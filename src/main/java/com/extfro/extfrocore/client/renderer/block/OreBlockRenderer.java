...
public class OreBlockRenderer {
    ...
    public static void reinitModels() {
        ...
        for (OreBlockRenderer model : MODELS) {
            ...
            ResourceLocation modelId = ExtForCore.id(ORE_MODEL_NAME_FORMAT
    ...
    protected static void copyOreModelWithBaseStone(TagPrefix tagPrefix, TagPrefix.OreType oreType,
        ...
        try {
            ...
            ExtForCore.LOGGER.error("Could not load template block model for ore type {}, icon type '{}', icon set '{}'",
        ...
        GTDynamicResourcePack.addBlockModel(
                ExtForCore.id(ORE_MODEL_NAME_FORMAT.formatted(iconSet.name, tagPrefix.name, iconType.name())), newJson);
    }
