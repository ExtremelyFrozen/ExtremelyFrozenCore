package com.extfro.extfrocore.api.registry.registrate.provider;
...
import com.extfro.extfrocore.client.util.ExtendedBlockModelRotation;
...
public class GTBlockstateProvider extends RegistrateBlockstateProvider {
    ...
    public static final String Z_ROT_PROPERTY_NAME = "extfrocore:z";
