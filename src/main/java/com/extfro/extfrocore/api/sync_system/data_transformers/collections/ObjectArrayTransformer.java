package com.extfro.extfrocore.api.sync_system.data_transformers.collections;
...
public class ObjectArrayTransformer<T> implements ValueTransformer<T[]> {
    ...
    private TransformerContext<T> getInnerElemContext(@Nullable T elem,
                                                      TransformerContext<T[]> parentContext) {
    ...
    public @Nullable T @Nullable [] deserializeNBT(Tag tag, TransformerContext<T[]> context) {
