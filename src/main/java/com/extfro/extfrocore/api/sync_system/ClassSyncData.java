    ...
    private ClassSyncData(Class<?> clazz) {
        ...
        for (Method method : clazz.getDeclaredMethods()) {
            ...
            try {
                ...
                ExtForCore.LOGGER.error("Sync: Failed to acquire method handle for method {} {}", method.getName(),
                        clazz.getName());
                ExtForCore.LOGGER.error(e.getMessage());
                continue;
            }
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            try {
                ...
                ExtForCore.LOGGER.error("Sync: Failed to acquire variable handle for field {} {}", field.getName(),
                        clazz.getName());
                ExtForCore.LOGGER.error(e.getMessage());
                continue;
            }
