...
import com.extfro.extfrocore.api.sync_system.annotations.ItemSave;
import com.extfro.extfrocore.api.sync_system.annotations.SaveField;
import com.extfro.extfrocore.api.sync_system.annotations.SyncBoth;
import com.extfro.extfrocore.api.sync_system.annotations.SyncToClient;
import com.extfro.extfrocore.api.sync_system.annotations.SyncToServer;
...
public final class ClassSyncData {
    ...
    private ClassSyncData(Class<?> clazz) {
        ...
        try {
            ...
            ExtForCore.LOGGER.error("Sync: Failed to create method handle lookup for class {}", clazz);
            ExtForCore.LOGGER.error(e.getMessage());
            return;
        }
        ...
        for (Method method : clazz.getDeclaredMethods()) {
            ...
            try {
                ...
                ExtForCore.LOGGER.error("Sync: Failed to acquire method handle for method {} {}",
            ...
            changeListeners.computeIfAbsent(listener.fieldName(), ignored -> new ArrayList<>()).add(handle);
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if (!hasSave && !hasItem && !hasS2C && !hasC2S && !hasBoth) {
                continue;
            }
            ...
            try {
                ...
                ExtForCore.LOGGER.error("Sync: Failed to acquire variable handle for field {} {}",
