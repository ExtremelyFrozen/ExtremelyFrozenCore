...
public class SlotWidget extends com.lowdragmc.lowdraglib2.gui.widget.SlotWidget {
    ...
    @Override
    public SlotWidget setOnAddedTooltips(BiConsumer<com.lowdragmc.lowdraglib2.gui.widget.SlotWidget, List<Component>> onAddedTooltips) {
    ...
    private Object convertIngredient(ItemStack itemStack) {
        ...
        } else if (ExtForCore.Mods.isJEILoaded() && !itemStack.isEmpty()) {
    ...
    private List<Object> getXEIIngredientsClickable(CycleItemEntryHandler handler, int index) {
        ...
        } else if (ExtForCore.Mods.isJEILoaded()) {
