...
public class ProspectingTexture extends AbstractTexture {
    ...
    private static final IGuiTexture ARROW = GuiTextures.UP.copy().setColor(ColorPattern.RED.color);
    ...
    public void draw(GuiGraphics graphics, int x, int y) {
        ...
        IGuiTexture arrow = ARROW.rotate(this.direction / 2);
        arrow.draw(graphics, 0, 0, x + playerXGui - 20, y + playerYGui - 20, 40, 40, 0);
