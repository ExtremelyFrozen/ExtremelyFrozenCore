...
public abstract class SteamWorkableMachine extends SteamMachine
    ...
    public SteamWorkableMachine(BlockEntityCreationInfo info, boolean isHighPressure, RecipeLogic recipeLogic,
                                NotifiableFluidTank steamTank) {
        this(info, isHighPressure, machine -> machine.attachTrait(recipeLogic), machine -> machine.attachTrait(steamTank));
    }

    public SteamWorkableMachine(BlockEntityCreationInfo info, boolean isHighPressure, RecipeLogic recipeLogic) {
        this(info, isHighPressure, machine -> machine.attachTrait(recipeLogic));
    }
