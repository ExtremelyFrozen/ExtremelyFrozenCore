...
import static com.extfro.extfrocore.utils.codec.GTCodecUtils.quietExceptionCodec;
...
public class GTRecipeSerializer implements RecipeSerializer<GTRecipe> {
    ...
    public static final MapCodec<GTRecipe> CODEC = makeCodec(ExtForCore.Mods.isKubeJSLoaded());
