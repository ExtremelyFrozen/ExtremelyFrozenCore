...
import com.extfro.extfrocore.data.recipe.GTIngredientTypes;
...
import static com.extfro.extfrocore.api.recipe.ingredient.IntProviderFluidIngredient.intProviderEqual;
...
public class IntProviderIngredient implements ICustomIngredient, IRangedIngredient {
    ...
    // spotless:on
    public static final ResourceLocation TYPE = ExtForCore.id("int_provider");
    ...
    public void setItemStacks(ItemStack @Nullable [] itemStacks) {
     ...
     *
     * @param random {@link RandomSource}, must be threadsafe, usually called using {@link EFValues#RNG}.
