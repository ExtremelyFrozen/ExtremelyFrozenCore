package com.extfro.extfrocore.api.data.worldgen.modifier;
...
public class FrequencyModifier extends PlacementModifier {
    ...
    public static final PlacementModifierType<FrequencyModifier> FREQUENCY_MODIFIER = GTRegistries
            .register(BuiltInRegistries.PLACEMENT_MODIFIER_TYPE, ExtForCore.id("frequency"), () -> FrequencyModifier.CODEC);
