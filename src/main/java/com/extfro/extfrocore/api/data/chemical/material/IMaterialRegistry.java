...
import com.extfro.extfrocore.core.IMappedRegistryAccess;
...
public interface IMaterialRegistry extends Iterable<Material> {
     ...
     * <li>{@code "registry_name"} - where modid is inferred to be {@link ExtForCore#MOD_ID}</li>
     * </ul>
    ...
    default Material getMaterial(String name) {
        return getMaterial(ExtForCore.id(name));
    }
