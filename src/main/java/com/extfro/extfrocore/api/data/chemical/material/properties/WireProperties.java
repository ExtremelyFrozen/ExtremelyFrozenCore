...
import static com.extfro.extfrocore.api.data.chemical.material.info.MaterialFlags.GENERATE_FOIL;
...
public class WireProperties implements IMaterialProperty {
    ...
    public void verifyProperty(MaterialProperties properties) {
        ...
        if (properties.hasProperty(PropertyKey.INGOT)) {
            ...
            if (!isSuperconductor && voltage >= EFValues.V[EFValues.IV] && !thisMaterial.hasFlag(GENERATE_FOIL)) {
