...
public class GTOreDefinition {
    ...
    public static final Codec<GTOreDefinition> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            RegistryCodecs.homogeneousList(Registries.BIOME).lenientOptionalFieldOf("biomes", HolderSet.empty()).forGetter(GTOreDefinition::biomes),
    ...
    public GTOreDefinition heightRange(HeightRangePlacement heightRange) {
        this.heightRange = heightRange;
        return this;
    }
    ...
    public HeightRangePlacement getHeightRange() {
        return heightRange;
    }
    ...
    public GTOreDefinition biomes(TagKey<Biome> biomes) {
        if (biomeLookup == null) {
            GTRegistries.builtinRegistry().registry(GTRegistries.ORE_VEIN_REGISTRY)
                    ...
                    .ifPresentOrElse(id -> {
                        ExtForCore.LOGGER.error("Tried to modify ore vein `{}`'s biomes after registry has been frozen!",
                                id);
                    }, () -> {
                        ExtForCore.LOGGER.error("Tried to modify an ore vein's biomes after registry has been frozen!");
                    });
            return this;
        }
