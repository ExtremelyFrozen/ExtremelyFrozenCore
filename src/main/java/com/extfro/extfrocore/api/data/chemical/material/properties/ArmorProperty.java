...
public class ArmorProperty implements IMaterialProperty {
    ...
    @Setter
    private ResourceLocation textureName = ExtForCore.id("metal");
    @Getter
    @Setter
    ...
    public static class Builder {
        ...
        public Builder repairIngredient(@Nullable Supplier<Ingredient> repairIngredient) {
        ...
        public Builder layers(ArmorMaterial.Layer... layers) {
         ...
         */
        public Builder customTexture(CustomTextureGetter textureGetter) {
