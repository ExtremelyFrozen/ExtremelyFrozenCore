package com.extfro.extfrocore.api.data.chemical;
...
import static com.extfro.extfrocore.api.EFValues.M;
import static com.extfro.extfrocore.api.data.chemical.material.ItemMaterialData.*;
...
public class ChemicalHelper {
    ...
    public static MaterialStack getMaterialStack(ItemLike itemLike) {
        ...
        if (info.getMaterial().isEmpty()) {
            ExtForCore.LOGGER.error("ItemMaterialInfo for {} is empty!", itemLike);
            return MaterialStack.EMPTY;
        }
    ...
    public static Material getMaterial(Fluid fluid) {
        if (FLUID_MATERIAL.isEmpty()) {
            ...
            for (final Material material : EFAPI.materialManager) {
