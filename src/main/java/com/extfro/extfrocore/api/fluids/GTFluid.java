...
import com.extfro.extfrocore.api.fluids.attribute.IAttributedFluid;
...
public abstract class GTFluid extends BaseFlowingFluid implements IAttributedFluid {
    ...
    public GTFluid(FluidState state, int burnTime, Properties properties) {
        super(properties);
        this.state = state;
    ...
    public static class Source extends GTFluid {
        ...
        public Source(FluidState state, int burnTime, Properties properties) {
    ...
    public static class Flowing extends GTFluid {
        ...
        public Flowing(FluidState state, int burnTime, Properties properties) {
            super(state, burnTime, properties);
