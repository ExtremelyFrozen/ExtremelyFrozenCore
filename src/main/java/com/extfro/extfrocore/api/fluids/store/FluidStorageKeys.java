package com.extfro.extfrocore.api.fluids.store;
...
public final class FluidStorageKeys {
    ...
    public static final FluidStorageKey LIQUID = new FluidStorageKey(ExtForCore.id("liquid"),
    ...
    public static final FluidStorageKey GAS = new FluidStorageKey(ExtForCore.id("gas"),
    ...
    public static final FluidStorageKey PLASMA = new FluidStorageKey(ExtForCore.id("plasma"),
            MaterialIconType.plasma,
            m -> m.getName() + "_plasma",
            m -> "gtceu.fluid.plasma",
            FluidState.PLASMA, -1);

    public static final FluidStorageKey MOLTEN = new FluidStorageKey(ExtForCore.id("molten"), CustomTags.MOLTEN_FLUIDS,
