...
public class ConfigHolder {
    ...
    public static class CompatibilityConfigs {
        ...
        @Configurable
        @Configurable.Comment("Config options regarding ExtForCore compatibility with AE2")
        public AE2CompatConfig ae2 = new AE2CompatConfig();

        @Configurable
        @Configurable.Comment("Config options regarding ExtForCore compatibility with minimap mods")
    ...
    public static class MachineConfigs {
         ...
         * Use {@link EFAPI#isHighTier()} instead.
         */
        @Configurable
