...
public class TagUtil {
     ...
     *
     * @return Block tag {@code #extfrocore:path}
     */
     ...
     *
     * @return Item tag {@code #extfrocore:path}
     */
     ...
     *
     * @return Fluid tag #extfrocore:path
     */
