...
import com.extfro.extfrocore.integration.ae2.machine.MEPatternBufferPartMachine;
import com.extfro.extfrocore.integration.ae2.machine.MEPatternBufferProxyPartMachine;
...
public enum GTFluidStorageProvider implements IServerExtensionProvider<CompoundTag>,
    ...
    public ResourceLocation getUid() {
        return ExtForCore.id("custom_fluid_storage");
    }
    ...
    public @Nullable List<ViewGroup<CompoundTag>> getGroups(Accessor<?> accessor) {
        ...
        } else if (ExtForCore.Mods.isAE2Loaded() && accessor.getTarget() instanceof MEPatternBufferPartMachine buffer) {
        ...
        } else if (ExtForCore.Mods.isAE2Loaded() && accessor.getTarget() instanceof MEPatternBufferProxyPartMachine proxy) {
