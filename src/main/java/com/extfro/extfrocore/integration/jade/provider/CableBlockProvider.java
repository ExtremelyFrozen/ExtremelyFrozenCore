...
import static com.extfro.extfrocore.utils.FormattingUtil.DECIMAL_FORMAT_1F;
...
public class CableBlockProvider implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
    ...
    public void appendTooltip(ITooltip iTooltip, BlockAccessor blockAccessor, IPluginConfig iPluginConfig) {
        ...
        if (be != null) {
            ...
            if (data.contains("cableData", Tag.TAG_COMPOUND)) {
                ...
                if (voltage != 0) {
                    iTooltip.append(Component.literal(EFValues.VNF[GTUtil.getTierByVoltage(voltage)]));
                    iTooltip.append(Component.literal(" / "));
                }
                iTooltip.append(Component.literal(EFValues.VNF[GTUtil.getTierByVoltage(tag.getLong("maxVoltage"))]));
    ...
    public ResourceLocation getUid() {
        return ExtForCore.id("cable_info");
    }
}
