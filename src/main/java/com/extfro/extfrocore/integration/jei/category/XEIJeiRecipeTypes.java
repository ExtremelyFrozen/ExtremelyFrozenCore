...
public final class XEIJeiRecipeTypes {
    ...
    private static final Map<OreProcessingCategory, RecipeType<OreProcessingDisplay>> ORE_PROCESSING_TYPES = new HashMap<>();
    ...
    public static final RecipeType<OreProcessingDisplay> ORE_PROCESSING = oreProcessing(OreProcessingRegistry.DEFAULT_CATEGORY);
