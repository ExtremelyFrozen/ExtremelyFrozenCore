...
public class RecipeCapabilityComponent implements RecipeComponent<RecipeCapability<?>> {
    ...
    // spotless:off
    public static final RecipeComponentType<RecipeCapability<?>> RECIPE_CAPABILITY = RecipeComponentType.unit(ExtForCore.id("recipe_capability"), new RecipeCapabilityComponent());
    // spotless:on
