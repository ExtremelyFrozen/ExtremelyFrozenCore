package com.extfro.extfrocore.integration.kjs.builders.block;
...
public class ActiveBlockBuilder extends BlockBuilder {
    ...
    public static final ResourceLocation CUBE_2_LAYER_ALL_MODEL = ExtForCore.id("block/cube_2_layer/all");
    public static final ResourceLocation CUBE_BOTTOM_TOP_MODEL = ResourceLocation.withDefaultNamespace("block/cube_bottom_top");
    public static final ResourceLocation FIRE_BOX_ACTIVE_MODEL = ExtForCore.id("block/fire_box_active");
    // spotless:on
