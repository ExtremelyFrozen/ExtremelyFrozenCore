...
import com.extfro.extfrocore.api.cosmetics.CapeRegistry;
...
import com.extfro.extfrocore.api.data.medicalcondition.Symptom;
...
import com.extfro.extfrocore.api.data.worldgen.generator.indicators.SurfaceIndicatorGenerator.IndicatorPlacement;
import com.extfro.extfrocore.api.data.worldgen.generator.veins.DikeVeinGenerator;
...
import com.extfro.extfrocore.common.cosmetics.GTCapes;
import com.extfro.extfrocore.common.data.*;
import com.extfro.extfrocore.common.data.machines.GCYMMachines;
...
import com.extfro.extfrocore.common.machine.multiblock.primitive.PrimitiveFancyUIWorkableMachine;
import com.extfro.extfrocore.data.pack.GTDynamicDataPack;
import com.extfro.extfrocore.data.pack.GTDynamicResourcePack;
import com.extfro.extfrocore.data.recipe.CraftingComponent;
import com.extfro.extfrocore.data.recipe.GTCraftingComponents;
import com.extfro.extfrocore.integration.kjs.builders.ElementBuilder;
import com.extfro.extfrocore.integration.kjs.builders.GTRecipeCategoryBuilder;
import com.extfro.extfrocore.integration.kjs.builders.GTRecipeTypeBuilder;
import com.extfro.extfrocore.integration.kjs.builders.block.ActiveBlockBuilder;
import com.extfro.extfrocore.integration.kjs.builders.block.CoilBlockBuilder;
import com.extfro.extfrocore.integration.kjs.builders.machine.*;
import com.extfro.extfrocore.integration.kjs.builders.material.MaterialBuilderWrapper;
import com.extfro.extfrocore.integration.kjs.builders.prefix.OreTagPrefixBuilder;
import com.extfro.extfrocore.integration.kjs.builders.prefix.TagPrefixBuilder;
import com.extfro.extfrocore.integration.kjs.builders.worldgen.BedrockFluidBuilder;
import com.extfro.extfrocore.integration.kjs.builders.worldgen.BedrockOreBuilder;
import com.extfro.extfrocore.integration.kjs.builders.worldgen.DimensionMarkerBuilder;
import com.extfro.extfrocore.integration.kjs.builders.worldgen.OreVeinDefinitionBuilder;
import com.extfro.extfrocore.integration.kjs.helpers.GTResourceLocation;
import com.extfro.extfrocore.integration.kjs.helpers.MachineConstructors;
import com.extfro.extfrocore.integration.kjs.helpers.MachineModifiers;
import com.extfro.extfrocore.integration.kjs.helpers.MaterialStackWrapper;
import com.extfro.extfrocore.integration.kjs.recipe.GTRecipeSchema;
import com.extfro.extfrocore.integration.kjs.recipe.GTShapedRecipeSchema;
import com.extfro.extfrocore.integration.kjs.recipe.KJSHelpers;
import com.extfro.extfrocore.integration.kjs.recipe.components.*;
...
public class GregTechKubeJSPlugin implements KubeJSPlugin {
    ...
    private static <T> void registerWrappers(RegisterEvent event, ResourceKey<Registry<T>> registryKey) {
        ...
        for (var builder : objStorage) {
            ...
            if (ExtForCore.isClientSide()) GTDynamicResourcePack.addNamespace(builder.id.getNamespace());
        ...
        if (!objStorage.objects.isEmpty() && DevProperties.get().logRegistryEventObjects) {
            ExtForCore.LOGGER.info("Registered {}/{} objects of {}", added, objStorage.objects.size(), registryLoc);
        }
    }
    ...
    public void registerBuilderTypes(BuilderTypeRegistry registry) {
        ...
        registry.of(GTRegistries.TAG_PREFIX_REGISTRY, reg -> {
            ...
            reg.add(ExtForCore.id("ore"), OreTagPrefixBuilder.class, OreTagPrefixBuilder::new);
        });
        ...
        registry.of(GTRegistries.MACHINE_REGISTRY, reg -> {
            ...
            reg.add(ExtForCore.id("tiered_multiblock"), KJSWrappingMultiblockBuilder.class,
                    KJSWrappingMultiblockBuilder::new);
            reg.add(ExtForCore.id("primitive"), MultiblockMachineBuilderWrapper.class,
                    (id) -> MultiblockMachineBuilderWrapper.createKJSMulti(id, PrimitiveFancyUIWorkableMachine::new));
        });

        registry.of(Registries.BLOCK, reg -> {
            reg.add(ExtForCore.id("active"), ActiveBlockBuilder.class, ActiveBlockBuilder::new);
            reg.add(ExtForCore.id("coil"), CoilBlockBuilder.class, CoilBlockBuilder::new);
        });
    ...
    public void registerClasses(ClassFilter filter) {
        ...
        filter.allow("com.extfro.extfrocore");
        filter.deny("com.extfro.extfrocore.core");
        filter.deny("com.extfro.extfrocore.common.network");
    }
    ...
    public void registerRecipeSchemas(RecipeSchemaRegistry event) {
        ...
        event.namespace(ExtForCore.MOD_ID).register("shaped", GTShapedRecipeSchema.SCHEMA);
    }
    ...
    public void registerBindings(BindingRegistry event) {
        // Mod related
        event.add("ExtForCore", ExtForCore.class);
        event.add("EFAPI", EFAPI.class);
        event.add("GTRegistries", GTRegistries.class);
        event.add("EFValues", EFValues.class);
        // Material related
        event.add("GTElements", GTElements.class);
        event.add("GTMaterials", GTMaterials.class);
        event.add("GTMaterialRegistry", EFAPI.materialManager);
