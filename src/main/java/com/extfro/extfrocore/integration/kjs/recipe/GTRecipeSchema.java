package com.extfro.extfrocore.integration.kjs.recipe;
...
import com.extfro.extfrocore.api.recipe.ResearchRecipeBuilder;
...
import com.extfro.extfrocore.integration.kjs.recipe.components.CapabilityMap;
import com.extfro.extfrocore.integration.kjs.recipe.components.CapabilityMapComponent;
import com.extfro.extfrocore.integration.kjs.recipe.components.GTRecipeComponents;
...
public interface GTRecipeSchema {
    ...
    class GTKubeRecipe extends KubeRecipe {
        ...
        // ((long) stack.getAmount() * EFValues.M) / EFValues.L));
        // }
        // }
        // }
        // return input(FluidRecipeCapability.CAP, (Object[]) inputs);
    ...
    // spotless:off
    KubeRecipeFactory RECIPE_FACTORY = new KubeRecipeFactory(ExtForCore.id("machine"), GTKubeRecipe.class, GTKubeRecipe::new);
