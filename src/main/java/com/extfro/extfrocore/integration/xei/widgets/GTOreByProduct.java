    ...
    public GTOreByProduct(Material material) {
        ...
        if (ALWAYS_MACHINES == null) {
            ALWAYS_MACHINES = ImmutableList.of(
                    GTMachines.MACERATOR[EFValues.LV].asStack(),
                    GTMachines.MACERATOR[EFValues.LV].asStack(),
                    GTMachines.CENTRIFUGE[EFValues.LV].asStack(),
                    GTMachines.ORE_WASHER[EFValues.LV].asStack(),
                    GTMachines.THERMAL_CENTRIFUGE[EFValues.LV].asStack(),
                    GTMachines.MACERATOR[EFValues.LV].asStack(),
                    GTMachines.MACERATOR[EFValues.LV].asStack(),
                    GTMachines.CENTRIFUGE[EFValues.LV].asStack());
        }
        ...
        simpleWashers.add(GTMachines.ORE_WASHER[EFValues.LV].asStack());
        ...
        if (!washedIn.first().isNull()) {
            hasChemBath = true;
            addToInputs(GTMachines.CHEMICAL_BATH[EFValues.LV].asStack());
        } else {
            addToInputs(ItemStack.EMPTY);
        }
        if (separatedInto != null && !separatedInto.isEmpty()) {
            hasSeparator = true;
            addToInputs(GTMachines.ELECTROMAGNETIC_SEPARATOR[EFValues.LV].asStack());
        } else {
            addToInputs(ItemStack.EMPTY);
        }
        if (material.hasProperty(PropertyKey.GEM)) {
            hasSifter = true;
            addToInputs(GTMachines.SIFTER[EFValues.LV].asStack());
        } else {
            addToInputs(ItemStack.EMPTY);
        }
