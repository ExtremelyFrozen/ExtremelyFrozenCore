...
import static com.extfro.extfrocore.api.data.chemical.material.properties.PropertyKey.ORE;
...
public class GTOreProcessingEmiCategory extends EmiRecipeCategory {
    ...
    public GTOreProcessingEmiCategory() {
        super(ExtForCore.id("ore_processing_diagram"), EmiStack.of(Items.RAW_IRON));
    }

    public static void registerDisplays(EmiRegistry registry) {
        for (Material mat : EFAPI.materialManager) {
