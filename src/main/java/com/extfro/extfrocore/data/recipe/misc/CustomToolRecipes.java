...
import com.extfro.extfrocore.api.recipe.ToolHeadReplaceRecipe;
...
import com.extfro.extfrocore.utils.ToolItemHelper;
...
import static com.extfro.extfrocore.api.EFValues.LuV;
import static com.extfro.extfrocore.api.data.tag.TagPrefix.*;
import static com.extfro.extfrocore.data.recipe.generated.ToolRecipeHandler.*;
...
public final class CustomToolRecipes {
    ...
    private static void initializeGTItems() {
        motorItems.put(EFValues.LV, GTItems.ELECTRIC_MOTOR_LV);
        motorItems.put(EFValues.MV, GTItems.ELECTRIC_MOTOR_MV);
        motorItems.put(EFValues.HV, GTItems.ELECTRIC_MOTOR_HV);
        motorItems.put(EFValues.EV, GTItems.ELECTRIC_MOTOR_EV);
        motorItems.put(EFValues.IV, GTItems.ELECTRIC_MOTOR_IV);

        baseMaterials.put(EFValues.LV, GTMaterials.Steel);
        baseMaterials.put(EFValues.MV, GTMaterials.Aluminium);
        baseMaterials.put(EFValues.HV, GTMaterials.StainlessSteel);
        baseMaterials.put(EFValues.EV, GTMaterials.Titanium);
        baseMaterials.put(EFValues.IV, GTMaterials.TungstenSteel);

        batteryItems.put(EFValues.ULV, List.of(GTItems.BATTERY_ULV_TANTALUM));
        batteryItems.put(EFValues.LV,
                List.of(GTItems.BATTERY_LV_LITHIUM, GTItems.BATTERY_LV_CADMIUM, GTItems.BATTERY_LV_SODIUM));
        batteryItems.put(EFValues.MV,
                List.of(GTItems.BATTERY_MV_LITHIUM, GTItems.BATTERY_MV_CADMIUM, GTItems.BATTERY_MV_SODIUM));
        batteryItems.put(EFValues.HV, List.of(GTItems.BATTERY_HV_LITHIUM, GTItems.BATTERY_HV_CADMIUM,
                GTItems.BATTERY_HV_SODIUM, GTItems.ENERGIUM_CRYSTAL));
        batteryItems.put(EFValues.EV, List.of(GTItems.BATTERY_EV_VANADIUM, GTItems.LAPOTRON_CRYSTAL));
        batteryItems.put(EFValues.IV, List.of(GTItems.BATTERY_IV_VANADIUM, GTItems.ENERGY_LAPOTRONIC_ORB));
        batteryItems.put(EFValues.LuV,
                List.of(GTItems.BATTERY_LuV_VANADIUM, GTItems.ENERGY_LAPOTRONIC_ORB_CLUSTER));
        batteryItems.put(EFValues.ZPM, List.of(GTItems.BATTERY_ZPM_NAQUADRIA, GTItems.ENERGY_MODULE));
        batteryItems.put(EFValues.UV, List.of(GTItems.BATTERY_UV_NAQUADRIA, GTItems.ENERGY_CLUSTER));
    ...
    private static void registerCustomToolRecipes(@NotNull RecipeOutput provider) {
        ...
        SpecialRecipeBuilder.special(ToolHeadReplaceRecipe::new).save(provider, "extfrocore:crafting/replace_tool_head");
    }
