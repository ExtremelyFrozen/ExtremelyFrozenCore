...
import com.extfro.extfrocore.data.recipe.WoodTypeEntry;
import com.extfro.extfrocore.integration.kjs.GTCEuStartupEvents;
import com.extfro.extfrocore.integration.kjs.events.RegisterWoodsEventJS;
...
import static com.extfro.extfrocore.common.data.GTItems.BIO_CHAFF;
        ...
        if (DEFAULT_ENTRIES == null) {
            ...
            return DEFAULT_ENTRIES = Arrays.asList(
                    ...
                    new WoodTypeEntry.Builder(mcModId, "warped")
                            ...
                            .registerAllMaterialInfo()
                            .build(),
                    new WoodTypeEntry.Builder(ExtForCore.MOD_ID, "rubber")
                            ...
                            .registerAllMaterialInfo()
                            .build(),
                    new WoodTypeEntry.Builder(ExtForCore.MOD_ID, "treated")
            ...
            if (ConfigHolder.INSTANCE.recipes.hardWoodRecipes) {
                ...
                if (entry.trapdoor != null) {
                    ...
                    ASSEMBLER_RECIPES.recipeBuilder(name + "_door")
                            ...
                            .inputFluids(Iron.getFluid(EFValues.L / 9))
        ...
        if (entry.sign != null && entry.slab != null) {
            ...
            if (ConfigHolder.INSTANCE.recipes.hardWoodRecipes) {
                ...
                ASSEMBLER_RECIPES.recipeBuilder(recipeName + "_steel")
                        ...
                        .inputItems(new ItemStack(entry.slab, 1))
                        .inputItems(entry.getStick(), 1)
                        .inputFluids(Steel.getFluid(EFValues.L / 9))
