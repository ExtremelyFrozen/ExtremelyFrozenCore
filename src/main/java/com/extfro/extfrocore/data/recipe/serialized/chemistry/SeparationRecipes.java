package com.extfro.extfrocore.data.recipe.serialized.chemistry;
...
import static com.extfro.extfrocore.common.data.GTItems.PLANT_BALL;
import static com.extfro.extfrocore.common.data.GTItems.STICKY_RESIN;
...
public class SeparationRecipes {
    ...
    public static void init(RecipeOutput provider) {
         ...
         * Collection<ItemStack> subItems = GTUtility.getAllSubItems(new ItemStack(item, 1, EFValues.W));
        ...
        // .inputItems(new ItemStack(Blocks.COBBLESTONE, 1, EFValues.W))
