package com.extfro.extfrocore.data.recipe;
...
import com.extfro.extfrocore.data.recipe.builder.*;
...
public class VanillaRecipeHelper {
    ...
    public static void addSmeltingRecipe(RecipeOutput provider, @NotNull String regName, TagKey<Item> input,
                                         ItemStack output) {
        addSmeltingRecipe(provider, ExtForCore.id(regName), input, output);
    }
    ...
    public static void addSmeltingRecipe(RecipeOutput provider, @NotNull String regName, TagKey<Item> input,
        ...
        addSmeltingRecipe(provider, ExtForCore.id(regName), input, output, experience);
    }
    ...
    public static void addSmeltingRecipe(RecipeOutput provider, @NotNull String regName, ItemStack input,
                                         ItemStack output) {
        addSmeltingRecipe(provider, ExtForCore.id(regName), input, output, 0.0f);
    }

    public static void addSmeltingRecipe(RecipeOutput provider, @NotNull String regName, Item input,
                                         Item output) {
        addSmeltingRecipe(provider, ExtForCore.id(regName), input.getDefaultInstance(), output.getDefaultInstance(), 0.0f);
    }

    public static void addSmeltingRecipe(RecipeOutput provider, @NotNull String regName, Item input,
                                         Item output, float experience) {
        addSmeltingRecipe(provider, ExtForCore.id(regName), input.getDefaultInstance(), output.getDefaultInstance(),
                experience);
    }
    ...
    public static void addBlastingRecipe(RecipeOutput provider, @NotNull String regName, TagKey<Item> input,
                                         ItemStack output) {
        addBlastingRecipe(provider, ExtForCore.id(regName), input, output);
    }
    ...
    public static void addBlastingRecipe(RecipeOutput provider, @NotNull String regName, TagKey<Item> input,
                                         ItemStack output, float experience) {
        addBlastingRecipe(provider, ExtForCore.id(regName), input, output, experience);
    }
    ...
    public static void addBlastingRecipe(RecipeOutput provider, @NotNull String regName, ItemStack input,
                                         ItemStack output) {
        addBlastingRecipe(provider, ExtForCore.id(regName), input, output, 0.0f);
    }

    public static void addBlastingRecipe(RecipeOutput provider, @NotNull String regName, Item input,
                                         Item output) {
        addBlastingRecipe(provider, ExtForCore.id(regName), input.getDefaultInstance(), output.getDefaultInstance(), 0.0f);
    }

    public static void addBlastingRecipe(RecipeOutput provider, @NotNull String regName, Item input,
                                         Item output, float experience) {
        addBlastingRecipe(provider, ExtForCore.id(regName), input.getDefaultInstance(), output.getDefaultInstance(),
                experience);
    }
    ...
    public static void addSmokingRecipe(RecipeOutput provider, @NotNull String regName, TagKey<Item> input,
                                        ItemStack output) {
        addSmokingRecipe(provider, ExtForCore.id(regName), input, output);
    }
    ...
    public static void addSmokingRecipe(RecipeOutput provider, @NotNull String regName, TagKey<Item> input,
                                        ItemStack output, float experience) {
        addSmokingRecipe(provider, ExtForCore.id(regName), input, output, experience);
    }
    ...
    public static void addSmokingRecipe(RecipeOutput provider, @NotNull String regName, ItemStack input,
                                        ItemStack output) {
        addSmokingRecipe(provider, ExtForCore.id(regName), input, output, 0.0f);
    }

    public static void addSmokingRecipe(RecipeOutput provider, @NotNull String regName, Item input,
                                        Item output) {
        addSmokingRecipe(provider, ExtForCore.id(regName), input.getDefaultInstance(), output.getDefaultInstance(), 0.0f);
    }

    public static void addSmokingRecipe(RecipeOutput provider, @NotNull String regName, Item input,
                                        Item output, float experience) {
        addSmokingRecipe(provider, ExtForCore.id(regName), input.getDefaultInstance(), output.getDefaultInstance(),
                experience);
    }
    ...
    public static void addCampfireRecipe(RecipeOutput provider, @NotNull String regName, ItemStack input,
                                         ItemStack output, float experience) {
        addCampfireRecipe(provider, ExtForCore.id(regName), input, output, experience);
    }

    public static void addCampfireRecipe(RecipeOutput provider, @NotNull String regName, ItemStack input,
                                         ItemStack output) {
        addCampfireRecipe(provider, ExtForCore.id(regName), input, output, 0);
    }
    ...
    public static void addShapedRecipe(RecipeOutput provider, @NotNull String regName,
        ...
        addShapedRecipe(provider, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addStrictShapedRecipe(RecipeOutput provider, @NotNull String regName,
                                             @NotNull ItemStack result, @NotNull Object... recipe) {
        addStrictShapedRecipe(provider, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addStrictSizeShapedRecipe(RecipeOutput provider, @NotNull String regName,
                                                 @NotNull ItemStack result, @NotNull Object... recipe) {
        addStrictSizeShapedRecipe(provider, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addStrictSizeShapedRecipe(RecipeOutput provider, boolean setMaterialInfoData,
                                                 ...
                                                 @NotNull ItemStack result, @NotNull Object... recipe) {
        addStrictSizeShapedRecipe(provider, setMaterialInfoData, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addShapedRecipe(RecipeOutput provider, boolean setMaterialInfoData,
        ...
        addShapedRecipe(provider, setMaterialInfoData, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addStrictShapedRecipe(RecipeOutput provider, boolean setMaterialInfoData,
                                             ...
                                             @NotNull Object... recipe) {
        addShapedRecipe(provider, setMaterialInfoData, true, ExtForCore.id(regName), result, recipe);
    }

    public static void addShapelessRecipe(RecipeOutput provider, @NotNull String regName,
                                          @NotNull ItemStack result, @NotNull Object... recipe) {
        addShapelessRecipe(provider, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addShapedEnergyTransferRecipe(RecipeOutput provider, boolean setMaterialInfoData,
        ...
        addShapedEnergyTransferRecipe(provider, setMaterialInfoData, overrideCharge, transferMaxCharge,
                ExtForCore.id(regName), chargeIngredient, result, recipe);
    }
    ...
    public static void addShapedFluidContainerRecipe(RecipeOutput provider, boolean setMaterialInfoData,
                                                     @NotNull String regName, @NotNull ItemStack result,
                                                     @NotNull Object... recipe) {
        addShapedFluidContainerRecipe(provider, setMaterialInfoData, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addShapedFluidContainerRecipe(RecipeOutput provider, @NotNull String regName,
                                                     ...
                                                     @NotNull Object... recipe) {
        addShapedFluidContainerRecipe(provider, ExtForCore.id(regName), result, recipe);
    }
    ...
    public static void addSmithingTransformRecipe(RecipeOutput provider, @NotNull String regName,
                                                  @NotNull Item result, @NotNull ItemLike baseInput,
                                                  @NotNull ItemLike template, @NotNull ItemLike addition) {
        addSmithingTransformRecipe(provider, ExtForCore.id(regName), result, baseInput, template, addition,
                RecipeCategory.MISC);
    }
