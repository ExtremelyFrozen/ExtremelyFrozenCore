...
import com.extfro.extfrocore.data.recipe.StoneTypeEntry;
...
public class StoneMachineRecipes {
        ...
        if (DEFAULT_ENTRIES == null) {
            ...
            return DEFAULT_ENTRIES = Arrays.asList(
                    ...
                    new StoneTypeEntry.Builder(mcModID, "brick")
                            ...
                            .material(GTMaterials.Brick, 4 * EFValues.M)
                            .registerAllMaterialInfo()
                            .build(),
                    ...
                    new StoneTypeEntry.Builder(mcModID, "nether_bricks")
                            ...
                            .material(GTMaterials.Netherrack, 4 * EFValues.M)
                            .registerAllMaterialInfo()
                            .build(),
                    ...
                    new StoneTypeEntry.Builder(mcModID, "quartz")
                            ...
                            .material(GTMaterials.NetherQuartz, 4 * EFValues.M)
                            .registerAllMaterialInfo()
                            .build(),
                    ...
                    new StoneTypeEntry.Builder(mcModID, "cut_copper")
                            ...
                            .material(GTMaterials.Copper, 9 * EFValues.M / 4)
                            .registerAllMaterialInfo()
                            .build(),
    ...
    public static void registerStoneTypeRecipes(RecipeOutput provider, @NotNull StoneTypeEntry entry) {
        if (entry.stone == null) {
            ExtForCore.LOGGER.error("Could not find stone form of StoneTypeEntry, id: {}", entry.stoneName);
            return;
        }
