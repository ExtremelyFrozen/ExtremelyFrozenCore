package com.extfro.extfrocore.data.recipe.configurable;
...
import com.extfro.extfrocore.api.recipe.ingredient.FluidContainerIngredient;
    ...
    private static void hardRedstoneRecipes(RecipeOutput provider) {
        if (ConfigHolder.INSTANCE.recipes.hardRedstoneRecipes) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("piston_iron")
                    ...
                    .inputFluids(GTMaterials.RedAlloy.getFluid(EFValues.L))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("piston_steel")
                    ...
                    .inputItems(ItemTags.STONE_CRAFTING_MATERIALS, 2)
                    .inputFluids(GTMaterials.RedAlloy.getFluid(EFValues.L * 2))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("piston_aluminium")
                    ...
                    .inputFluids(GTMaterials.RedAlloy.getFluid(EFValues.L * 3))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("piston_stainless_steel")
                    ...
                    .inputFluids(GTMaterials.RedAlloy.getFluid(EFValues.L * 4))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("piston_titanium")
                    ...
                    .inputFluids(GTMaterials.RedAlloy.getFluid(EFValues.L * 8))
    ...
    private static void hardMiscRecipes(RecipeOutput provider) {
        if (ConfigHolder.INSTANCE.recipes.hardMiscRecipes) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("lantern").duration(100).EUt(VA[LV])
                    .inputItems(Items.TORCH).inputFluids(Iron.getFluid(EFValues.L / 9 * 8))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("stonecutter").duration(100).EUt(VA[LV])
                    .inputItems(Items.STONE, 3).inputFluids(Iron.getFluid(EFValues.L))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("smithing_table").duration(100).EUt(VA[LV])
                    .inputItems(ItemTags.PLANKS, 4).inputFluids(Iron.getFluid(EFValues.L * 2))
            ...
            ASSEMBLER_RECIPES.recipeBuilder("blast_furnace").duration(100).EUt(VA[LV])
                    ...
                    .inputFluids(Iron.getFluid(EFValues.L * 5)).outputItems(new ItemStack(Blocks.BLAST_FURNACE))
                    .save(provider);
