...
import static com.extfro.extfrocore.common.data.GTBlocks.LD_FLUID_PIPE;
import static com.extfro.extfrocore.common.data.GTBlocks.LD_ITEM_PIPE;
import static com.extfro.extfrocore.common.data.GTItems.*;
import static com.extfro.extfrocore.common.data.GTMachines.*;
import static com.extfro.extfrocore.common.data.GTMaterials.*;
import static com.extfro.extfrocore.common.data.GTRecipeTypes.ASSEMBLER_RECIPES;
import static com.extfro.extfrocore.common.data.GTRecipeTypes.ASSEMBLY_LINE_RECIPES;
...
public class MetaTileEntityMachineRecipeLoader {
    ...
    public static void init(RecipeOutput provider) {
        ...
        for (int tier = 0; tier < TRANSFORMER.length; tier++) {
            ...
            GTRecipeBuilder b = ASSEMBLER_RECIPES.recipeBuilder(VN[tier].toLowerCase(Locale.ROOT) + "_transformer")
                    ...
                    .EUt(tier < EFValues.IV ? VA[LV] : VA[tier])
        ...
        for (int tier = 0; tier < POWER_TRANSFORMER.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_power_transformer")
        ...
        for (int tier = 0; tier < ENERGY_INPUT_HATCH_4A.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("energy_hatch_4a_" + EFValues.VN[tier].toLowerCase(Locale.ROOT))
        ...
        for (int tier = 0; tier < ENERGY_INPUT_HATCH_16A.length; tier++) {
            ...
            if (tier == (EFAPI.isHighTier() ? MAX : UHV)) {
                transformer = HI_AMP_TRANSFORMER_4A[tier - 1];
            } else {
                transformer = TRANSFORMER[tier];
            }

            ASSEMBLER_RECIPES.recipeBuilder("energy_hatch_16a_" + EFValues.VN[tier].toLowerCase(Locale.ROOT))
        ...
        for (int tier = 0; tier < SUBSTATION_ENERGY_INPUT_HATCH.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("substation_energy_hatch_" + EFValues.VN[tier].toLowerCase(Locale.ROOT))
                    .inputItems(transformer)
        ...
        for (int tier = 0; tier < ENERGY_OUTPUT_HATCH_4A.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("dynamo_hatch_4a_" + EFValues.VN[tier].toLowerCase(Locale.ROOT))
        ...
        for (int tier = 0; tier < ENERGY_OUTPUT_HATCH_16A.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("dynamo_hatch_16a_" + EFValues.VN[tier].toLowerCase(Locale.ROOT))
                    .inputItems(transformer)
        ...
        for (int tier = 0; tier < SUBSTATION_ENERGY_OUTPUT_HATCH.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder("substation_dynamo_hatch_" + EFValues.VN[tier].toLowerCase(Locale.ROOT))
                    .inputItems(transformer)
    ...
    private static void registerLaserRecipes(RecipeOutput provider) {
        ...
        for (int tier = 0; tier < LASER_INPUT_HATCH_256.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_256a_laser_target_hatch")
        ...
        for (int tier = 0; tier < LASER_OUTPUT_HATCH_256.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_256a_laser_source_hatch")
                    .inputItems(HULL[tier])
                    .inputItems(lens, Diamond)
        ...
        for (int tier = 0; tier < LASER_INPUT_HATCH_1024.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_1024a_laser_target_hatch")
                    .inputItems(HULL[tier])
        ...
        for (int tier = 0; tier < LASER_OUTPUT_HATCH_1024.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_1024a_laser_source_hatch")
                    .inputItems(HULL[tier])
                    .inputItems(lens, Diamond, 2)
        ...
        for (int tier = 0; tier < LASER_INPUT_HATCH_4096.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_4096a_laser_target_hatch")
                    .inputItems(HULL[tier])
        ...
        for (int tier = 0; tier < LASER_OUTPUT_HATCH_4096.length; tier++) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(EFValues.VN[tier].toLowerCase(Locale.ROOT) + "_4096a_laser_output_hatch")
                    .inputItems(HULL[tier])
                    .inputItems(lens, Diamond, 4)
