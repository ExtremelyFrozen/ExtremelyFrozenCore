...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("curios.identifier.gtceu_magnet", "ExtForCore Magnet");
        // capabilities
        provider.add("recipe.capability.eu.name", "ExtForCore Energy");
        ...
        provider.add("config.jade.plugin_gtceu.controllable_provider", "[ExtForCore] Controllable");
        provider.add("config.jade.plugin_gtceu.workable_provider", "[ExtForCore] Workable");
        provider.add("config.jade.plugin_gtceu.battery_info", "[ExtForCore] Battery info");
        provider.add("config.jade.plugin_gtceu.electric_container_provider", "[ExtForCore] Electric Container");
        provider.add("config.jade.plugin_gtceu.recipe_logic_provider", "[ExtForCore] Recipe Logic");
        provider.add("config.jade.plugin_gtceu.hazard_cleaner_provider", "[ExtForCore] Hazard Cleaner");
        provider.add("config.jade.plugin_gtceu.recipe_output_info", "[ExtForCore] Recipe Output Info");
        provider.add("config.jade.plugin_gtceu.auto_output_info", "[ExtForCore] Auto Output Info");
        provider.add("config.jade.plugin_gtceu.cable_info", "[ExtForCore] Cable Info");
        provider.add("config.jade.plugin_gtceu.exhaust_vent_info", "[ExtForCore] Exhaust Vent Info");
        provider.add("config.jade.plugin_gtceu.steam_boiler_info", "[ExtForCore] Steam Boiler Info");
        provider.add("config.jade.plugin_gtceu.machine_mode", "[ExtForCore] Machine Mode");
        provider.add("config.jade.plugin_gtceu.maintenance_info", "[ExtForCore] Maintenance Info");
        provider.add("config.jade.plugin_gtceu.multiblock_structure", "[ExtForCore] MultiBlock Structure");
        provider.add("config.jade.plugin_gtceu.parallel_info", "[ExtForCore] Parallel Info");
        provider.add("config.jade.plugin_gtceu.primitive_pump", "[ExtForCore] Primitive Pump Info");
        provider.add("config.jade.plugin_gtceu.data_bank", "[ExtForCore] Data Bank Info");
        provider.add("config.jade.plugin_gtceu.transformer", "[ExtForCore] Transformer Info");
        provider.add("config.jade.plugin_gtceu.stained_color", "[ExtForCore] Stained Block Info");
        provider.add("config.jade.plugin_gtceu.me_pattern_buffer", "[ExtForCore] Pattern Buffer Info");
        provider.add("config.jade.plugin_gtceu.me_pattern_buffer_proxy", "[ExtForCore] Pattern Buffer Proxy Info");
        provider.add("config.jade.plugin_gtceu.energy_converter_provider", "[ExtForCore] Energy Converter Mode");
        provider.add("config.jade.plugin_gtceu.ldp_endpoint", "[ExtForCore] Long Distance Pipeline Endpoint Info");
