...
import com.extfro.extfrocore.core.mixins.neoforge.ConfiguredModelBuilderAccessor;
import com.extfro.extfrocore.core.mixins.neoforge.ConfiguredModelListAccessor;
...
import com.extfro.extfrocore.utils.memoization.function.MemoizedBiFunction;
...
public class PipeModelBuilder<T extends ModelBuilder<T>> extends CustomLoaderBuilder<T> {
    ...
    private static final ResourceLocation PIPE_BLOCKED_OVERLAY = ExtForCore.id("block/pipe/blocked/pipe_blocked");
    ...
    private static BlockModelBuilder[] makeRestrictorModels(BlockModelProvider provider, float thickness) {
        ...
        for (Direction dir : GTUtil.DIRECTIONS) {
            ...
            ResourceLocation modelName = ExtForCore.id(modelPath);
