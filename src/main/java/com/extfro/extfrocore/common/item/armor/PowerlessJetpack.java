...
import com.extfro.extfrocore.api.item.armor.ArmorUtils;
import com.extfro.extfrocore.api.item.armor.IArmorLogic;
import com.extfro.extfrocore.api.item.component.*;
import com.extfro.extfrocore.api.item.component.IComponentCapability;
import com.extfro.extfrocore.api.item.datacomponents.GTArmor;
...
import com.extfro.extfrocore.utils.GradientUtil;
...
public class PowerlessJetpack implements IArmorLogic, IJetpack, IItemHUDProvider {
    ...
    public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot,
        ...
        return ExtForCore.id("textures/armor/liquid_fuel_jetpack.png");
    }
    ...
    public static class Behaviour implements IDurabilityBar, IItemComponent, ISubItemHandler, IAddInformation,
        ...
        public void fillItemCategory(Item item, CreativeModeTab category, NonNullList<ItemStack> items) {
            ...
            if (fluidHandlerItem != null) {
                fluidHandlerItem.fill(GTMaterials.Diesel.getFluid(tankCapacity), FluidAction.SIMULATE);
                items.add(copy);
            } else {
                items.add(copy);
            }
