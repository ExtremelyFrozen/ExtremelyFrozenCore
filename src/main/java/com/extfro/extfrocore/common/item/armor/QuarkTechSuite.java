...
import com.extfro.extfrocore.api.item.armor.ArmorLogicSuite;
...
import com.extfro.extfrocore.core.IFireImmuneEntity;
...
public class QuarkTechSuite extends ArmorLogicSuite implements IStepAssist {
    ...
    public QuarkTechSuite(ArmorItem.Type slot, int energyPerUse, long capacity, int tier) {
        ...
        if (ExtForCore.isClientSide() && this.shouldDrawHUD()) {
    ...
    public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot,
        ...
        return slot != EquipmentSlot.LEGS ?
                ExtForCore.id(String.format("textures/armor/%s_1.png", armorTexture)) :
                ExtForCore.id(String.format("textures/armor/%s_2.png", armorTexture));
    }
