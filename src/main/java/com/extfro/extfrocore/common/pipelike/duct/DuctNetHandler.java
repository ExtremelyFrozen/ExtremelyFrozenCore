...
public class DuctNetHandler implements IHazardParticleContainer {
    ...
    public static void emitPollutionParticles(ServerLevel level, BlockPos pos, Direction frontFacing) {
        ...
        float ySpd = frontFacing.getStepY() * 0.1F + 0.2F + 0.1F * EFValues.RNG.nextFloat();
        float xSpd;
        float zSpd;
        ...
        if (frontFacing.getStepY() == -1) {
            ...
            xSpd = frontFacing.getStepX() * (0.1F + 0.2F * EFValues.RNG.nextFloat());
            zSpd = frontFacing.getStepZ() * (0.1F + 0.2F * EFValues.RNG.nextFloat());
        }
