...
public class GTBedrockFluids {
    ...
    public static final ResourceKey<BedrockFluidDefinition> HEAVY_OIL = create(ExtForCore.id("heavy_oil_deposit"));
    public static final ResourceKey<BedrockFluidDefinition> LIGHT_OIL = create(ExtForCore.id("light_oil_deposit"));
    public static final ResourceKey<BedrockFluidDefinition> NATURAL_GAS = create(ExtForCore.id("natural_gas_deposit"));
    public static final ResourceKey<BedrockFluidDefinition> OIL = create(ExtForCore.id("oil_deposit"));
    public static final ResourceKey<BedrockFluidDefinition> RAW_OIL = create(ExtForCore.id("raw_oil_deposit"));
    public static final ResourceKey<BedrockFluidDefinition> SALT_WATER = create(ExtForCore.id("salt_water_deposit"));

    //////////////////////////////////////
    // ******** NETHER ********//
    //////////////////////////////////////

    public static final ResourceKey<BedrockFluidDefinition> LAVA = create(ExtForCore.id("lava_deposit"));
    public static final ResourceKey<BedrockFluidDefinition> NETHER_NATURAL_GAS = create(
            ExtForCore.id("nether_natural_gas_deposit"));
