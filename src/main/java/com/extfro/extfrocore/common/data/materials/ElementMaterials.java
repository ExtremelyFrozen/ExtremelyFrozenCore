...
import com.extfro.extfrocore.common.data.GTElements;
...
public class ElementMaterials {
    ...
    public static void register() {
        Actinium = new Material.Builder(ExtForCore.id("actinium"))
                .color(0xC3D1FF).secondaryColor(0x397090).iconSet(METALLIC)
                .element(GTElements.Ac)
                .buildAndRegister();

        Aluminium = new Material.Builder(ExtForCore.id("aluminium"))
                .ingot()
        ...
        Americium = new Material.Builder(ExtForCore.id("americium"))
                .ingot(3)
        ...
        Antimony = new Material.Builder(ExtForCore.id("antimony"))
                .ingot()
        ...
        Argon = new Material.Builder(ExtForCore.id("argon"))
                .gas().plasma()
                .color(0x00FF00)
                .element(GTElements.Ar)
                .buildAndRegister();

        Arsenic = new Material.Builder(ExtForCore.id("arsenic"))
                .dust()
        ...
        Astatine = new Material.Builder(ExtForCore.id("astatine"))
                .color(0x65204f).secondaryColor(0x17212b)
                .element(GTElements.At)
                .buildAndRegister();

        Barium = new Material.Builder(ExtForCore.id("barium"))
                .dust()
                .color(0xede192).secondaryColor(0xa7ad4d).iconSet(METALLIC)
                .element(GTElements.Ba)
                .buildAndRegister();

        Berkelium = new Material.Builder(ExtForCore.id("berkelium"))
                .color(0x645A88).iconSet(RADIOACTIVE)
                .element(GTElements.Bk)
                .buildAndRegister();

        Beryllium = new Material.Builder(ExtForCore.id("beryllium"))
                .ingot()
        ...
        Bismuth = new Material.Builder(ExtForCore.id("bismuth"))
                .ingot(1)
        ...
        Cadmium = new Material.Builder(ExtForCore.id("cadmium"))
                .dust()
        ...
        Cerium = new Material.Builder(ExtForCore.id("cerium"))
                .dust()
        ...
        Chlorine = new Material.Builder(ExtForCore.id("chlorine"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .element(GTElements.Cl)
                // TODO hazard
                .buildAndRegister();

        Chromium = new Material.Builder(ExtForCore.id("chromium"))
                .ingot(3)
        ...
        Cobalt = new Material.Builder(ExtForCore.id("cobalt"))
                .ingot()
        ...
        Copernicium = new Material.Builder(ExtForCore.id("copernicium"))
                .color(0x565c5d).secondaryColor(0xffd34b).iconSet(RADIOACTIVE)
                .element(GTElements.Cn)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Copper = new Material.Builder(ExtForCore.id("copper"))
                .ingot(1)
        ...
        Curium = new Material.Builder(ExtForCore.id("curium"))
                .color(0x7B544E).iconSet(RADIOACTIVE)
                .element(GTElements.Cm)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Darmstadtium = new Material.Builder(ExtForCore.id("darmstadtium"))
                .ingot().fluid()
        ...
        Deuterium = new Material.Builder(ExtForCore.id("deuterium"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .element(GTElements.D)
                .buildAndRegister();

        Dubnium = new Material.Builder(ExtForCore.id("dubnium"))
                .color(0xc7ddde).secondaryColor(0x00f3ff).iconSet(RADIOACTIVE)
                .element(GTElements.Db)
                .buildAndRegister();

        Dysprosium = new Material.Builder(ExtForCore.id("dysprosium"))
                .color(0x6a664b).secondaryColor(0x423307)
                .iconSet(METALLIC)
                .element(GTElements.Dy)
                .buildAndRegister();

        Einsteinium = new Material.Builder(ExtForCore.id("einsteinium"))
                .color(0xCE9F00).iconSet(RADIOACTIVE)
                .element(GTElements.Es)
                .buildAndRegister();

        Erbium = new Material.Builder(ExtForCore.id("erbium"))
                .color(0xeccbdb).secondaryColor(0x5d625a)
                .iconSet(METALLIC)
                .element(GTElements.Er)
                .buildAndRegister();

        Europium = new Material.Builder(ExtForCore.id("europium"))
                .ingot()
        ...
        Germanium = new Material.Builder(ExtForCore.id("germanium"))
                .color(0x4a4a4a).secondaryColor(0x2d2612).iconSet(SHINY)
                .element(GTElements.Ge)
                .buildAndRegister();

        Gold = new Material.Builder(ExtForCore.id("gold"))
                .ingot()
        ...
        Hafnium = new Material.Builder(ExtForCore.id("hafnium"))
                .color(0x99999A).secondaryColor(0x2b4a3a).iconSet(SHINY)
                .element(GTElements.Hf)
                .buildAndRegister();

        Hassium = new Material.Builder(ExtForCore.id("hassium"))
                .color(0x738786).secondaryColor(0x62ffd5)
                .iconSet(RADIOACTIVE)
                .element(GTElements.Hs)
                .buildAndRegister();

        Holmium = new Material.Builder(ExtForCore.id("holmium"))
                .color(0xf6fc9c).secondaryColor(0xa3a3a3)
                .iconSet(METALLIC)
                .element(GTElements.Ho)
                .buildAndRegister();

        Hydrogen = new Material.Builder(ExtForCore.id("hydrogen"))
                .gas()
                .color(0x0000B5)
                .element(GTElements.H)
                .buildAndRegister();

        Helium = new Material.Builder(ExtForCore.id("helium"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .plasma()
        ...
        Helium3 = new Material.Builder(ExtForCore.id("helium_3"))
                .gas(new FluidBuilder()
                        .customStill()
        ...
        Indium = new Material.Builder(ExtForCore.id("indium"))
                .ingot()
        ...
        Iodine = new Material.Builder(ExtForCore.id("iodine"))
                .dust()
                .color(0x3e4467).secondaryColor(0x021e40).iconSet(SHINY)
                .element(GTElements.I)
                .buildAndRegister();

        Iridium = new Material.Builder(ExtForCore.id("iridium"))
                .ingot(3)
        ...
        Iron = new Material.Builder(ExtForCore.id("iron"))
                .ingot()
        ...
        Krypton = new Material.Builder(ExtForCore.id("krypton"))
                .gas(new FluidBuilder()
                        .customStill()
                        .translation("gtceu.fluid.generic"))
                .color(0x80FF80)
        ...
        Lanthanum = new Material.Builder(ExtForCore.id("lanthanum"))
                .dust()
        ...
        Lawrencium = new Material.Builder(ExtForCore.id("lawrencium"))
                .color(0x5D7575)
                .iconSet(RADIOACTIVE)
                .element(GTElements.Lr)
                .buildAndRegister();

        Lead = new Material.Builder(ExtForCore.id("lead"))
                .ingot(1)
        ...
        Lithium = new Material.Builder(ExtForCore.id("lithium"))
                .dust()
        ...
        Livermorium = new Material.Builder(ExtForCore.id("livermorium"))
                .color(0x939393).secondaryColor(0xff5e5e).iconSet(RADIOACTIVE)
                .element(GTElements.Lv)
                .buildAndRegister();

        Lutetium = new Material.Builder(ExtForCore.id("lutetium"))
                .dust()
        ...
        Magnesium = new Material.Builder(ExtForCore.id("magnesium"))
                .dust()
        ...
        Mendelevium = new Material.Builder(ExtForCore.id("mendelevium"))
                .color(0x1D4ACF).iconSet(RADIOACTIVE)
                .element(GTElements.Md)
                .buildAndRegister();

        Manganese = new Material.Builder(ExtForCore.id("manganese"))
                .ingot()
        ...
        Meitnerium = new Material.Builder(ExtForCore.id("meitnerium"))
                .color(0x4f3c82).secondaryColor(0x6e90ff).iconSet(RADIOACTIVE)
                .element(GTElements.Mt)
                .buildAndRegister();

        Mercury = new Material.Builder(ExtForCore.id("mercury"))
                .fluid()
        ...
        Molybdenum = new Material.Builder(ExtForCore.id("molybdenum"))
                .ingot()
        ...
        Moscovium = new Material.Builder(ExtForCore.id("moscovium"))
                .color(0x2a1b40).secondaryColor(0xbd91ff).iconSet(RADIOACTIVE)
                .element(GTElements.Mc)
                .buildAndRegister();

        Neodymium = new Material.Builder(ExtForCore.id("neodymium"))
                .ingot().fluid().ore()
        ...
        Neon = new Material.Builder(ExtForCore.id("neon"))
                .gas()
                .color(0xFAB4B4)
                .element(GTElements.Ne)
                .buildAndRegister();

        Neptunium = new Material.Builder(ExtForCore.id("neptunium"))
                .color(0x284D7B).iconSet(RADIOACTIVE)
                .element(GTElements.Np)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Nickel = new Material.Builder(ExtForCore.id("nickel"))
                .ingot()
        ...
        Nihonium = new Material.Builder(ExtForCore.id("nihonium"))
                .color(0x323957).secondaryColor(0xbfabff).iconSet(RADIOACTIVE)
                .element(GTElements.Nh)
                .buildAndRegister();

        Niobium = new Material.Builder(ExtForCore.id("niobium"))
                .ingot().fluid()
        ...
        Nitrogen = new Material.Builder(ExtForCore.id("nitrogen"))
                .gas().plasma()
                .color(0x00BFC1)
                .element(GTElements.N)
                .buildAndRegister();

        Nobelium = new Material.Builder(ExtForCore.id("nobelium"))
                .color(0x3e4758).secondaryColor(0x43deff)
                .iconSet(RADIOACTIVE)
                .element(GTElements.No)
                .buildAndRegister();

        Oganesson = new Material.Builder(ExtForCore.id("oganesson"))
                .color(0x443936).secondaryColor(0xff1dbd).iconSet(RADIOACTIVE)
                .element(GTElements.Og)
                .buildAndRegister();

        Osmium = new Material.Builder(ExtForCore.id("osmium"))
                .ingot(4)
        ...
        Oxygen = new Material.Builder(ExtForCore.id("oxygen"))
                .gas()
                .liquid(new FluidBuilder()
                        .temperature(85)
                        .color(0x6688DD)
        ...
        Palladium = new Material.Builder(ExtForCore.id("palladium"))
                .ingot().fluid().ore()
        ...
        Phosphorus = new Material.Builder(ExtForCore.id("phosphorus"))
                .dust()
                .color(0x77332c).secondaryColor(0x220202)
                .element(GTElements.P)
                .buildAndRegister();

        Polonium = new Material.Builder(ExtForCore.id("polonium"))
        ...
        Platinum = new Material.Builder(ExtForCore.id("platinum"))
                .ingot()
        ...
        Plutonium239 = new Material.Builder(ExtForCore.id("plutonium_239"))
                .ingot(3)
        ...
        Plutonium241 = new Material.Builder(ExtForCore.id("plutonium_241"))
                .ingot(3)
                .liquid(new FluidBuilder().temperature(913))
        ...
        Potassium = new Material.Builder(ExtForCore.id("potassium"))
                .dust(1)
        ...
        Praseodymium = new Material.Builder(ExtForCore.id("praseodymium"))
                .color(0x718060).secondaryColor(0x3f3447).iconSet(METALLIC)
                .element(GTElements.Pr)
                .buildAndRegister();

        Promethium = new Material.Builder(ExtForCore.id("promethium"))
        ...
        Protactinium = new Material.Builder(ExtForCore.id("protactinium"))
                .color(0xA78B6D).iconSet(RADIOACTIVE)
                .element(GTElements.Pa)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Radon = new Material.Builder(ExtForCore.id("radon"))
                .gas()
                .color(0xFF39FF)
        ...
        Roentgenium = new Material.Builder(ExtForCore.id("roentgenium"))
                .color(0x388c48).secondaryColor(0x198a92).iconSet(RADIOACTIVE)
                .element(GTElements.Rg)
                .buildAndRegister();

        Rubidium = new Material.Builder(ExtForCore.id("rubidium"))
                .color(0xde0f0f).secondaryColor(0x3a1f1f).iconSet(SHINY)
                .element(GTElements.Rb)
                .buildAndRegister();

        Ruthenium = new Material.Builder(ExtForCore.id("ruthenium"))
                .ingot().fluid()
        ...
        Rutherfordium = new Material.Builder(ExtForCore.id("rutherfordium"))
                .color(0x6b6157).secondaryColor(0xFFF6A1).iconSet(RADIOACTIVE)
                .element(GTElements.Rf)
                .buildAndRegister();

        Samarium = new Material.Builder(ExtForCore.id("samarium"))
                .ingot()
        ...
        Silver = new Material.Builder(ExtForCore.id("silver"))
                .ingot()
        ...
        Tantalum = new Material.Builder(ExtForCore.id("tantalum"))
                .ingot()
        ...
        Titanium = new Material.Builder(ExtForCore.id("titanium")) // todo Ore? Look at EBF recipe here if we do Ti ores
                .ingot(3).fluid()
        ...
        Tritium = new Material.Builder(ExtForCore.id("tritium"))
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
        ...
        Tungsten = new Material.Builder(ExtForCore.id("tungsten"))
                .ingot(3)
        ...
        Uranium238 = new Material.Builder(ExtForCore.id("uranium_238"))
                .ingot(3)
        ...
        Uranium235 = new Material.Builder(ExtForCore.id("uranium_235"))
                .ingot(3)
                .liquid(new FluidBuilder().temperature(1405))
        ...
        Vanadium = new Material.Builder(ExtForCore.id("vanadium"))
                .ingot().fluid()
        ...
        Xenon = new Material.Builder(ExtForCore.id("xenon"))
                .gas()
                .color(0x00FFFF)
                .element(GTElements.Xe)
                .buildAndRegister();

        Ytterbium = new Material.Builder(ExtForCore.id("ytterbium"))
                .color(0xA7A7A7).iconSet(METALLIC)
                .element(GTElements.Yb)
                .buildAndRegister();

        Yttrium = new Material.Builder(ExtForCore.id("yttrium"))
                .ingot().fluid()
        ...
        Zinc = new Material.Builder(ExtForCore.id("zinc"))
                .ingot(1)
        ...
        Zirconium = new Material.Builder(ExtForCore.id("zirconium"))
                .color(0xb99b7e).secondaryColor(0x271813).iconSet(METALLIC)
                .element(GTElements.Zr)
                .buildAndRegister();

        Naquadah = new Material.Builder(ExtForCore.id("naquadah"))
                .ingot(4)
        ...
        NaquadahEnriched = new Material.Builder(ExtForCore.id("enriched_naquadah"))
                .ingot(4)
                .liquid(new FluidBuilder().customStill())
        ...
        Naquadria = new Material.Builder(ExtForCore.id("naquadria"))
                .ingot(3)
                .liquid(new FluidBuilder().customStill())
        ...
        Neutronium = new Material.Builder(ExtForCore.id("neutronium"))
                .ingot(6)
        ...
        Tritanium = new Material.Builder(ExtForCore.id("tritanium"))
                .ingot(6)
        ...
        Duranium = new Material.Builder(ExtForCore.id("duranium"))
                .ingot(5)
        ...
        Trinium = new Material.Builder(ExtForCore.id("trinium"))
                .ingot(7).fluid()
