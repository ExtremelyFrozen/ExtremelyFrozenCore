...
import com.extfro.extfrocore.api.cover.filter.*;
import com.extfro.extfrocore.api.data.chemical.ChemicalHelper;
import com.extfro.extfrocore.api.data.chemical.material.ItemMaterialData;
import com.extfro.extfrocore.api.data.chemical.material.MarkerMaterial;
import com.extfro.extfrocore.api.data.chemical.material.MarkerMaterials;
...
import com.extfro.extfrocore.api.data.chemical.material.stack.ItemMaterialInfo;
import com.extfro.extfrocore.api.data.chemical.material.stack.MaterialEntry;
import com.extfro.extfrocore.api.data.chemical.material.stack.MaterialStack;
...
import com.extfro.extfrocore.api.item.TagPrefixItem;
import com.extfro.extfrocore.api.item.armor.ArmorComponentItem;
import com.extfro.extfrocore.api.item.component.*;
import com.extfro.extfrocore.common.data.item.GTDataComponents;
import com.extfro.extfrocore.common.data.materials.GTFoods;
import com.extfro.extfrocore.common.item.armor.*;
import com.extfro.extfrocore.common.item.armor.GTArmorMaterials;
import com.extfro.extfrocore.common.item.behavior.*;
import com.extfro.extfrocore.common.item.behavior.MachineConfigCopyBehaviour;
import com.extfro.extfrocore.common.item.datacomponents.DataItem;
import com.extfro.extfrocore.common.item.modules.ImageModuleBehaviour;
import com.extfro.extfrocore.common.item.modules.TextModuleBehaviour;
...
import com.extfro.extfrocore.utils.memoization.GTMemoizer;
...
import static com.extfro.extfrocore.common.data.GTCreativeModeTabs.ITEM;
import static com.extfro.extfrocore.common.data.GTCreativeModeTabs.TOOL;
import static com.extfro.extfrocore.common.data.models.GTModels.createTextureModel;
import static com.extfro.extfrocore.common.data.models.GTModels.overrideModel;
...
public class GTItems {
    ...
    public static ItemEntry<Item> COMPRESSED_CLAY = REGISTRATE.item("compressed_clay", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Clay, EFValues.M)))).register();
    ...
    public static ItemEntry<Item> COMPRESSED_FIRECLAY = REGISTRATE.item("compressed_fireclay", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Fireclay, EFValues.M))))
            .register();
    ...
    public static ItemEntry<Item> SHAPE_EMPTY = REGISTRATE.item("empty_mold", Item::new)
            .lang("Empty Mold")
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Steel, EFValues.M * 4))))
            .register();
    ...
    public static ItemEntry<ComponentItem> PORTABLE_SCANNER = REGISTRATE.item("portable_scanner", ComponentItem::new)
            ...
            .properties(p -> p.stacksTo(1))
            .onRegister(attach(ElectricStats.createElectricItem(100_000L, EFValues.MV), new PortableScannerBehavior(0)))
            .register();
    ...
    public static ItemEntry<ComponentItem> PORTABLE_DEBUG_SCANNER = REGISTRATE
            ...
            .properties(p -> p.stacksTo(1))
            .onRegister(
                    attach(ElectricStats.createElectricItem(1_000_000L, EFValues.MV), new PortableScannerBehavior(1)))
            .register();
    ...
    public static ItemEntry<ComponentItem> createFluidCell(Material mat, int capacity, int matSize, int stackSize) {
        ...
        return REGISTRATE
                ...
                .onRegister(attach(cellName(),
                        ...
                        new ItemFluidContainer()))
                .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(mat, EFValues.M * matSize))))
                .register();
    }
    ...
    public static ItemEntry<ComponentItem> TOOL_LIGHTER_INVAR = REGISTRATE.item("invar_lighter", ComponentItem::new)
            ...
            .onRegister(attach(new FilteredFluidContainer(100, true, x -> x.is(CustomTags.LIGHTER_FLUIDS)),
                    new ItemFluidContainer()))
            .onRegister(modelPredicate(ExtForCore.id("lighter_open"),
    ...
    public static ItemEntry<Item> BATTERY_HULL_LV = REGISTRATE.item("lv_battery_hull", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.BatteryAlloy, EFValues.M))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_MV = REGISTRATE.item("mv_battery_hull", Item::new)
            .lang("Medium Battery Hull")
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.BatteryAlloy, EFValues.M * 3))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_HV = REGISTRATE.item("hv_battery_hull", Item::new)
            .lang("Large Battery Hull")
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.BatteryAlloy, EFValues.M * 9))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_SMALL_VANADIUM = REGISTRATE.item("ev_battery_hull", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.RedSteel, EFValues.M * 2))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_MEDIUM_VANADIUM = REGISTRATE.item("iv_battery_hull", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.RoseGold, EFValues.M * 6))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_LARGE_VANADIUM = REGISTRATE.item("luv_battery_hull", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.BlueSteel, EFValues.M * 18))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_MEDIUM_NAQUADRIA = REGISTRATE.item("zpm_battery_hull", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Europium, EFValues.M * 6))))
            .register();
    public static ItemEntry<Item> BATTERY_HULL_LARGE_NAQUADRIA = REGISTRATE.item("uv_battery_hull", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Americium, EFValues.M * 18))))
            .register();
    ...
    public static ItemEntry<ComponentItem> BATTERY_ULV_TANTALUM = REGISTRATE
            ...
            .onRegister(attach(ElectricStats.createRechargeableBattery(1000, EFValues.ULV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_LV_SODIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(80000, EFValues.LV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_MV_SODIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(360000, EFValues.MV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_HV_SODIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(1200000, EFValues.HV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_LV_LITHIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(120000, EFValues.LV)))
            .tag(CustomTags.LV_BATTERIES).register();
    public static ItemEntry<ComponentItem> BATTERY_MV_LITHIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(420000, EFValues.MV)))
            .tag(CustomTags.MV_BATTERIES).register();
    public static ItemEntry<ComponentItem> BATTERY_HV_LITHIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(1800000, EFValues.HV)))
            .tag(CustomTags.HV_BATTERIES).register();
    ...
    public static ItemEntry<ComponentItem> BATTERY_LV_CADMIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(100000, EFValues.LV)))
            .tag(CustomTags.LV_BATTERIES).register();
    public static ItemEntry<ComponentItem> BATTERY_MV_CADMIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(400000, EFValues.MV)))
            .tag(CustomTags.MV_BATTERIES).register();
    public static ItemEntry<ComponentItem> BATTERY_HV_CADMIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(1600000, EFValues.HV)))
            .tag(CustomTags.HV_BATTERIES).register();
    ...
    public static ItemEntry<ComponentItem> ENERGIUM_CRYSTAL = REGISTRATE.item("energy_crystal", ComponentItem::new)
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(6_400_000L, EFValues.HV)))
            .tag(CustomTags.HV_BATTERIES).register();
    public static ItemEntry<ComponentItem> LAPOTRON_CRYSTAL = REGISTRATE.item("lapotron_crystal", ComponentItem::new)
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(25_000_000L, EFValues.EV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_EV_VANADIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(10_240_000L, EFValues.EV)))
            .tag(CustomTags.EV_BATTERIES).register();
    public static ItemEntry<ComponentItem> BATTERY_IV_VANADIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(40_960_000L, EFValues.IV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_LuV_VANADIUM = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(163_840_000L, EFValues.LuV)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_ZPM_NAQUADRIA = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(655_360_000L, EFValues.ZPM)))
    ...
    public static ItemEntry<ComponentItem> BATTERY_UV_NAQUADRIA = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(2_621_440_000L, EFValues.UV)))
    ...
    public static ItemEntry<ComponentItem> ENERGY_LAPOTRONIC_ORB = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(250_000_000L, EFValues.IV)))
            .tag(CustomTags.IV_BATTERIES).register();
    public static ItemEntry<ComponentItem> ENERGY_LAPOTRONIC_ORB_CLUSTER = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(1_000_000_000L, EFValues.LuV)))
            .tag(CustomTags.LuV_BATTERIES).register();
    ...
    public static ItemEntry<ComponentItem> ENERGY_MODULE = REGISTRATE.item("energy_module", ComponentItem::new)
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(4_000_000_000L, EFValues.ZPM)))
            .tag(CustomTags.ZPM_BATTERIES).register();
    public static ItemEntry<ComponentItem> ENERGY_CLUSTER = REGISTRATE.item("energy_cluster", ComponentItem::new)
            .lang("Energy Cluster")
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(20_000_000_000L, EFValues.UV)))
            .tag(CustomTags.UV_BATTERIES).register();
    ...
    public static ItemEntry<ComponentItem> ZERO_POINT_MODULE = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createBattery(2000000000000L, EFValues.ZPM, true))).register();
    public static ItemEntry<ComponentItem> ULTIMATE_BATTERY = REGISTRATE.item("max_battery", ComponentItem::new)
            ...
            .model(overrideModel(ExtForCore.id("battery"), 8))
            .onRegister(modelPredicate(ExtForCore.id("battery"), ElectricStats::getStoredPredicate))
            .onRegister(attach(ElectricStats.createRechargeableBattery(Long.MAX_VALUE, EFValues.UHV)))
    ...
    public static ItemEntry<Item> ELECTRIC_MOTOR_UV = REGISTRATE.item("uv_electric_motor", Item::new)
            ...
            .tag(CustomTags.ELECTRIC_MOTORS)
            .register();
    public static ItemEntry<Item> ELECTRIC_MOTOR_UHV = EFAPI.isHighTier() ?
            REGISTRATE.item("uhv_electric_motor", Item::new).lang("UHV Electric Motor")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_MOTOR_UEV = EFAPI.isHighTier() ?
            REGISTRATE.item("uev_electric_motor", Item::new).lang("UEV Electric Motor")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_MOTOR_UIV = EFAPI.isHighTier() ?
            REGISTRATE.item("uiv_electric_motor", Item::new).lang("UIV Electric Motor")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_MOTOR_UXV = EFAPI.isHighTier() ?
            REGISTRATE.item("uxv_electric_motor", Item::new).lang("UXV Electric Motor")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_MOTOR_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_UHV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_UEV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_UIV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_UXV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> ELECTRIC_PUMP_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_UV = REGISTRATE
            ...
            .tag(CustomTags.FLUID_REGULATORS)
            .register();
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_UHV = EFAPI.isHighTier() ?
            REGISTRATE.item("uhv_fluid_regulator", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_UEV = EFAPI.isHighTier() ?
            REGISTRATE.item("uev_fluid_regulator", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_UIV = EFAPI.isHighTier() ?
            REGISTRATE.item("uiv_fluid_regulator", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_UXV = EFAPI.isHighTier() ?
            REGISTRATE.item("uxv_fluid_regulator", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> FLUID_REGULATOR_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_UV = REGISTRATE
            ...
            .tag(CustomTags.CONVEYOR_MODULES)
            .register();
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_UHV = EFAPI.isHighTier() ?
            REGISTRATE.item("uhv_conveyor_module", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_UEV = EFAPI.isHighTier() ?
            REGISTRATE.item("uev_conveyor_module", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_UIV = EFAPI.isHighTier() ?
            REGISTRATE.item("uiv_conveyor_module", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_UXV = EFAPI.isHighTier() ?
            REGISTRATE.item("uxv_conveyor_module", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> CONVEYOR_MODULE_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<Item> ELECTRIC_PISTON_UV = REGISTRATE.item("uv_electric_piston", Item::new)
            ...
            .tag(CustomTags.ELECTRIC_PISTONS)
            .register();
    public static ItemEntry<Item> ELECTRIC_PISTON_UHV = EFAPI.isHighTier() ?
            REGISTRATE.item("uhv_electric_piston", Item::new).lang("UHV Electric Piston")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_PISTON_UEV = EFAPI.isHighTier() ?
            REGISTRATE.item("uev_electric_piston", Item::new).lang("UEV Electric Piston")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_PISTON_UIV = EFAPI.isHighTier() ?
            REGISTRATE.item("uiv_electric_piston", Item::new).lang("UIV Electric Piston")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_PISTON_UXV = EFAPI.isHighTier() ?
            REGISTRATE.item("uxv_electric_piston", Item::new).lang("UXV Electric Piston")
                    .register() :
            null;
    public static ItemEntry<Item> ELECTRIC_PISTON_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<ComponentItem> ROBOT_ARM_UV = REGISTRATE.item("uv_robot_arm", ComponentItem::new)
            ...
            .tag(CustomTags.ROBOT_ARMS)
            .register();
    public static ItemEntry<ComponentItem> ROBOT_ARM_UHV = EFAPI.isHighTier() ?
            REGISTRATE.item("uhv_robot_arm", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> ROBOT_ARM_UEV = EFAPI.isHighTier() ?
            REGISTRATE.item("uev_robot_arm", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> ROBOT_ARM_UIV = EFAPI.isHighTier() ?
            REGISTRATE.item("uiv_robot_arm", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> ROBOT_ARM_UXV = EFAPI.isHighTier() ?
            REGISTRATE.item("uxv_robot_arm", ComponentItem::new)
                    ...
                    .register() :
            null;
    public static ItemEntry<ComponentItem> ROBOT_ARM_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<Item> FIELD_GENERATOR_UV = REGISTRATE.item("uv_field_generator", Item::new)
            ...
            .tag(CustomTags.FIELD_GENERATORS)
            .register();
    public static ItemEntry<Item> FIELD_GENERATOR_UHV = EFAPI.isHighTier() ?
            REGISTRATE.item("uhv_field_generator", Item::new).lang("UHV Field Generator")
                    .register() :
            null;
    public static ItemEntry<Item> FIELD_GENERATOR_UEV = EFAPI.isHighTier() ?
            REGISTRATE.item("uev_field_generator", Item::new).lang("UEV Field Generator")
                    .register() :
            null;
    public static ItemEntry<Item> FIELD_GENERATOR_UIV = EFAPI.isHighTier() ?
            REGISTRATE.item("uiv_field_generator", Item::new).lang("UIV Field Generator")
                    .register() :
            null;
    public static ItemEntry<Item> FIELD_GENERATOR_UXV = EFAPI.isHighTier() ?
            REGISTRATE.item("uxv_field_generator", Item::new).lang("UXV Field Generator")
                    .register() :
            null;
    public static ItemEntry<Item> FIELD_GENERATOR_OpV = EFAPI.isHighTier() ?
    ...
    public static ItemEntry<Item> EMITTER_UV = REGISTRATE.item("uv_emitter", Item::new).lang("UV Emitter")
            .tag(CustomTags.EMITTERS)
            .register();
    public static ItemEntry<Item> EMITTER_UHV = EFAPI.isHighTier() ? REGISTRATE.item("uhv_emitter", Item::new)
            .lang("UHV Emitter")
            .register() : null;
    public static ItemEntry<Item> EMITTER_UEV = EFAPI.isHighTier() ? REGISTRATE.item("uev_emitter", Item::new)
            .lang("UEV Emitter")
            .register() : null;
    public static ItemEntry<Item> EMITTER_UIV = EFAPI.isHighTier() ? REGISTRATE.item("uiv_emitter", Item::new)
            .lang("UIV Emitter")
            .register() : null;
    public static ItemEntry<Item> EMITTER_UXV = EFAPI.isHighTier() ? REGISTRATE.item("uxv_emitter", Item::new)
            .lang("UXV Emitter")
            .register() : null;
    public static ItemEntry<Item> EMITTER_OpV = EFAPI.isHighTier() ? REGISTRATE.item("opv_emitter", Item::new)
            .lang("OpV Emitter")
            .register() : null;
    ...
    public static ItemEntry<Item> SENSOR_UV = REGISTRATE.item("uv_sensor", Item::new).lang("UV Sensor")
            .tag(CustomTags.SENSORS)
            .register();
    public static ItemEntry<Item> SENSOR_UHV = EFAPI.isHighTier() ? REGISTRATE.item("uhv_sensor", Item::new)
            .lang("UHV Sensor")
            .register() : null;
    public static ItemEntry<Item> SENSOR_UEV = EFAPI.isHighTier() ? REGISTRATE.item("uev_sensor", Item::new)
            .lang("UEV Sensor")
            .register() : null;
    public static ItemEntry<Item> SENSOR_UIV = EFAPI.isHighTier() ? REGISTRATE.item("uiv_sensor", Item::new)
            .lang("UIV Sensor")
            .register() : null;
    public static ItemEntry<Item> SENSOR_UXV = EFAPI.isHighTier() ? REGISTRATE.item("uxv_sensor", Item::new)
            .lang("UXV Sensor")
            .register() : null;
    public static ItemEntry<Item> SENSOR_OpV = EFAPI.isHighTier() ? REGISTRATE.item("opv_sensor", Item::new)
            .lang("OpV Sensor")
            .register() : null;
    ...
    public static ItemEntry<Item> GLASS_TUBE = REGISTRATE.item("glass_tube", Item::new).lang("Glass Tube")
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Glass, EFValues.M))))
            .register();
    ...
    public static ItemEntry<Item> COMPONENT_GRINDER_DIAMOND = REGISTRATE.item("diamond_grinding_head", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Steel, EFValues.M * 8),
                    new MaterialStack(GTMaterials.Diamond, EFValues.M * 5))))
            .register();
    public static ItemEntry<Item> COMPONENT_GRINDER_TUNGSTEN = REGISTRATE.item("tungsten_grinding_head", Item::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Tungsten, EFValues.M * 4),
                    new MaterialStack(GTMaterials.VanadiumSteel, EFValues.M * 8),
                    new MaterialStack(GTMaterials.Diamond, EFValues.M))))
            .register();

    public static ItemEntry<Item> IRON_MINECART_WHEELS = REGISTRATE.item("iron_minecart_wheels", Item::new)
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Iron, EFValues.M))))
            .register();
    public static ItemEntry<Item> STEEL_MINECART_WHEELS = REGISTRATE.item("steel_minecart_wheels", Item::new)
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Steel, EFValues.M))))
            .register();
    ...
    public static ItemEntry<ComponentItem> ITEM_FILTER = REGISTRATE.item("item_filter", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Zinc, EFValues.M * 2),
                    new MaterialStack(GTMaterials.Steel, EFValues.M))))
            .register();
    ...
    public static ItemEntry<ComponentItem> SMART_ITEM_FILTER = REGISTRATE
            ...
            .onRegister(attach(new ItemFilterBehaviour(SmartItemFilter::loadFilter),
                    new CoverPlaceBehavior(GTCovers.ITEM_FILTER)))
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Zinc, EFValues.M * 3 / 2))))
            .register();
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL = REGISTRATE.item("solar_panel", ComponentItem::new)
            .lang("Solar Panel").onRegister(attach(new TooltipBehavior(lines -> {
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", 1, EFValues.VNF[EFValues.ULV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_ULV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                ...
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.ULV],
                        EFValues.VNF[EFValues.ULV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_LV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.LV],
                        EFValues.VNF[EFValues.LV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_MV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.MV],
                        EFValues.VNF[EFValues.MV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_HV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.HV],
                        EFValues.VNF[EFValues.HV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_EV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.EV],
                        EFValues.VNF[EFValues.EV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_IV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.IV],
                        EFValues.VNF[EFValues.IV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_LuV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.LuV],
                        EFValues.VNF[EFValues.LuV]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_ZPM = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.ZPM],
                        EFValues.VNF[EFValues.ZPM]));
    ...
    public static ItemEntry<ComponentItem> COVER_SOLAR_PANEL_UV = REGISTRATE
            ...
            .onRegister(attach(new TooltipBehavior(lines -> {
                lines.addAll(LangHandler.getMultiLang("item.gtceu.solar_panel.tooltip"));
                lines.add(Component.translatable("gtceu.universal.tooltip.voltage_out", EFValues.V[EFValues.UV],
                        EFValues.VNF[EFValues.UV]));
    ...
    public static ItemEntry<ComponentItem> PROGRAMMED_CIRCUIT = REGISTRATE
            ...
            .model(overrideModel(ExtForCore.id("circuit"), 33))
            .onRegister(modelPredicate(ExtForCore.id("circuit"),
    ...
    public static ItemEntry<ComponentItem> POWER_UNIT_LV = REGISTRATE.item("lv_power_unit", ComponentItem::new)
            ...
            .onRegister(attach(ElectricStats.createElectricItem(100000L, EFValues.LV)))
            .register();
    public static ItemEntry<ComponentItem> POWER_UNIT_MV = REGISTRATE.item("mv_power_unit", ComponentItem::new)
            ...
            .onRegister(attach(ElectricStats.createElectricItem(400000L, EFValues.MV)))
            .register();
    public static ItemEntry<ComponentItem> POWER_UNIT_HV = REGISTRATE.item("hv_power_unit", ComponentItem::new)
            ...
            .onRegister(attach(ElectricStats.createElectricItem(1600000L, EFValues.HV)))
            .register();
    public static ItemEntry<ComponentItem> POWER_UNIT_EV = REGISTRATE.item("ev_power_unit", ComponentItem::new)
            ...
            .onRegister(attach(ElectricStats.createElectricItem(6400000L, EFValues.EV)))
            .register();
    public static ItemEntry<ComponentItem> POWER_UNIT_IV = REGISTRATE.item("iv_power_unit", ComponentItem::new)
            ...
            .onRegister(attach(ElectricStats.createElectricItem(25600000L, EFValues.IV)))
            .register();
    ...
    public static ItemEntry<ComponentItem> NANO_SABER = REGISTRATE.item("nano_saber", ComponentItem::new)
            .lang("Nano Saber")
            .properties(p -> p.stacksTo(1))
            .onRegister(attach(new NanoSaberBehavior(), ElectricStats.createElectricItem(4_000_000L, EFValues.HV)))
            .model((ctx, prov) -> {
    ...
    public static ItemEntry<ComponentItem> PROSPECTOR_LV = REGISTRATE.item("prospector.lv", ComponentItem::new)
            ...
            .properties(p -> p.stacksTo(1))
            .onRegister(attach(ElectricStats.createElectricItem(100_000L, EFValues.LV),
                    new ProspectorScannerBehavior(2, EFValues.V[EFValues.LV] / 16L, ProspectorMode.ORE)))
            .register();
    public static ItemEntry<ComponentItem> PROSPECTOR_HV = REGISTRATE.item("prospector.hv", ComponentItem::new)
            ...
            .properties(p -> p.stacksTo(1))
            .onRegister(attach(ElectricStats.createElectricItem(1_600_000L, EFValues.HV),
                    new ProspectorScannerBehavior(3, EFValues.V[EFValues.HV] / 16L, ProspectorMode.ORE,
    ...
    public static ItemEntry<ComponentItem> PROSPECTOR_LuV = REGISTRATE.item("prospector.luv", ComponentItem::new)
            ...
            .properties(p -> p.stacksTo(1))
            .onRegister(attach(ElectricStats.createElectricItem(1_000_000_000L, EFValues.LuV),
                    new ProspectorScannerBehavior(5, EFValues.V[EFValues.LuV] / 16L, ProspectorMode.ORE,
                            ProspectorMode.FLUID,
                            ConfigHolder.INSTANCE.machines.doBedrockOres ? ProspectorMode.BEDROCK_ORE : null)))
            .register();
    ...
    public static ItemEntry<ComponentItem> ITEM_MAGNET_LV = REGISTRATE.item("lv_item_magnet", ComponentItem::new)
            ...
            .onRegister(attach(ElectricStats.createElectricItem(100_000L, EFValues.LV), new ItemMagnetBehavior(8)))
            .register();
    public static ItemEntry<ComponentItem> ITEM_MAGNET_HV = REGISTRATE.item("hv_item_magnet", ComponentItem::new)
            ...
            .properties(p -> p.stacksTo(1)
                    ...
                    .component(GTDataComponents.SIMPLE_ITEM_FILTER,
                            new SimpleItemFilter(true, true, Collections.emptyList())))
            .onRegister(attach(ElectricStats.createElectricItem(1_600_000L, EFValues.HV), new ItemMagnetBehavior(32)))
            .register();
    ...
    public static ItemEntry<ComponentItem> TURBINE_ROTOR = REGISTRATE.item("turbine_rotor", ComponentItem::new)
            ...
            .properties(p -> p.stacksTo(1))
            .model((ctx, prov) -> createTextureModel(ctx, prov, ExtForCore.id("item/tools/turbine")))
    ...
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_ULV = REGISTRATE.item("ulv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Lead, EFValues.M * 2),
                    new MaterialStack(GTMaterials.IronMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_LV = REGISTRATE.item("lv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Steel, EFValues.M * 2),
                    new MaterialStack(GTMaterials.IronMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_MV = REGISTRATE.item("mv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Aluminium, EFValues.M * 2),
                    new MaterialStack(GTMaterials.SteelMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_HV = REGISTRATE.item("hv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.BlackSteel, EFValues.M * 2),
                    new MaterialStack(GTMaterials.SteelMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_EV = REGISTRATE.item("ev_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Platinum, EFValues.M * 2),
                    new MaterialStack(GTMaterials.NeodymiumMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_IV = REGISTRATE.item("iv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Iridium, EFValues.M * 2),
                    new MaterialStack(GTMaterials.NeodymiumMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_LuV = REGISTRATE.item("luv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Osmiridium, EFValues.M * 2),
                    new MaterialStack(GTMaterials.SamariumMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_ZPM = REGISTRATE.item("zpm_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Europium, EFValues.M * 2),
                    new MaterialStack(GTMaterials.SamariumMagnetic, EFValues.M / 2))))
            .register();
    public static ItemEntry<ComponentItem> VOLTAGE_COIL_UV = REGISTRATE.item("uv_voltage_coil", ComponentItem::new)
            ...
            .onRegister(materialInfo(new ItemMaterialInfo(new MaterialStack(GTMaterials.Tritanium, EFValues.M * 2),
                    new MaterialStack(GTMaterials.SamariumMagnetic, EFValues.M / 2))))
            .register();
    ...
    public static ItemEntry<ArmorComponentItem> ELECTRIC_JETPACK = REGISTRATE
            ...
            .transform(addArmorClientExtensions())
            .tag(ItemTags.CHEST_ARMOR)
            .model(overrideModel(ExtForCore.id("electric_jetpack"), 8))
            .onRegister(modelPredicate(ExtForCore.id("electric_jetpack"), ElectricStats::getStoredPredicate))
            .register();
