...
import com.extfro.extfrocore.api.data.chemical.material.info.MaterialFlag;
...
import com.extfro.extfrocore.common.data.materials.*;
...
public class GTMaterials {
    ...
    public static Material get(String name) {
        var mat = EFAPI.materialManager.getMaterial(ResourceLocation.parse(name));
        // material could be null here due to the registry grabbing a material that isn't in the map
        if (mat == null || mat.isNull()) {
            ExtForCore.LOGGER.warn("{} is not a known Material", name);
    ...
    public static final MarkerMaterial NULL = new MarkerMaterial(ExtForCore.id("null"));
