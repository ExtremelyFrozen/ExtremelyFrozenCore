...
import com.extfro.extfrocore.common.machine.multiblock.electric.research.HPCAMachine;
import com.extfro.extfrocore.common.machine.multiblock.electric.research.NetworkSwitchMachine;
import com.extfro.extfrocore.common.machine.multiblock.electric.research.ResearchStationMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.DataAccessHatchMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.ObjectHolderMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.OpticalComputationHatchMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.OpticalDataHatchMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.hpca.*;
...
import static com.extfro.extfrocore.common.data.GTMachines.CREATIVE_TOOLTIPS;
...
public class GTResearchMachines {
    ...
    public static final MultiblockMachineDefinition RESEARCH_STATION = REGISTRATE
            ...
            .shapeInfo(definition -> MultiblockShapeInfo.builder()
                    ...
                    .where('E', GTMachines.ENERGY_INPUT_HATCH[EFValues.LuV], Direction.SOUTH)
                    ...
                    .build())
            .sidedWorkableCasingModel(ExtForCore.id("block/casings/hpca/advanced_computer_casing"),
                    ExtForCore.id("block/multiblock/research_station"))
            .register();
    ...
    public static final MachineDefinition OBJECT_HOLDER = REGISTRATE.machine("object_holder", ObjectHolderMachine::new)
            ...
            .model(createWorkableTieredHullMachineModel(ExtForCore.id("block/machines/object_holder"))
    ...
    public static final MachineDefinition NETWORK_SWITCH = REGISTRATE
            ...
            .shapeInfo(definition -> MultiblockShapeInfo.builder()
                    ...
                    .build())
            .sidedWorkableCasingModel(ExtForCore.id("block/casings/hpca/computer_casing"),
                    ExtForCore.id("block/multiblock/network_switch"))
            .register();
    ...
    public static final MachineDefinition HIGH_PERFORMANCE_COMPUTING_ARRAY = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                MultiblockShapeInfo.ShapeInfoBuilder builder = MultiblockShapeInfo.builder()
                        ...
                        .where('E', GTMachines.ENERGY_INPUT_HATCH[EFValues.LuV], Direction.SOUTH)
                        .where('H', GTMachines.FLUID_IMPORT_HATCH[EFValues.LV], Direction.SOUTH)
            ...
            .sidedWorkableCasingModel(ExtForCore.id("block/casings/hpca/computer_casing"),
                    ExtForCore.id("block/multiblock/hpca"))
            .register();
    ...
    public static final MachineDefinition HPCA_COMPUTATION_COMPONENT = registerHPCAPart(
            ...
            .tooltips(
                    Component.translatable("gtceu.machine.hpca.component_general.upkeep_eut", EFValues.VA[EFValues.EV]),
                    Component.translatable("gtceu.machine.hpca.component_general.max_eut", EFValues.VA[EFValues.LuV]),
    ...
    public static final MachineDefinition HPCA_ADVANCED_COMPUTATION_COMPONENT = registerHPCAPart(
            ...
            .tooltips(
                    Component.translatable("gtceu.machine.hpca.component_general.upkeep_eut", EFValues.VA[EFValues.IV]),
                    Component.translatable("gtceu.machine.hpca.component_general.max_eut", EFValues.VA[EFValues.ZPM]),
    ...
    public static final MachineDefinition HPCA_ACTIVE_COOLER_COMPONENT = registerHPCAPart(
            ...
            .tooltips(Component.translatable("gtceu.machine.hpca.component_general.max_eut", EFValues.VA[EFValues.IV]),
    ...
    public static final MachineDefinition HPCA_BRIDGE_COMPONENT = registerHPCAPart(
            ...
            .tooltips(Component.translatable("gtceu.machine.hpca.component_type.bridge"),
                    Component.translatable("gtceu.machine.hpca.component_general.max_eut", EFValues.VA[EFValues.IV]),
                    Component.translatable("gtceu.part_sharing.disabled"))
            .register();
    ...
    private static MachineBuilder<MachineDefinition, ?> registerHPCAPart(String name, String displayName,
        ...
        return REGISTRATE.machine(name, constructor)
                ...
                .model(createHPCAPartModel(isAdvanced,
                        ExtForCore.id("block/overlay/machine/hpca/" + texture),
                        ExtForCore.id("block/overlay/machine/hpca/damaged" + (isAdvanced ? "_advanced" : ""))));
    }
