...
import com.extfro.extfrocore.client.renderer.machine.DynamicRenderHelper;
...
import com.extfro.extfrocore.common.machine.multiblock.electric.DistillationTowerMachine;
import com.extfro.extfrocore.common.machine.multiblock.electric.gcym.*;
...
import static com.extfro.extfrocore.api.machine.multiblock.PartAbility.*;
import static com.extfro.extfrocore.api.machine.property.GTMachineModelProperties.IS_FORMED;
...
import static com.extfro.extfrocore.common.data.GCYMRecipeTypes.ALLOY_BLAST_RECIPES;
import static com.extfro.extfrocore.common.data.GTBlocks.*;
import static com.extfro.extfrocore.common.data.GTMachines.*;
import static com.extfro.extfrocore.common.data.GTMaterials.NaquadahAlloy;
import static com.extfro.extfrocore.common.data.GTRecipeModifiers.*;
import static com.extfro.extfrocore.common.data.GTRecipeTypes.*;
import static com.extfro.extfrocore.common.data.machines.GTMachineUtils.registerTieredMachines;
...
public class GCYMMachines {
    ...
    public static final MachineDefinition[] PARALLEL_HATCH = registerTieredMachines("parallel_hatch",
            ...
            (tier, builder) -> builder
                    ...
                    .model(createWorkableTieredHullMachineModel(
                            ExtForCore.id("block/machines/parallel_hatch_mk" + (tier - 4)))
    ...
    public final static MultiblockMachineDefinition LARGE_MACERATION_TOWER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/secure_maceration_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_maceration_tower"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_CHEMICAL_BATH = REGISTRATE
            ...
            .hasBER(true)
            .modelProperty(GTMachineModelProperties.RECIPE_LOGIC_STATUS, RecipeLogic.Status.IDLE)
            .model(createWorkableCasingMachineModel(ExtForCore.id("block/casings/gcym/watertight_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_chemical_bath"))
    ...
    public final static MultiblockMachineDefinition LARGE_CENTRIFUGE = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/vibration_safe_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_centrifuge"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_MIXER = REGISTRATE
            ...
            .hasBER(true)
            .modelProperty(GTMachineModelProperties.RECIPE_LOGIC_STATUS, RecipeLogic.Status.IDLE)
            .model(createWorkableCasingMachineModel(ExtForCore.id("block/casings/gcym/reaction_safe_mixing_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_mixer"))
                    .andThen(b -> b.addDynamicRenderer(DynamicRenderHelper::makeRecipeFluidAreaRender)))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_ELECTROLYZER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/nonconducting_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_electrolyzer"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_PACKER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('A', Predicates.air())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_robust_tungstensteel"),
                    ExtForCore.id("block/multiblock/gcym/large_packer"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_ASSEMBLER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', Predicates.any())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/large_scale_assembling_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_assembler"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_CIRCUIT_ASSEMBLER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/large_scale_assembling_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_circuit_assembler"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_ARC_SMELTER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', Predicates.any())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/high_temperature_smelting_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_arc_smelter"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_ENGRAVING_LASER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('A', Predicates.air())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/laser_safe_engraving_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_engraving_laser"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_SIFTING_FUNNEL = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/vibration_safe_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_sifting_funnel"))
            .register();
    ...
    public final static MultiblockMachineDefinition BLAST_ALLOY_SMELTER = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                var builder = MultiblockShapeInfo.builder()
                        ...
                        .where('I', ITEM_IMPORT_BUS[EFValues.LV], Direction.WEST)
            ...
            .workableCasingModel(ExtForCore.id("block/casings/gcym/high_temperature_smelting_casing"),
                    ExtForCore.id("block/multiblock/gcym/blast_alloy_smelter"))
                                    ...
                                    .translatable(
                                            FormattingUtil
                                                    .formatNumbers(coilMachine.getCoilType().getCoilTemperature() +
                                                            100L * Math.max(0, coilMachine.getTier() - EFValues.MV)) +
                                                    "K")
    ...
    public final static MultiblockMachineDefinition LARGE_AUTOCLAVE = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', any())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/watertight_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_autoclave"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_MATERIAL_PRESS = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('A', air())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/stress_proof_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_material_press"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_BREWER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', any())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/corrosion_proof_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_brewer"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_CUTTER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', any())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/shock_proof_cutting_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_cutter"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_DISTILLERY = REGISTRATE
            ...
            .workableCasingModel(ExtForCore.id("block/casings/gcym/watertight_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_distillery"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_EXTRACTOR = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/watertight_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_extractor"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_EXTRUDER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/stress_proof_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_extruder"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_SOLIDIFIER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/watertight_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_solidifier"))
            .register();
    ...
    public final static MultiblockMachineDefinition LARGE_WIREMILL = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/gcym/stress_proof_casing"),
                    ExtForCore.id("block/multiblock/gcym/large_wiremill"))
            .register();
    ...
    public static final MultiblockMachineDefinition ROTARY_HEARTH_FURNACE = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                var builder = MultiblockShapeInfo.builder()
                        ...
                        .where('E', ENERGY_INPUT_HATCH[EFValues.LV], Direction.SOUTH)
                        .where('L', ITEM_IMPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('O', ITEM_EXPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('Q', FLUID_IMPORT_HATCH[EFValues.LV], Direction.NORTH)
            ...
            .workableCasingModel(ExtForCore.id("block/casings/gcym/high_temperature_smelting_casing"),
                    ExtForCore.id("block/multiblock/gcym/rotary_hearth_furnace"))
            .additionalDisplay((controller, components) -> {
                if (controller instanceof CoilWorkableElectricMultiblockMachine coilMachine && controller.isFormed()) {
                    components.add(Component.translatable("gtceu.multiblock.blast_furnace.max_temperature",
    ...
    public final static MultiblockMachineDefinition MEGA_VACUUM_FREEZER = REGISTRATE
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_frost_proof"),
                    ExtForCore.id("block/multiblock/gcym/mega_vacuum_freezer"))
            .register();
    // spotless:on
}
