...
import com.extfro.extfrocore.integration.ae2.machine.*;

import net.minecraft.network.chat.Component;

import static com.extfro.extfrocore.api.EFValues.EV;
...
public class GTAEMachines {
    ...
    public final static MachineDefinition ITEM_IMPORT_BUS_ME = REGISTRATE
            ...
            .colorOverlayTieredHullModel(ExtForCore.id("block/overlay/appeng/me_input_bus"))
            .tooltips(
    ...
    public final static MachineDefinition ITEM_EXPORT_BUS_ME = REGISTRATE
            ...
            .colorOverlayTieredHullModel(ExtForCore.id("block/overlay/appeng/me_output_bus"))
            .tooltips(
    ...
    public final static MachineDefinition FLUID_IMPORT_HATCH_ME = REGISTRATE
            ...
            .colorOverlayTieredHullModel(ExtForCore.id("block/overlay/appeng/me_input_hatch"))
            .tooltips(
    ...
    public final static MachineDefinition FLUID_EXPORT_HATCH_ME = REGISTRATE
            ...
            .colorOverlayTieredHullModel(ExtForCore.id("block/overlay/appeng/me_output_hatch"))
            .tooltips(
    ...
    public static final MachineDefinition ME_PATTERN_BUFFER = REGISTRATE
            ...
            .rotationState(RotationState.ALL)
            .colorOverlayTieredHullModel(ExtForCore.id("block/overlay/appeng/me_buffer_hatch"))
    ...
    public static final MachineDefinition ME_PATTERN_BUFFER_PROXY = REGISTRATE
            ...
            .abilities(PartAbility.IMPORT_ITEMS, PartAbility.IMPORT_FLUIDS, PartAbility.EXPORT_FLUIDS,
                    PartAbility.EXPORT_ITEMS)
            .rotationState(RotationState.ALL)
            .colorOverlayTieredHullModel(ExtForCore.id("block/overlay/appeng/me_buffer_hatch_proxy"))
