...
public class HigherDegreeMaterials {
    ...
    public static void register() {
        Electrotine = new Material.Builder(ExtForCore.id("electrotine"))
                .dust().ore(5, 1, true)
        ...
        EnderEye = new Material.Builder(ExtForCore.id("ender_eye"))
                .gem(1)
        ...
        Diatomite = new Material.Builder(ExtForCore.id("diatomite"))
                .dust(1).ore()
                .color(0xfffafa)
                .components(Flint, 8, Hematite, 1, Sapphire, 1)
                .buildAndRegister();

        RedSteel = new Material.Builder(ExtForCore.id("red_steel"))
                .ingot(3).fluid()
        ...
        BlueSteel = new Material.Builder(ExtForCore.id("blue_steel"))
                .ingot(3).fluid()
        ...
        Basalt = new Material.Builder(ExtForCore.id("basalt"))
                .dust(1)
        ...
        GraniticMineralSand = new Material.Builder(ExtForCore.id("granitic_mineral_sand"))
                .dust(1).ore()
        ...
        Redrock = new Material.Builder(ExtForCore.id("redrock"))
                .dust(1)
        ...
        GarnetSand = new Material.Builder(ExtForCore.id("garnet_sand"))
                .dust(1).ore()
        ...
        HSSG = new Material.Builder(ExtForCore.id("hssg"))
                .ingot(3).fluid()
                ...
                .cableProperties(EFValues.V[6], 4, 2)
                .blast(b -> b.temp(4200, GasTier.MID)
                        .blastStats(VA[EFValues.EV], 1300)
                        .vacuumStats(VA[HV]))
                .buildAndRegister();

        RedAlloy = new Material.Builder(ExtForCore.id("red_alloy"))
                .ingot(0)
                ...
                .cableProperties(EFValues.V[0], 1, 0)
                .buildAndRegister();

        BasalticMineralSand = new Material.Builder(ExtForCore.id("basaltic_mineral_sand"))
                .dust(1).ore()
        ...
        HSSE = new Material.Builder(ExtForCore.id("hsse"))
                .ingot(4).fluid()
                ...
                .blast(b -> b.temp(5000, GasTier.HIGH)
                        .blastStats(VA[EFValues.EV], 1400)
                        .vacuumStats(VA[HV]))
                .buildAndRegister();

        HSSS = new Material.Builder(ExtForCore.id("hsss"))
                .ingot(4).fluid()
                ...
                .blast(b -> b.temp(5000, GasTier.HIGH)
                        .blastStats(VA[EFValues.EV], 1500)
                        .vacuumStats(VA[EV], 200))
                .buildAndRegister();

        IridiumMetalResidue = new Material.Builder(ExtForCore.id("iridium_metal_residue"))
                .dust()
        ...
        Granite = new Material.Builder(ExtForCore.id("granite"))
                .dust()
        ...
        Brick = new Material.Builder(ExtForCore.id("brick"))
                .dust()
        ...
        Fireclay = new Material.Builder(ExtForCore.id("fireclay"))
                .dust()
        ...
        Diorite = new Material.Builder(ExtForCore.id("diorite"))
                .dust()
        ...
        BlueAlloy = new Material.Builder(ExtForCore.id("blue_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1400))
                ...
                .cableProperties(EFValues.V[HV], 2, 1)
                .buildAndRegister();

        RadAway = new Material.Builder(ExtForCore.id("rad_away"))
                .dust()
        ...
        Blackstone = new Material.Builder(ExtForCore.id("blackstone"))
                .dust()
