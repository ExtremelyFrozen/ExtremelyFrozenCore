package com.extfro.extfrocore.common.data.machines;
...
import com.extfro.extfrocore.api.machine.multiblock.CoilWorkableElectricMultiblockMachine;
...
import com.extfro.extfrocore.api.pattern.FactoryBlockPattern;
import com.extfro.extfrocore.api.pattern.MultiblockShapeInfo;
import com.extfro.extfrocore.api.pattern.Predicates;
import com.extfro.extfrocore.api.pattern.TraceabilityPredicate;
import com.extfro.extfrocore.client.renderer.machine.*;
import com.extfro.extfrocore.client.util.TooltipHelper;
import com.extfro.extfrocore.common.block.BoilerFireboxType;
import com.extfro.extfrocore.common.data.*;
import com.extfro.extfrocore.common.machine.multiblock.electric.*;
import com.extfro.extfrocore.common.machine.multiblock.electric.BedrockOreMinerMachine;
import com.extfro.extfrocore.common.machine.multiblock.primitive.CharcoalPileIgniterMachine;
import com.extfro.extfrocore.common.machine.multiblock.primitive.CokeOvenMachine;
import com.extfro.extfrocore.common.machine.multiblock.primitive.PrimitiveBlastFurnaceMachine;
...
import static com.extfro.extfrocore.api.pattern.Predicates.*;
import static com.extfro.extfrocore.api.pattern.util.RelativeDirection.*;
import static com.extfro.extfrocore.common.data.GTBlocks.*;
...
import static com.extfro.extfrocore.common.data.GTRecipeModifiers.*;
import static com.extfro.extfrocore.common.data.GTRecipeTypes.DUMMY_RECIPES;
import static com.extfro.extfrocore.common.data.machines.GTMachineUtils.*;
import static com.extfro.extfrocore.common.data.models.GTMachineModels.*;
import static com.extfro.extfrocore.common.registry.GTRegistration.REGISTRATE;
import static com.extfro.extfrocore.utils.FormattingUtil.toRomanNumeral;
...
public class GTMultiMachines {
    ...
    public static final MultiblockMachineDefinition LARGE_BOILER_BRONZE = registerLargeBoiler("bronze",
            ...
            ExtForCore.id("block/casings/solid/machine_casing_bronze_plated_bricks"), BoilerFireboxType.BRONZE_FIREBOX,
    ...
    public static final MultiblockMachineDefinition LARGE_BOILER_STEEL = registerLargeBoiler("steel",
            ...
            ExtForCore.id("block/casings/solid/machine_casing_solid_steel"), BoilerFireboxType.STEEL_FIREBOX,
    ...
    public static final MultiblockMachineDefinition LARGE_BOILER_TITANIUM = registerLargeBoiler("titanium",
            ...
            ExtForCore.id("block/casings/solid/machine_casing_stable_titanium"), BoilerFireboxType.TITANIUM_FIREBOX,
    ...
    public static final MultiblockMachineDefinition COKE_OVEN = REGISTRATE.multiblock("coke_oven", CokeOvenMachine::new)
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_coke_bricks"),
                    ExtForCore.id("block/multiblock/coke_oven"))
            .register();
    ...
    public static final MultiblockMachineDefinition PRIMITIVE_BLAST_FURNACE = REGISTRATE
            ...
            .model(createWorkableCasingMachineModel(ExtForCore.id("block/casings/solid/machine_primitive_bricks"),
                    ExtForCore.id("block/multiblock/primitive_blast_furnace"))
    ...
    public static final MultiblockMachineDefinition ELECTRIC_BLAST_FURNACE = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                var builder = MultiblockShapeInfo.builder()
                        ...
                        .where('E', ENERGY_INPUT_HATCH[EFValues.LV], Direction.SOUTH)
                        .where('I', ITEM_IMPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('O', ITEM_EXPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('F', FLUID_IMPORT_HATCH[EFValues.LV], Direction.WEST)
                        .where('D', FLUID_EXPORT_HATCH[EFValues.LV], Direction.EAST)
                        .where('H', MUFFLER_HATCH[EFValues.LV], Direction.UP)
                        .where('M', MAINTENANCE_HATCH, Direction.NORTH);
                EFAPI.HEATING_COILS.entrySet().stream()
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_heatproof"),
                    ExtForCore.id("block/multiblock/electric_blast_furnace"))
                    ...
                    components.add(Component.translatable("gtceu.multiblock.blast_furnace.max_temperature",
                            Component.translatable(
                                    FormattingUtil.formatNumbers(coilMachine.getCoilType().getCoilTemperature() +
                                            100L * Math.max(0, coilMachine.getTier() - EFValues.MV)) + "K")
    ...
    public static final MultiblockMachineDefinition LARGE_CHEMICAL_REACTOR = REGISTRATE
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_inert_ptfe"),
                    ExtForCore.id("block/multiblock/large_chemical_reactor"))
            .register();
    ...
    public static final MultiblockMachineDefinition IMPLOSION_COMPRESSOR = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', Predicates.air())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_solid_steel"),
                    ExtForCore.id("block/multiblock/implosion_compressor"))
            .register();
    ...
    public static final MultiblockMachineDefinition PYROLYSE_OVEN = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                var builder = MultiblockShapeInfo.builder()
                        ...
                        .where('I', ITEM_IMPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('O', ITEM_EXPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('F', FLUID_IMPORT_HATCH[EFValues.LV], Direction.NORTH)
                        .where('D', FLUID_EXPORT_HATCH[EFValues.LV], Direction.NORTH)
                        .where('H', MUFFLER_HATCH[EFValues.LV], Direction.SOUTH)
                        .where('M', MAINTENANCE_HATCH, Direction.NORTH)
                        .where('#', Blocks.AIR.defaultBlockState());
                EFAPI.HEATING_COILS.entrySet().stream()
                        .sorted(Comparator.comparingInt(entry -> entry.getKey().getTier()))
            ...
            .workableCasingModel(ExtForCore.id("block/casings/voltage/ulv/side"),
                    ExtForCore.id("block/multiblock/pyrolyse_oven"))
    ...
    public static final MultiblockMachineDefinition MULTI_SMELTER = REGISTRATE
            ...
            .recoveryItems(
                    () -> new ItemLike[] {
                            GTMaterialItems.MATERIAL_ITEMS.get(TagPrefix.dustTiny, GTMaterials.Ash).get() })
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_heatproof"),
                    ExtForCore.id("block/multiblock/multi_furnace"))
            .additionalDisplay((controller, components) -> {
                if (controller instanceof CoilWorkableElectricMultiblockMachine coilMachine && controller.isFormed()) {
    ...
    public static final MultiblockMachineDefinition CRACKER = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                var builder = MultiblockShapeInfo.builder()
                        ...
                        .where('E', ENERGY_INPUT_HATCH[EFValues.LV], Direction.WEST)
                        .where('I', ITEM_IMPORT_BUS[EFValues.LV], Direction.NORTH)
                        .where('F', FLUID_IMPORT_HATCH[EFValues.LV], Direction.NORTH)
                        .where('D', FLUID_EXPORT_HATCH[EFValues.LV], Direction.NORTH)
                        .where('M', MAINTENANCE_HATCH, Direction.NORTH)
                        .where('X', MUFFLER_HATCH[EFValues.LV], Direction.SOUTH)
                        .where('#', Blocks.AIR.defaultBlockState());
                EFAPI.HEATING_COILS.entrySet().stream()
                        .sorted(Comparator.comparingInt(entry -> entry.getKey().getTier()))
                        .forEach(
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_clean_stainless_steel"),
                    ExtForCore.id("block/multiblock/cracking_unit"))
    ...
    public static final MultiblockMachineDefinition DISTILLATION_TOWER = REGISTRATE
            ...
            .pattern(definition -> {
                ...
                if (ExtForCore.Mods.isAE2Loaded()) {
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_clean_stainless_steel"),
                    ExtForCore.id("block/multiblock/distillation_tower"))
            .register();
    ...
    public static final MultiblockMachineDefinition VACUUM_FREEZER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .where('#', Predicates.air())
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_frost_proof"),
                    ExtForCore.id("block/multiblock/vacuum_freezer"))
            .register();
    ...
    public static final MultiblockMachineDefinition ASSEMBLY_LINE = REGISTRATE
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_solid_steel"),
                    ExtForCore.id("block/multiblock/assembly_line"))
            .register();
    ...
    public static final MultiblockMachineDefinition PRIMITIVE_PUMP = REGISTRATE
            ...
            .model(createSidedWorkableCasingMachineModel(ExtForCore.id("block/casings/pump_deck"),
                    ExtForCore.id("block/multiblock/primitive_pump"))
                    .andThen(builder -> {
    ...
    public static final MultiblockMachineDefinition STEAM_GRINDER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    ExtForCore.id("block/multiblock/steam_grinder"))
            .register();
    ...
    public static final MultiblockMachineDefinition STEAM_OVEN = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .build())
            .modelProperty(GTMachineModelProperties.RECIPE_LOGIC_STATUS, RecipeLogic.Status.IDLE)
            .model(createWorkableCasingMachineModel(ExtForCore.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    ExtForCore.id("block/multiblock/steam_oven"))
    ...
    public static final MultiblockMachineDefinition[] FUSION_REACTOR = registerTieredMultis("fusion_reactor",
            FusionReactorMachine::new, (tier, builder) -> builder
                    ...
                    .model(createWorkableCasingMachineModel(FusionReactorMachine.getCasingType(tier).getTexture(),
                            ExtForCore.id("block/multiblock/fusion_reactor"))
    ...
    public static final MultiblockMachineDefinition[] FLUID_DRILLING_RIG = registerTieredMultis(
            "fluid_drilling_rig", FluidDrillMachine::new, (tier, builder) -> builder
                    ...
                    .tooltips(
                            ...
                            Component.translatable("gtceu.universal.tooltip.energy_tier_range", EFValues.VNF[tier],
                                    EFValues.VNF[tier + 1]),
                    ...
                    .workableCasingModel(FluidDrillMachine.getBaseTexture(tier),
                            ExtForCore.id("block/multiblock/fluid_drilling_rig"))
                    .register(),
            MV, HV, EV);
    ...
    public static final MultiblockMachineDefinition[] LARGE_MINER = registerTieredMultis("large_miner",
            ...
            (tier, builder) -> builder
                    ...
                    .model(createWorkableCasingMachineModel(
                            ...
                            ExtForCore.id("block/multiblock/large_miner"))
                            .andThen((ctx, prov, modelBuilder) -> {
                                ...
                                modelBuilder.replaceForAllStates((state, models) -> {
                                    ...
                                    var parentModel = prov.models()
                                            .getExistingFile(ExtForCore.id("block/machine/large_miner_active"));
                    ...
                    .tooltipBuilder((stack, tooltip) -> {
                        ...
                        tooltip.add(Component.translatable("gtceu.universal.tooltip.energy_tier_range",
                                EFValues.VNF[tier], EFValues.VNF[tier + 1]));
                    })
                    .register(),
            EV, IV, LuV);
    ...
    public static final MultiblockMachineDefinition CLEANROOM = REGISTRATE
            ...
            .shapeInfos((controller) -> {
                ...
                MultiblockShapeInfo.ShapeInfoBuilder builder = MultiblockShapeInfo.builder()
                        ...
                        .where(' ', Blocks.AIR)
                        .where('E', GTMachines.ENERGY_INPUT_HATCH[EFValues.LV], Direction.SOUTH)
                        .where('I', GTMachines.ITEM_PASSTHROUGH_HATCH[EFValues.LV], Direction.NORTH)
                        .where('L', GTMachines.FLUID_PASSTHROUGH_HATCH[EFValues.LV], Direction.NORTH)
                        .where('H', GTMachines.HULL[EFValues.HV], Direction.NORTH)
                        .where('D', GTMachines.DIODE[EFValues.HV], Direction.NORTH)
                        .where('O',
                ...
                EFAPI.CLEANROOM_FILTERS.values()
                        .forEach(block -> shapeInfo.add(builder.where('F', block.get()).build()));
                return shapeInfo;
            })
            .allowExtendedFacing(false)
            .allowFlip(false)
            .workableCasingModel(ExtForCore.id("block/casings/cleanroom/plascrete"),
                    ExtForCore.id("block/multiblock/cleanroom"))
            .register();
    ...
    public static final MultiblockMachineDefinition LARGE_COMBUSTION_ENGINE = registerLargeCombustionEngine(
            ...
            ExtForCore.id("block/multiblock/generator/large_combustion_engine"));
    ...
    public static final MultiblockMachineDefinition EXTREME_COMBUSTION_ENGINE = registerLargeCombustionEngine(
            ...
            ExtForCore.id("block/casings/solid/machine_casing_robust_tungstensteel"),
            ExtForCore.id("block/multiblock/generator/extreme_combustion_engine"));
    ...
    public static final MultiblockMachineDefinition LARGE_STEAM_TURBINE = registerLargeTurbine("steam_large_turbine",
            ...
            ExtForCore.id("block/multiblock/generator/large_steam_turbine"),
            false);
    ...
    public static final MultiblockMachineDefinition LARGE_GAS_TURBINE = registerLargeTurbine("gas_large_turbine", EV,
            ...
            ExtForCore.id("block/multiblock/generator/large_gas_turbine"),
            true);
    ...
    public static final MultiblockMachineDefinition LARGE_PLASMA_TURBINE = registerLargeTurbine("plasma_large_turbine",
            ...
            ExtForCore.id("block/casings/mechanic/machine_casing_turbine_tungstensteel"),
            ExtForCore.id("block/multiblock/generator/large_plasma_turbine"),
            false);
    ...
    public static final MultiblockMachineDefinition ACTIVE_TRANSFORMER = REGISTRATE
            ...
            .pattern((definition) -> FactoryBlockPattern.start()
                    ...
                    .build())
            .workableCasingModel(ExtForCore.id("block/casings/hpca/high_power_casing"),
                    ExtForCore.id("block/multiblock/data_bank"))
            .register();
    ...
    public static final MultiblockMachineDefinition POWER_SUBSTATION = REGISTRATE
            ...
            .shapeInfos(definition -> {
                ...
                EFAPI.PSS_BATTERIES.entrySet().stream()
            ...
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_palladium_substation"),
                    ExtForCore.id("block/multiblock/power_substation"))
            .register();
    ...
    public static final MultiblockMachineDefinition CHARCOAL_PILE_IGNITER = REGISTRATE
            ...
            .allowExtendedFacing(false)
            .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_bronze_plated_bricks"),
                    ExtForCore.id("block/multiblock/charcoal_pile_igniter"))
            .register();
    ...
    public static MultiblockMachineDefinition[] BEDROCK_ORE_MINER = registerTieredMultis(
            "bedrock_ore_miner", BedrockOreMinerMachine::new, (tier, builder) -> builder
                    ...
                    .workableCasingModel(BedrockOreMinerMachine.getBaseTexture(tier),
                            ExtForCore.id("block/multiblock/bedrock_ore_miner"))
                    .register(),
            MV, HV, EV);
    ...
    public static final MachineDefinition WOODEN_TANK_VALVE = GTMachineUtils.registerTankValve(
            ...
            (builder, overlay) -> builder.sidedWorkableCasingModel(ExtForCore.id("block/casings/wood_wall"), overlay));
    ...
    public static final MachineDefinition BRONZE_TANK_VALVE = GTMachineUtils.registerTankValve(
            ...
            (builder, overlay) -> builder
                    .workableCasingModel(ExtForCore.id("block/casings/solid/machine_casing_bronze_plated_bricks"), overlay));
    ...
    public static final MachineDefinition STEEL_TANK_VALVE = GTMachineUtils.registerTankValve(
            ...
            (builder, overlay) -> builder.workableCasingModel(
                    ExtForCore.id("block/casings/solid/machine_casing_solid_steel"), overlay));
    ...
    public static final MultiblockMachineDefinition CENTRAL_MONITOR = REGISTRATE
            ...
            .model(createWorkableCasingMachineModel(
                    ...
                    ExtForCore.id("block/multiblock/central_monitor"))
