...
import com.extfro.extfrocore.api.item.MaterialPipeBlockItem;
import com.extfro.extfrocore.api.item.SurfaceRockBlockItem;
...
import com.extfro.extfrocore.common.pipelike.fluidpipe.FluidPipeType;
...
public class GTMaterialBlocks {
    ...
    public static void generateMaterialBlocks() {
        ExtForCore.LOGGER.debug("Generating ExtForCore Material Blocks...");
        ...
        ExtForCore.LOGGER.debug("Generating ExtForCore Material Blocks... Complete!");
    }
    ...
    public static void generateOreBlocks() {
        ExtForCore.LOGGER.debug("Generating ExtForCore Ore Blocks...");
        for (Material material : EFAPI.materialManager) {
        ...
        ExtForCore.LOGGER.debug("Generating ExtForCore Ore Blocks... Complete!");
    }
    ...
    public static void generateOreIndicators() {
        ExtForCore.LOGGER.debug("Generating ExtForCore Surface Rock Indicator Blocks...");
        for (Material material : EFAPI.materialManager) {
        ...
        ExtForCore.LOGGER.debug("Generating ExtForCore Surface Rock Indicator Blocks... Complete!");
    }
    ...
    public static void generateCableBlocks() {
        ExtForCore.LOGGER.debug("Generating ExtForCore Cable/Wire Blocks...");
        ...
        ExtForCore.LOGGER.debug("Generating ExtForCore Cable/Wire Blocks... Complete!");
    }
    ...
    public static void generateFluidPipeBlocks() {
        ExtForCore.LOGGER.debug("Generating ExtForCore Fluid Pipe Blocks...");
        ...
        ExtForCore.LOGGER.debug("Generating ExtForCore Fluid Pipe Blocks... Complete!");
    }
    ...
    public static void generateItemPipeBlocks() {
        ExtForCore.LOGGER.debug("Generating ExtForCore Item Pipe Blocks...");
        ...
        ExtForCore.LOGGER.debug("Generating ExtForCore Item Pipe Blocks... Complete!");
    }
