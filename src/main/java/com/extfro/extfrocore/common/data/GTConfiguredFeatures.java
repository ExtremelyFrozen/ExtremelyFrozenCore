...
import com.extfro.extfrocore.common.worldgen.feature.configurations.FluidSproutConfiguration;
import com.extfro.extfrocore.common.worldgen.feature.configurations.StoneBlobConfiguration;
...
public class GTConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> RUBBER_TREE = ResourceKey.create(
            Registries.CONFIGURED_FEATURE, ExtForCore.id("rubber_tree"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> RED_GRANITE_BLOB = ResourceKey
            .create(Registries.CONFIGURED_FEATURE, ExtForCore.id("red_granite_blob"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MARBLE_BLOB = ResourceKey
            .create(Registries.CONFIGURED_FEATURE, ExtForCore.id("marble_blob"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> RAW_OIL_SPROUT = ResourceKey
            .create(Registries.CONFIGURED_FEATURE, ExtForCore.id("raw_oil_sprout"));
