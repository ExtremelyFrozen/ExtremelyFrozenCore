...
import com.extfro.extfrocore.api.data.worldgen.*;
...
import static com.extfro.extfrocore.api.data.worldgen.generator.veins.DikeVeinGenerator.DikeBlockDefinition;
import static com.extfro.extfrocore.api.data.worldgen.generator.veins.VeinedVeinGenerator.VeinBlockDefinition;
...
public class GTOreVeins {
    ...
    public static final ResourceKey<GTOreDefinition> END_BAUXITE_VEIN = create(ExtForCore.id("end_bauxite"));
    public static final ResourceKey<GTOreDefinition> END_MAGNETITE_VEIN = create(ExtForCore.id("end_magnetite"));
    public static final ResourceKey<GTOreDefinition> NAQUADAH_VEIN = create(ExtForCore.id("naquadah"));
    public static final ResourceKey<GTOreDefinition> PITCHBLENDE_VEIN = create(ExtForCore.id("pitchblende"));
    public static final ResourceKey<GTOreDefinition> SCHEELITE_VEIN = create(ExtForCore.id("scheelite"));
    public static final ResourceKey<GTOreDefinition> SHELDONITE_VEIN = create(ExtForCore.id("sheldonite"));

    //////////////////////////////////////
    // ****** Nether Vein *******//
    /// ///////////////////////////////////

    public static final ResourceKey<GTOreDefinition> BANDED_IRON_VEIN = create(ExtForCore.id("banded_iron"));
    public static final ResourceKey<GTOreDefinition> BERYLLIUM_VEIN = create(ExtForCore.id("beryllium"));
    public static final ResourceKey<GTOreDefinition> CERTUS_QUARTZ_VEIN = create(ExtForCore.id("certus_quartz"));
    public static final ResourceKey<GTOreDefinition> NETHER_MANGANESE_VEIN = create(ExtForCore.id("nether_manganese"));
    public static final ResourceKey<GTOreDefinition> MOLYBDENUM_VEIN = create(ExtForCore.id("molybdenum"));
    public static final ResourceKey<GTOreDefinition> MONAZITE_VEIN = create(ExtForCore.id("monazite"));
    public static final ResourceKey<GTOreDefinition> NETHER_QUARTZ_VEIN = create(ExtForCore.id("nether_quartz"));
    public static final ResourceKey<GTOreDefinition> METHER_REDSTONE_VEIN = create(ExtForCore.id("nether_redstone"));
    public static final ResourceKey<GTOreDefinition> SALTPETER_VEIN = create(ExtForCore.id("saltpeter"));
    public static final ResourceKey<GTOreDefinition> SULFUR_VEIN = create(ExtForCore.id("sulfur"));
    public static final ResourceKey<GTOreDefinition> TETRAHEDRITE_VEIN = create(ExtForCore.id("tetrahedrite"));
    public static final ResourceKey<GTOreDefinition> TOPAZ_VEIN = create(ExtForCore.id("topaz"));

    //////////////////////////////////////
    // ***** Stone *****//
    /// ///////////////////////////////////

    public static final ResourceKey<GTOreDefinition> APATITE_VEIN = create(ExtForCore.id("apatite"));
    public static final ResourceKey<GTOreDefinition> CASSITERITE_VEIN = create(ExtForCore.id("cassiterite"));
    public static final ResourceKey<GTOreDefinition> COAL_VEIN = create(ExtForCore.id("coal"));
    public static final ResourceKey<GTOreDefinition> COPPER_TIN_VEIN = create(ExtForCore.id("copper_tin"));
    public static final ResourceKey<GTOreDefinition> GALENA_VEIN = create(ExtForCore.id("galena"));
    public static final ResourceKey<GTOreDefinition> GARNET_TIN_VEIN = create(ExtForCore.id("garnet_tin"));
    public static final ResourceKey<GTOreDefinition> GARNET_VEIN = create(ExtForCore.id("garnet"));
    public static final ResourceKey<GTOreDefinition> IRON_VEIN = create(ExtForCore.id("iron"));
    public static final ResourceKey<GTOreDefinition> LUBRICANT_VEIN = create(ExtForCore.id("lubricant"));
    public static final ResourceKey<GTOreDefinition> MAGNETITE_VEIN = create(ExtForCore.id("magnetite"));
    public static final ResourceKey<GTOreDefinition> MINERAL_SAND_VEIN = create(ExtForCore.id("mineral_sand"));
    public static final ResourceKey<GTOreDefinition> NICKEL_VEIN = create(ExtForCore.id("nickel"));
    public static final ResourceKey<GTOreDefinition> SALTS_VEIN = create(ExtForCore.id("salts"));
    public static final ResourceKey<GTOreDefinition> OILSANDS_VEIN = create(ExtForCore.id("oilsands"));

    //////////////////////////////////////
    // ***** Deepslate *****//
    /// ///////////////////////////////////

    public static final ResourceKey<GTOreDefinition> COPPER_VEIN = create(ExtForCore.id("copper"));
    public static final ResourceKey<GTOreDefinition> DIAMOND_VEIN = create(ExtForCore.id("diamond"));
    public static final ResourceKey<GTOreDefinition> LAPIS_VEIN = create(ExtForCore.id("lapis"));
    public static final ResourceKey<GTOreDefinition> MANGANESE_VEIN = create(ExtForCore.id("manganese"));
    public static final ResourceKey<GTOreDefinition> MICA_VEIN = create(ExtForCore.id("mica"));
    public static final ResourceKey<GTOreDefinition> OLIVINE_VEIN = create(ExtForCore.id("olivine"));
    public static final ResourceKey<GTOreDefinition> REDSTONE_VEIN = create(ExtForCore.id("redstone"));
    public static final ResourceKey<GTOreDefinition> SAPPHIRE_VEIN = create(ExtForCore.id("sapphire"));
    ...
    public static void bootstrap(BootstrapContext<GTOreDefinition> context) {
        ...
        register(context, END_MAGNETITE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, NAQUADAH_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, PITCHBLENDE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, SCHEELITE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, SHELDONITE_VEIN, vein -> vein
        ...
        register(context, BANDED_IRON_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, BERYLLIUM_VEIN, vein -> vein
                ...
                .dikeVeinGenerator(generator -> generator
                        ...
                        .withBlock(new DikeBlockDefinition(Thorium, 2, 16, 30)))
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Beryllium)
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, CERTUS_QUARTZ_VEIN, vein -> vein
        ...
        register(context, NETHER_MANGANESE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, MOLYBDENUM_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, MONAZITE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, NETHER_QUARTZ_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, METHER_REDSTONE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, SALTPETER_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, SULFUR_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Sulfur)
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, TETRAHEDRITE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.BELOW)));
        register(context, TOPAZ_VEIN, vein -> vein
        ...
        register(context, APATITE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Apatite)
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, CASSITERITE_VEIN, vein -> vein
        ...
        register(context, GALENA_VEIN, vein -> vein
                .clusterSize(UniformInt.of(32, 40)).density(0.25f).weight(40)
                .layer(WorldGenLayers.STONE)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Galena)));
        register(context, GARNET_TIN_VEIN, vein -> vein
        ...
        register(context, GARNET_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)));
        register(context, IRON_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Goethite)));
        register(context, LUBRICANT_VEIN, vein -> vein
                .clusterSize(UniformInt.of(25, 29)).density(0.25f).weight(40)
                .layer(WorldGenLayers.STONE)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Talc)));
        register(context, MAGNETITE_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Magnetite)));
        register(context, MINERAL_SAND_VEIN, vein -> vein
                .clusterSize(UniformInt.of(32, 40)).density(0.2f).weight(80)
                .layer(WorldGenLayers.STONE)
        ...
        register(context, NICKEL_VEIN, vein -> vein
                .clusterSize(UniformInt.of(32, 40)).density(0.25f).weight(40)
                .layer(WorldGenLayers.STONE)
                .heightRangeUniform(-10, 60)
                .biomes(BiomeTags.IS_OVERWORLD)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Nickel)));
        register(context, SALTS_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Salt)));
        register(context, OILSANDS_VEIN, vein -> vein
        ...
        register(context, COPPER_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Copper)));
        register(context, DIAMOND_VEIN, vein -> vein
                .clusterSize(UniformInt.of(32, 40)).density(0.25f).weight(40)
                .layer(WorldGenLayers.DEEPSLATE)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)
                        .radius(2)));
        register(context, LAPIS_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .placement(SurfaceIndicatorGenerator.IndicatorPlacement.ABOVE)
                        .radius(3)));
        register(context, MANGANESE_VEIN, vein -> vein
                .clusterSize(UniformInt.of(50, 64)).density(0.75f).weight(20)
                .layer(WorldGenLayers.DEEPSLATE)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .density(0.15f)
                        .radius(3)));
        register(context, MICA_VEIN, vein -> vein
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Mica)
                        .radius(3)));
        register(context, OLIVINE_VEIN, vein -> vein
                .clusterSize(UniformInt.of(32, 40)).density(0.25f).weight(20)
                .layer(WorldGenLayers.DEEPSLATE)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        ...
                        .density(0.15f)
                        .radius(3)));
        register(context, REDSTONE_VEIN, vein -> vein
                .clusterSize(UniformInt.of(32, 40)).density(0.2f).weight(60)
                .layer(WorldGenLayers.DEEPSLATE)
                ...
                .surfaceIndicatorGenerator(indicator -> indicator
                        .surfaceRock(Redstone)));
        register(context, SAPPHIRE_VEIN, vein -> vein
