...
import com.extfro.extfrocore.api.sound.ExistingSoundEntry;
import com.extfro.extfrocore.common.machine.multiblock.electric.FusionReactorMachine;
import com.extfro.extfrocore.common.machine.trait.customlogic.*;
import com.extfro.extfrocore.common.recipe.condition.AdjacentFluidCondition;
...
import com.extfro.extfrocore.integration.xei.entry.fluid.FluidHolderSetList;
...
import static com.lowdragmc.lowdraglib2.gui.ui.data.FillDirection.*;
...
public class GTRecipeTypes {
    ...
    public final static GTRecipeType ALLOY_SMELTER_RECIPES = register("alloy_smelter", ELECTRIC)
            ...
            .setSlotOverlay(false, false, GuiTextures.FURNACE_OVERLAY_1)
            .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.ALLOY_SMELTER[EFValues.LV].asStack())
            .setSteamProgressBar(GuiTextures.PROGRESS_BAR_ARROW_STEAM, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.FURNACE);
    ...
    public final static GTRecipeType MACERATOR_RECIPES = register("macerator", ELECTRIC).setMaxIOSize(1, 4, 0, 0)
            ...
            .setIconSupplier(() -> GTMachines.MACERATOR[EFValues.LV].asStack())
            ...
            .addDataInfo(data -> LocalizationUtils.format("gtceu.recipe.byproduct_tier", EFValues.VNF[EFValues.HV]));
    ...
    public final static GTRecipeType CHEMICAL_BATH_RECIPES = register("chemical_bath", ELECTRIC)
            ...
            .prepareBuilder(recipeBuilder -> recipeBuilder.EUt(EFValues.VA[EFValues.LV]))
    ...
    public final static GTRecipeType CHEMICAL_RECIPES = register("chemical_reactor", ELECTRIC).setMaxIOSize(2, 2, 3, 2)
            ...
            .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, LEFT_TO_RIGHT)
            .setSound(EFValues.FOOLS.getAsBoolean() ? GTSoundEntries.SCIENCE : GTSoundEntries.CHEMICAL)
    ...
    public final static GTRecipeType COMPRESSOR_RECIPES = register("compressor", ELECTRIC).setMaxIOSize(1, 1, 0, 0)
            ...
            .setIconSupplier(() -> GTMachines.COMPRESSOR[EFValues.LV].asStack())
    ...
    public final static GTRecipeType EXTRACTOR_RECIPES = register("extractor", ELECTRIC).setMaxIOSize(1, 1, 0, 1)
            ...
            .setProgressBar(GuiTextures.PROGRESS_BAR_EXTRACT, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.EXTRACTOR[EFValues.LV].asStack())
    ...
    public final static GTRecipeType FORGE_HAMMER_RECIPES = register("forge_hammer", ELECTRIC).setMaxIOSize(1, 1, 0, 0)
            ...
            .setIconSupplier(() -> GTMachines.FORGE_HAMMER[EFValues.LV].asStack())
                ...
                if (recipeBuilder.input.getOrDefault(FluidRecipeCapability.CAP, Collections.emptyList()).isEmpty() &&
                    ...
                    recipeBuilder.copy(recipeBuilder.id.withSuffix("_soldering_alloy"))
                            .inputFluids(GTMaterials.SolderingAlloy
                                    .getFluid(Math.max(1, (EFValues.L / 2) * recipeBuilder.getSolderMultiplier())))
                            .save(provider);
                    ...
                    recipeBuilder.inputFluids(
                            GTMaterials.Tin.getFluid(Math.max(1, EFValues.L * recipeBuilder.getSolderMultiplier())));
                }
            });
    ...
    public static final GTRecipeType RESEARCH_STATION_RECIPES = register("research_station", ELECTRIC)
            ...
            .setScanner(true)
            .setMaxTooltips(4)
            .setSound(EFValues.FOOLS.getAsBoolean() ? GTSoundEntries.SCIENCE : GTSoundEntries.COMPUTATION);
    ...
    public final static GTRecipeType ROCK_BREAKER_RECIPES = register("rock_breaker", ELECTRIC).setMaxIOSize(1, 4, 0, 0)
            ...
            .setProgressBar(GuiTextures.PROGRESS_BAR_MACERATE, LEFT_TO_RIGHT)
            .setIconSupplier(() -> GTMachines.ROCK_CRUSHER[EFValues.LV].asStack())
            .setSteamProgressBar(GuiTextures.PROGRESS_BAR_MACERATE_STEAM, LEFT_TO_RIGHT)
            .setUiBuilder((recipe, widgetGroup) -> {
                ...
                for (HolderSet<Fluid> set : fluids) {
                    ...
                    widgetGroup.addChild(GTRecipeElement.fluidSlot(
                            (int) widgetGroup.getSizeWidth() - 30 - xOffset,
                            (int) widgetGroup.getSizeHeight() - 30 + yOffset,
                            GuiTextures.FLUID_SLOT,
                            "adjacent_fluid_" + i,
                            new CycleFluidEntryHandler(slots),
                            0));
    ...
    public final static GTRecipeType BLAST_RECIPES = register("electric_blast_furnace", MULTIBLOCK)
            ...
            .setUiBuilder((recipe, widgetGroup) -> {
                ...
                widgetGroup.addChild(GTRecipeElement.itemSlot(
                        ...
                        (int) widgetGroup.getSizeHeight() - 32,
                        GuiTextures.SLOT,
                        "blast_coil",
    ...
    public final static GTRecipeType IMPLOSION_RECIPES = register("implosion_compressor", MULTIBLOCK)
            ...
            .prepareBuilder(recipeBuilder -> recipeBuilder.duration(20).EUt(EFValues.VA[EFValues.LV]))
    ...
    public final static GTRecipeType VACUUM_RECIPES = register("vacuum_freezer", MULTIBLOCK).setMaxIOSize(1, 1, 2, 1)
            .setEUIO(IO.IN)
            .prepareBuilder(recipeBuilder -> recipeBuilder.EUt(EFValues.VA[EFValues.MV]))
            .setSound(GTSoundEntries.COOLING);
    ...
    public static GTRecipeType register(String name, String group, RecipeType<?>... proxyRecipes) {
        var recipeType = new GTRecipeType(ExtForCore.id(name), group, proxyRecipes);
    ...
    public @Nullable static GTRecipeType get(String name) {
        RecipeType<?> type = BuiltInRegistries.RECIPE_TYPE.get(ExtForCore.id(name));
