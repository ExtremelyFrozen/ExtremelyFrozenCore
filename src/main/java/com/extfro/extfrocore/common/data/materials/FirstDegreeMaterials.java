package com.extfro.extfrocore.common.data.materials;

import com.extfro.extfrocore.ExtForCore;
import com.extfro.extfrocore.api.data.chemical.material.Material;
import com.extfro.extfrocore.api.data.chemical.material.properties.ArmorProperty;
import com.extfro.extfrocore.api.data.chemical.material.properties.BlastProperty.GasTier;
...
import com.extfro.extfrocore.api.fluids.FluidBuilder;
import com.extfro.extfrocore.api.fluids.FluidState;
import com.extfro.extfrocore.api.fluids.attribute.FluidAttributes;
...
import static com.extfro.extfrocore.api.data.chemical.material.info.MaterialIconSet.*;
import static com.extfro.extfrocore.common.data.GTMaterials.*;

public class FirstDegreeMaterials {

    public static void register() {
        Almandine = new Material.Builder(ExtForCore.id("almandine"))
                .gem(1).ore(3, 1)
                .color(0xa21717).secondaryColor(0x4b1e0c)
                .components(Aluminium, 2, Iron, 3, Silicon, 3, Oxygen, 12)
                .buildAndRegister();

        Andradite = new Material.Builder(ExtForCore.id("andradite"))
                .gem(1)
                .color(0xffce26).secondaryColor(0x647d59).iconSet(RUBY)
                .components(Calcium, 3, Iron, 2, Silicon, 3, Oxygen, 12)
                .buildAndRegister();

        AnnealedCopper = new Material.Builder(ExtForCore.id("annealed_copper"))
                .ingot()
        ...
        Asbestos = new Material.Builder(ExtForCore.id("asbestos"))
                .dust(1).ore(3, 1)
        ...
        Ash = new Material.Builder(ExtForCore.id("ash"))
                .dust(1)
        ...
        Hematite = new Material.Builder(ExtForCore.id("hematite"))
                .dust().ore()
                .color(0xff7161).secondaryColor(0x330817)
                .components(Iron, 2, Oxygen, 3)
                .buildAndRegister();

        BatteryAlloy = new Material.Builder(ExtForCore.id("battery_alloy"))
                .ingot(1)
        ...
        BlueTopaz = new Material.Builder(ExtForCore.id("blue_topaz"))
                .gem(3).ore(2, 1)
        ...
        Bone = new Material.Builder(ExtForCore.id("bone"))
                .dust(1)
        ...
        Brass = new Material.Builder(ExtForCore.id("brass"))
                .ingot(1)
        ...
        Bronze = new Material.Builder(ExtForCore.id("bronze"))
                .ingot()
        ...
        Goethite = new Material.Builder(ExtForCore.id("goethite"))
                .dust(1).ore()
        ...
        Calcite = new Material.Builder(ExtForCore.id("calcite"))
                .dust(1).ore()
                .color(0xfffef8).secondaryColor(0xbbaf62)
                .components(Calcium, 1, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        Cassiterite = new Material.Builder(ExtForCore.id("cassiterite"))
                .dust(1).ore(2, 1)
                .color(0x89847e).secondaryColor(0x3b3b35).iconSet(ROUGH)
                .components(Tin, 1, Oxygen, 2)
                .buildAndRegister();

        CassiteriteSand = new Material.Builder(ExtForCore.id("cassiterite_sand"))
                .dust(1).ore(2, 1)
                .color(0x89847e).secondaryColor(0x3b3b35).iconSet(SAND)
                .components(Tin, 1, Oxygen, 2)
                .buildAndRegister();

        Chalcopyrite = new Material.Builder(ExtForCore.id("chalcopyrite"))
                .dust(1).ore()
                .color(0x96c185).secondaryColor(0xe3af1a)
                .components(Copper, 1, Iron, 1, Sulfur, 2)
                .buildAndRegister();

        Charcoal = new Material.Builder(ExtForCore.id("charcoal"))
        ...
        Chromite = new Material.Builder(ExtForCore.id("chromite"))
                .dust(1).ore()
                .color(0xc5c1a8).secondaryColor(0x4c1a69).iconSet(METALLIC)
                .components(Iron, 1, Chromium, 2, Oxygen, 4)
                .buildAndRegister();

        Cinnabar = new Material.Builder(ExtForCore.id("cinnabar"))
                .gem(1).ore()
        ...
        Water = new Material.Builder(ExtForCore.id("water"))
        ...
        Coal = new Material.Builder(ExtForCore.id("coal"))
        ...
        DarkAsh = new Material.Builder(ExtForCore.id("dark_ash"))
                .dust(1)
        ...
        Diamond = new Material.Builder(ExtForCore.id("diamond"))
                .gem(3).ore()
        ...
        Electrum = new Material.Builder(ExtForCore.id("electrum"))
                .ingot()
        ...
        Emerald = new Material.Builder(ExtForCore.id("emerald"))
                .gem().ore(2, 1)
        ...
        Galena = new Material.Builder(ExtForCore.id("galena"))
                .dust(3).ore()
        ...
        Garnierite = new Material.Builder(ExtForCore.id("garnierite"))
                .dust(3).ore()
                .color(0x32c880).secondaryColor(0x344028).iconSet(METALLIC)
                .components(Nickel, 1, Oxygen, 1)
                .buildAndRegister();

        GreenSapphire = new Material.Builder(ExtForCore.id("green_sapphire"))
                .gem().ore()
        ...
        Ilmenite = new Material.Builder(ExtForCore.id("ilmenite"))
                .dust(3).ore()
        ...
        Rutile = new Material.Builder(ExtForCore.id("rutile"))
                .gem()
        ...
        Bauxite = new Material.Builder(ExtForCore.id("bauxite"))
                .dust(1).ore()
        ...
        Invar = new Material.Builder(ExtForCore.id("invar"))
                .ingot()
        ...
        Kanthal = new Material.Builder(ExtForCore.id("kanthal"))
                .ingot()
        ...
        Lazurite = new Material.Builder(ExtForCore.id("lazurite"))
                .gem(1).ore(6, 4)
        ...
        Magnalium = new Material.Builder(ExtForCore.id("magnalium"))
                .ingot()
        ...
        NiobiumNitride = new Material.Builder(ExtForCore.id("niobium_nitride"))
                .ingot().fluid()
        ...
        NiobiumTitanium = new Material.Builder(ExtForCore.id("niobium_titanium"))
                .ingot()
        ...
        Obsidian = new Material.Builder(ExtForCore.id("obsidian"))
                .dust(3)
        ...
        Phosphate = new Material.Builder(ExtForCore.id("phosphate"))
                .dust(1)
        ...
        PlatinumRaw = new Material.Builder(ExtForCore.id("platinum_raw"))
                .dust()
        ...
        SterlingSilver = new Material.Builder(ExtForCore.id("sterling_silver"))
                .ingot()
        ...
        RoseGold = new Material.Builder(ExtForCore.id("rose_gold"))
                .ingot()
        ...
        BlackBronze = new Material.Builder(ExtForCore.id("black_bronze"))
                .ingot()
        ...
        BismuthBronze = new Material.Builder(ExtForCore.id("bismuth_bronze"))
                .ingot()
        ...
        Biotite = new Material.Builder(ExtForCore.id("biotite"))
                .dust(1)
        ...
        Powellite = new Material.Builder(ExtForCore.id("powellite"))
                .dust().ore()
                .color(0xd8cfac).secondaryColor(0xbc7a2c)
                .components(Calcium, 1, Molybdenum, 1, Oxygen, 4)
                .buildAndRegister();

        Pyrite = new Material.Builder(ExtForCore.id("pyrite"))
                .dust(1).ore()
        ...
        RTMAlloy = new Material.Builder(ExtForCore.id("rtm_alloy"))
                .ingot().fluid()
        ...
        Ruridit = new Material.Builder(ExtForCore.id("ruridit"))
                .ingot(3)
                .fluid()
        ...
        Ruby = new Material.Builder(ExtForCore.id("ruby"))
                .gem().ore()
        ...
        Salt = new Material.Builder(ExtForCore.id("salt"))
                .gem(1).ore(2, 1)
        ...
        Saltpeter = new Material.Builder(ExtForCore.id("saltpeter"))
                .dust(1).ore(2, 1)
        ...
        Sapphire = new Material.Builder(ExtForCore.id("sapphire"))
                .gem().ore()
        ...
        Scheelite = new Material.Builder(ExtForCore.id("scheelite"))
                .dust(3).ore()
        ...
        Sodalite = new Material.Builder(ExtForCore.id("sodalite"))
                .gem(1).ore(6, 4)
        ...
        SolderingAlloy = new Material.Builder(ExtForCore.id("soldering_alloy"))
                .ingot(1)
        ...
        Spessartine = new Material.Builder(ExtForCore.id("spessartine"))
                .gem().ore(3, 1)
                .color(0xffa81e).secondaryColor(0xb33700).iconSet(RUBY)
                .components(Aluminium, 2, Manganese, 3, Silicon, 3, Oxygen, 12)
                .buildAndRegister();

        Sphalerite = new Material.Builder(ExtForCore.id("sphalerite"))
                .dust(1).ore()
        ...
        StainlessSteel = new Material.Builder(ExtForCore.id("stainless_steel"))
                .ingot(3)
        ...
        Steel = new Material.Builder(ExtForCore.id("steel"))
                .ingot(3)
        ...
        Stibnite = new Material.Builder(ExtForCore.id("stibnite"))
                .dust().ore()
        ...
        Tetrahedrite = new Material.Builder(ExtForCore.id("tetrahedrite"))
                .dust().ore()
                .color(0xa3a09b).secondaryColor(0x143313)
                .components(Copper, 2, Iron, 1, Antimony, 1, Sulfur, 3)
                .buildAndRegister();

        TinAlloy = new Material.Builder(ExtForCore.id("tin_alloy"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1258))
        ...
        Topaz = new Material.Builder(ExtForCore.id("topaz"))
                .gem(3).ore()
        ...
        Tungstate = new Material.Builder(ExtForCore.id("tungstate"))
                .dust(3).ore()
        ...
        Ultimet = new Material.Builder(ExtForCore.id("ultimet"))
                .ingot(4)
        ...
        Uraninite = new Material.Builder(ExtForCore.id("uraninite"))
                .dust(3).ore(true)
        ...
        Uvarovite = new Material.Builder(ExtForCore.id("uvarovite"))
                .gem()
                .color(0x2ded4c).secondaryColor(0x00697c).iconSet(RUBY)
                .components(Calcium, 3, Chromium, 2, Silicon, 3, Oxygen, 12)
                .buildAndRegister();

        VanadiumGallium = new Material.Builder(ExtForCore.id("vanadium_gallium"))
                .ingot()
        ...
        WroughtIron = new Material.Builder(ExtForCore.id("wrought_iron"))
                .ingot()
                .liquid(new FluidBuilder().temperature(2011))
        ...
        Wulfenite = new Material.Builder(ExtForCore.id("wulfenite"))
                .dust(3).ore()
                .color(0xff9000).secondaryColor(0xFF0000)
                .components(Lead, 1, Molybdenum, 1, Oxygen, 4)
                .buildAndRegister();

        YellowLimonite = new Material.Builder(ExtForCore.id("yellow_limonite"))
                .dust().ore()
        ...
        YttriumBariumCuprate = new Material.Builder(ExtForCore.id("yttrium_barium_cuprate"))
                .ingot()
        ...
        NetherQuartz = new Material.Builder(ExtForCore.id("nether_quartz"))
                .gem(1).ore(2, 1)
        ...
        CertusQuartz = new Material.Builder(ExtForCore.id("certus_quartz"))
                .gem(1).ore(2, 1)
        ...
        Quartzite = new Material.Builder(ExtForCore.id("quartzite"))
                .gem(1).ore(2, 1)
        ...
        Graphite = new Material.Builder(ExtForCore.id("graphite"))
                .ore()
        ...
        Graphene = new Material.Builder(ExtForCore.id("graphene"))
                .dust().ingot()
        ...
        TungsticAcid = new Material.Builder(ExtForCore.id("tungstic_acid"))
                .dust()
        ...
        Osmiridium = new Material.Builder(ExtForCore.id("osmiridium"))
                .ingot(3)
        ...
        Potash = new Material.Builder(ExtForCore.id("potash"))
                .dust(1)
                .color(0xffa772).secondaryColor(0x922f1b).iconSet(FINE)
                .components(Potassium, 2, Oxygen, 1)
                .buildAndRegister();

        SodaAsh = new Material.Builder(ExtForCore.id("soda_ash"))
                .dust(1)
                .color(0xffffff).secondaryColor(0xDCDCFF)
                .components(Sodium, 2, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        IndiumGalliumPhosphide = new Material.Builder(ExtForCore.id("indium_gallium_phosphide"))
                .ingot(1)
        ...
        NickelZincFerrite = new Material.Builder(ExtForCore.id("nickel_zinc_ferrite"))
                .ingot(0)
        ...
        SiliconDioxide = new Material.Builder(ExtForCore.id("silicon_dioxide"))
                .dust(1)
        ...
        MagnesiumChloride = new Material.Builder(ExtForCore.id("magnesium_chloride"))
                .dust(1)
        ...
        SodiumSulfide = new Material.Builder(ExtForCore.id("sodium_sulfide"))
                .dust(1)
                .color(0xffd83d).secondaryColor(0xc54a00)
                .components(Sodium, 2, Sulfur, 1)
                .buildAndRegister();

        PhosphorusPentoxide = new Material.Builder(ExtForCore.id("phosphorus_pentoxide"))
                .dust(1)
        ...
        Quicklime = new Material.Builder(ExtForCore.id("quicklime"))
                .dust(1)
        ...
        SodiumBisulfate = new Material.Builder(ExtForCore.id("sodium_bisulfate"))
                .dust(1)
        ...
        FerriteMixture = new Material.Builder(ExtForCore.id("ferrite_mixture"))
                .dust(1)
        ...
        Magnesia = new Material.Builder(ExtForCore.id("magnesia"))
                .dust(1)
                .color(0x998282).secondaryColor(0x594d19)
                .components(Magnesium, 1, Oxygen, 1)
                .buildAndRegister();

        PlatinumGroupSludge = new Material.Builder(ExtForCore.id("platinum_group_sludge"))
                .dust(1)
                .color(0x343228).secondaryColor(0x001E00).iconSet(FINE)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        Realgar = new Material.Builder(ExtForCore.id("realgar"))
                .gem().ore()
        ...
        SodiumBicarbonate = new Material.Builder(ExtForCore.id("sodium_bicarbonate"))
                .dust(1)
        ...
        PotassiumDichromate = new Material.Builder(ExtForCore.id("potassium_dichromate"))
                .dust(1)
        ...
        ChromiumTrioxide = new Material.Builder(ExtForCore.id("chromium_trioxide"))
                .dust(1)
                .color(0xFFE4E1)
        ...
        AntimonyTrioxide = new Material.Builder(ExtForCore.id("antimony_trioxide"))
                .dust(1)
                .color(0xf5f5ff).secondaryColor(0xc4c4d6)
                .components(Antimony, 2, Oxygen, 3)
                .buildAndRegister();

        Zincite = new Material.Builder(ExtForCore.id("zincite"))
                .dust(1)
                .color(0xff9f49).secondaryColor(0xff0000)
                .components(Zinc, 1, Oxygen, 1)
                .buildAndRegister();

        CupricOxide = new Material.Builder(ExtForCore.id("cupric_oxide"))
                .dust(1)
                .color(0x8df7cf).secondaryColor(0x57696e)
                .components(Copper, 1, Oxygen, 1)
                .buildAndRegister();

        CobaltOxide = new Material.Builder(ExtForCore.id("cobalt_oxide"))
                .dust(1)
                .color(0x3cb099).secondaryColor(0x3b5c66)
                .components(Cobalt, 1, Oxygen, 1)
                .buildAndRegister();

        ArsenicTrioxide = new Material.Builder(ExtForCore.id("arsenic_trioxide"))
                .dust(1)
                .color(0xf9f3f3).secondaryColor(0x3b5c66).iconSet(ROUGH)
                .components(Arsenic, 2, Oxygen, 3)
                .buildAndRegister();

        Massicot = new Material.Builder(ExtForCore.id("massicot"))
                .dust(1)
                .color(0xFFDD55).secondaryColor(0x000000)
                .components(Lead, 1, Oxygen, 1)
                .buildAndRegister();

        Ferrosilite = new Material.Builder(ExtForCore.id("ferrosilite"))
                .dust(1)
                .color(0x968c80).secondaryColor(0x97732a)
                .components(Iron, 1, Silicon, 1, Oxygen, 3)
                .buildAndRegister();

        MetalMixture = new Material.Builder(ExtForCore.id("metal_mixture"))
                .dust(1)
                .color(0x697077).secondaryColor(0x502d16).iconSet(METALLIC)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        SodiumHydroxide = new Material.Builder(ExtForCore.id("sodium_hydroxide"))
                .dust(1)
        ...
        TungstenCarbide = new Material.Builder(ExtForCore.id("tungsten_carbide"))
                .ingot(4).fluid()
        ...
        CarbonDioxide = new Material.Builder(ExtForCore.id("carbon_dioxide"))
                .gas()
                .color(0xA9D0F5)
                .components(Carbon, 1, Oxygen, 2)
                .buildAndRegister();

        TitaniumTetrachloride = new Material.Builder(ExtForCore.id("titanium_tetrachloride"))
                .liquid(new FluidBuilder().customStill())
                .color(0xD40D5C)
                .flags(DISABLE_DECOMPOSITION)
        ...
        NitrogenDioxide = new Material.Builder(ExtForCore.id("nitrogen_dioxide"))
                .gas()
                .color(0x85FCFF)
        ...
        HydrogenSulfide = new Material.Builder(ExtForCore.id("hydrogen_sulfide"))
        ...
        NitricAcid = new Material.Builder(ExtForCore.id("nitric_acid"))
        ...
        SulfuricAcid = new Material.Builder(ExtForCore.id("sulfuric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .flags(DISABLE_DECOMPOSITION)
                .components(Hydrogen, 2, Sulfur, 1, Oxygen, 4)
                .buildAndRegister();

        PhosphoricAcid = new Material.Builder(ExtForCore.id("phosphoric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xDCDC01)
                .flags(DISABLE_DECOMPOSITION)
        ...
        SulfurTrioxide = new Material.Builder(ExtForCore.id("sulfur_trioxide"))
                .gas()
                .color(0xA0A014)
        ...
        SulfurDioxide = new Material.Builder(ExtForCore.id("sulfur_dioxide"))
                .gas()
                .color(0x0E4880)
        ...
        CarbonMonoxide = new Material.Builder(ExtForCore.id("carbon_monoxide"))
                .gas()
                .color(0x0E4880)
        ...
        HypochlorousAcid = new Material.Builder(ExtForCore.id("hypochlorous_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x6F8A91)
                .components(Hydrogen, 1, Chlorine, 1, Oxygen, 1)
                .buildAndRegister();

        Ammonia = new Material.Builder(ExtForCore.id("ammonia"))
                .gas()
                .color(0x4465a2).secondaryColor(0x3F3480)
                .components(Nitrogen, 1, Hydrogen, 3)
                .buildAndRegister();

        HydrofluoricAcid = new Material.Builder(ExtForCore.id("hydrofluoric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x0088AA)
        ...
        NitricOxide = new Material.Builder(ExtForCore.id("nitric_oxide"))
                .gas()
                .color(0x7DC8F0)
        ...
        Iron3Chloride = new Material.Builder(ExtForCore.id("iron_iii_chloride"))
                .liquid()
                .color(0x060B0B)
        ...
        Iron2Chloride = new Material.Builder(ExtForCore.id("iron_ii_chloride"))
                .liquid()
                .color(0xe8e0be)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
        ...
        UraniumHexafluoride = new Material.Builder(ExtForCore.id("uranium_hexafluoride"))
                .gas()
                .color(0x42D126)
                .flags(DISABLE_DECOMPOSITION)
        ...
        EnrichedUraniumHexafluoride = new Material.Builder(ExtForCore.id("enriched_uranium_hexafluoride"))
                .gas()
                .color(0x4BF52A)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DepletedUraniumHexafluoride = new Material.Builder(ExtForCore.id("depleted_uranium_hexafluoride"))
                .gas()
                .color(0x74BA66)
                .flags(DISABLE_DECOMPOSITION)
                .components(Uranium238, 1, Fluorine, 6)
        ...
        NitrousOxide = new Material.Builder(ExtForCore.id("nitrous_oxide"))
                .gas()
                .color(0x7DC8FF)
        ...
        EnderPearl = new Material.Builder(ExtForCore.id("ender_pearl"))
                .gem(1)
        ...
        PotassiumFeldspar = new Material.Builder(ExtForCore.id("potassium_feldspar"))
                .dust(1)
                .color(0xffe3bc).secondaryColor(0xd4918a).iconSet(FINE)
                .components(Potassium, 1, Aluminium, 1, Silicon, 3, Oxygen, 8)
                .buildAndRegister();

        NeodymiumMagnetic = new Material.Builder(ExtForCore.id("magnetic_neodymium"))
                .ingot()
        ...
        HydrochloricAcid = new Material.Builder(ExtForCore.id("hydrochloric_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .components(Hydrogen, 1, Chlorine, 1)
                .buildAndRegister();

        Steam = new Material.Builder(ExtForCore.id("steam"))
        ...
        DistilledWater = new Material.Builder(ExtForCore.id("distilled_water"))
                .fluid()
                .color(0x4A94FF)
                .flags(DISABLE_DECOMPOSITION)
                .components(Hydrogen, 2, Oxygen, 1)
        ...
        SodiumPotassium = new Material.Builder(ExtForCore.id("sodium_potassium"))
                .fluid()
                .color(0x64FCB4)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
        ...
        SamariumMagnetic = new Material.Builder(ExtForCore.id("magnetic_samarium"))
                .ingot()
        ...
        ManganesePhosphide = new Material.Builder(ExtForCore.id("manganese_phosphide"))
                .ingot()
        ...
        MagnesiumDiboride = new Material.Builder(ExtForCore.id("magnesium_diboride"))
                .ingot()
        ...
        MercuryBariumCalciumCuprate = new Material.Builder(ExtForCore.id("mercury_barium_calcium_cuprate"))
                .ingot()
        ...
        UraniumTriplatinum = new Material.Builder(ExtForCore.id("uranium_triplatinum"))
                .ingot()
        ...
        SamariumIronArsenicOxide = new Material.Builder(ExtForCore.id("samarium_iron_arsenic_oxide"))
                .ingot()
        ...
        IndiumTinBariumTitaniumCuprate = new Material.Builder(ExtForCore.id("indium_tin_barium_titanium_cuprate"))
                .ingot()
        ...
        UraniumRhodiumDinaquadide = new Material.Builder(ExtForCore.id("uranium_rhodium_dinaquadide"))
                .ingot()
        ...
        EnrichedNaquadahTriniumEuropiumDuranide = new Material.Builder(
                ExtForCore.id("enriched_naquadah_trinium_europium_duranide"))
                .ingot()
        ...
        RutheniumTriniumAmericiumNeutronate = new Material.Builder(ExtForCore.id("ruthenium_trinium_americium_neutronate"))
                .ingot()
        ...
        InertMetalMixture = new Material.Builder(ExtForCore.id("inert_metal_mixture"))
                .dust()
        ...
        RhodiumSulfate = new Material.Builder(ExtForCore.id("rhodium_sulfate"))
        ...
        RutheniumTetroxide = new Material.Builder(ExtForCore.id("ruthenium_tetroxide"))
                .dust()
        ...
        OsmiumTetroxide = new Material.Builder(ExtForCore.id("osmium_tetroxide"))
                .dust()
        ...
        IridiumChloride = new Material.Builder(ExtForCore.id("iridium_chloride"))
                .dust()
        ...
        FluoroantimonicAcid = new Material.Builder(ExtForCore.id("fluoroantimonic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID).customStill())
                .components(Hydrogen, 2, Antimony, 1, Fluorine, 7)
                .buildAndRegister();

        TitaniumTrifluoride = new Material.Builder(ExtForCore.id("titanium_trifluoride"))
                .dust()
        ...
        CalciumPhosphide = new Material.Builder(ExtForCore.id("calcium_phosphide"))
                .dust()
                .color(0xFFF5DE).secondaryColor(0xf6baba).iconSet(METALLIC)
                .components(Calcium, 1, Phosphorus, 1)
                .buildAndRegister();

        IndiumPhosphide = new Material.Builder(ExtForCore.id("indium_phosphide"))
                .dust()
        ...
        BariumSulfide = new Material.Builder(ExtForCore.id("barium_sulfide"))
                .dust()
                .color(0x80784a).secondaryColor(0x2c333b).iconSet(METALLIC)
                .components(Barium, 1, Sulfur, 1)
                .buildAndRegister();

        TriniumSulfide = new Material.Builder(ExtForCore.id("trinium_sulfide"))
                .dust()
        ...
        ZincSulfide = new Material.Builder(ExtForCore.id("zinc_sulfide"))
                .dust()
                .color(0xfff4d5).secondaryColor(0xdadada)
                .components(Zinc, 1, Sulfur, 1)
                .buildAndRegister();

        GalliumSulfide = new Material.Builder(ExtForCore.id("gallium_sulfide"))
                .dust()
                .color(0xffee5d).secondaryColor(0xedf008).iconSet(SHINY)
                .components(Gallium, 1, Sulfur, 1)
                .buildAndRegister();

        AntimonyTrifluoride = new Material.Builder(ExtForCore.id("antimony_trifluoride"))
                .dust()
        ...
        EnrichedNaquadahSulfate = new Material.Builder(ExtForCore.id("enriched_naquadah_sulfate"))
                .dust()
        ...
        NaquadriaSulfate = new Material.Builder(ExtForCore.id("naquadria_sulfate"))
                .dust()
        ...
        Pyrochlore = new Material.Builder(ExtForCore.id("pyrochlore"))
                .dust().ore()
                .color(0x5b4838).secondaryColor(0x331400).iconSet(METALLIC)
                .components(Calcium, 2, Niobium, 2, Oxygen, 6, Fluorine, 1)
                .buildAndRegister();

        PotassiumHydroxide = new Material.Builder(ExtForCore.id("potassium_hydroxide"))
                .dust(1)
        ...
        PotassiumIodide = new Material.Builder(ExtForCore.id("potassium_iodide"))
                .dust()
                .color(0xa66c71).secondaryColor(0x802d67).iconSet(METALLIC)
                .components(Potassium, 1, Iodine, 1)
                .buildAndRegister();

        PotassiumCarbonate = new Material.Builder(ExtForCore.id("potassium_carbonate"))
                .dust()
                .color(0xa66c71).secondaryColor(0x802d67).iconSet(METALLIC)
                .components(Potassium, 2, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        PotassiumFerrocyanide = new Material.Builder(ExtForCore.id("potassium_ferrocyanide"))
                .dust()
        ...
        CalciumFerrocyanide = new Material.Builder(ExtForCore.id("calcium_ferrocyanide"))
                .dust()
                .color(0xc9a842).secondaryColor(0x947110).iconSet(DULL)
        ...
        CalciumHydroxide = new Material.Builder(ExtForCore.id("calcium_hydroxide"))
                .dust()
        ...
        CalciumCarbonate = new Material.Builder(ExtForCore.id("calcium_carbonate"))
                .dust()
                .color(0xd9ca9c).secondaryColor(0xad913b)
                .components(Calcium, 1, Carbon, 1, Oxygen, 3)
                .buildAndRegister();

        PotassiumCyanide = new Material.Builder(ExtForCore.id("potassium_cyanide"))
                .dust()
        ...
        HydrogenCyanide = new Material.Builder(ExtForCore.id("hydrogen_cyanide"))
                .gas()
                .color(0x72dbd4)
        ...
        FormicAcid = new Material.Builder(ExtForCore.id("formic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xa6a6a6)
        ...
        PotassiumSulfate = new Material.Builder(ExtForCore.id("potassium_sulfate"))
                .dust()
        ...
        PrussianBlue = new Material.Builder(ExtForCore.id("prussian_blue"))
                .dust()
        ...
        Formaldehyde = new Material.Builder(ExtForCore.id("formaldehyde"))
                .liquid()
                .color(0xddeced)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
        ...
        Glycolonitrile = new Material.Builder(ExtForCore.id("glycolonitrile"))
                .liquid()
                .color(0x5b8c8f)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DiethylenetriaminePentaacetonitrile = new Material.Builder(ExtForCore.id("diethylenetriamine_pentaacetonitrile"))
                .liquid()
                .color(0xcbbfd6)
                .flags(DISABLE_DECOMPOSITION)
        ...
        DiethylenetriaminepentaaceticAcid = new Material.Builder(ExtForCore.id("diethylenetriaminepentaacetic_acid"))
                .dust()
        ...
        SodiumNitrite = new Material.Builder(ExtForCore.id("sodium_nitrite"))
                .dust()
        ...
        HydrogenPeroxide = new Material.Builder(ExtForCore.id("hydrogen_peroxide"))
                .liquid()
                .color(0x0cbdd7)
        ...
        IlmeniteSlag = new Material.Builder(ExtForCore.id("ilmenite_slag"))
                .dust()
