package com.extfro.extfrocore.common.data.models;
...
import com.extfro.extfrocore.client.model.machine.overlays.EnergyIOOverlay;
import com.extfro.extfrocore.client.model.machine.overlays.HPCAOverlay;
import com.extfro.extfrocore.client.model.machine.overlays.WorkableOverlays;
import com.extfro.extfrocore.common.data.GTMaterials;
import com.extfro.extfrocore.common.machine.electric.ChargerMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.DiodePartMachine;
...
import static com.extfro.extfrocore.api.machine.property.GTMachineModelProperties.*;
import static com.extfro.extfrocore.client.model.machine.overlays.EnergyIOOverlay.*;
import static com.extfro.extfrocore.common.data.models.GTModels.*;
...
public class GTMachineModels {
    ...
    // spotless:off
    public static final ResourceLocation SIDED_SIDED_OVERLAY_MODEL = ExtForCore.id("block/machine/template/sided/sided");
    public static final ResourceLocation SIDED_SINGLE_OVERLAY_MODEL = ExtForCore.id("block/machine/template/sided/single");
    public static final ResourceLocation CUBE_ALL_SIDED_OVERLAY_MODEL = ExtForCore.id("block/machine/template/cube_all/sided");
    public static final ResourceLocation CUBE_ALL_SINGLE_OVERLAY_MODEL = ExtForCore.id("block/machine/template/cube_all/single");

    public static final Int2ObjectMap<ResourceLocation> TIERED_HULL_MODELS = Util.make(new Int2ObjectOpenHashMap<>(), map -> {
        for (int tier : EFValues.ALL_TIERS) {
            String vn = EFValues.VN[tier].toLowerCase(Locale.ROOT);
            map.put(tier, ExtForCore.id("block/casings/voltage/" + vn));
        }
        map.defaultReturnValue(ExtForCore.id("block/casings/voltage/lv"));
    });
    public static final ResourceLocation LP_STEAM_HULL_MODEL = ExtForCore.id("block/casings/steam/bricked_bronze");
    public static final ResourceLocation HP_STEAM_HULL_MODEL = ExtForCore.id("block/casings/steam/bricked_steel");

    public static final ResourceLocation HATCH_PART_MODEL = ExtForCore.id("block/machine/template/part/hatch_machine");
    public static final ResourceLocation HATCH_PART_COLOR_RING_MODEL = ExtForCore.id("block/machine/template/part/hatch_machine_color_ring");
    public static final ResourceLocation HATCH_PART_EMISSIVE_MODEL = ExtForCore.id("block/machine/template/part/hatch_machine_emissive");
    public static final ResourceLocation HATCH_PART_EMISSIVE_COLOR_RING_MODEL = ExtForCore.id("block/machine/template/part/hatch_machine_emissive_color_ring");
    // spotless:on
    ...
    public static final ResourceLocation VENT_OVERLAY = ExtForCore.id("block/overlay/machine/overlay_steam_vent");
    ...
    // @deprecated use {@link com.extfro.extfrocore.common.data.models.GTMachineModels.OVERLAY_FLUID_HATCH_INPUT} or {@link com.extfro.extfrocore.common.data.models.GTMachineModels.OVERLAY_FLUID_HATCH_OUTPUT} instead.
    @Deprecated
    ...
    // @deprecated use {@link com.extfro.extfrocore.common.data.models.GTMachineModels.OVERLAY_ITEM_HATCH_INPUT} or {@link com.extfro.extfrocore.common.data.models.GTMachineModels.OVERLAY_ITEM_HATCH_OUTPUT} instead.
    @Deprecated
    public static final String OVERLAY_ITEM_HATCH = "overlay_item_hatch";

    public static final ResourceLocation GENERATOR_MODEL = ExtForCore.id("block/machine/template/generator_machine");
    ...
    // spotless:off
    public static final ResourceLocation CHARGER_IDLE = ExtForCore.id("block/machines/charger/overlay_charger_idle");
    public static final ResourceLocation CHARGER_RUNNING = ExtForCore.id("block/machines/charger/overlay_charger_running");
    public static final ResourceLocation CHARGER_RUNNING_EMISSIVE = ExtForCore.id("block/machines/charger/overlay_charger_running_emissive");
    public static final ResourceLocation CHARGER_FINISHED = ExtForCore.id("block/machines/charger/overlay_charger_finished");
    public static final ResourceLocation CHARGER_FINISHED_EMISSIVE = ExtForCore.id("block/machines/charger/overlay_charger_finished_emissive");
    ...
    public static final ResourceLocation TRANSFORMER_LIKE = ExtForCore.id("block/machine/template/transformer_like_machine");

    public static final ResourceLocation CONVERTER_FE_IN = ExtForCore.id("block/overlay/converter/converter_native_in");
    public static final ResourceLocation CONVERTER_FE_OUT = ExtForCore.id("block/overlay/converter/converter_native_out");

    public static final ResourceLocation CONVERTER_FE_IN_EMISSIVE = ExtForCore.id("block/overlay/converter/converter_native_in_emissive");
    public static final ResourceLocation CONVERTER_FE_OUT_EMISSIVE = ExtForCore.id("block/overlay/converter/converter_native_out_emissive");
    ...
    public static MachineBuilder.ModelInitializer createCrateModel(boolean wooden) {
        return (ctx, prov, builder) -> {
            ...
            ModelFile baseModel = prov.models().getExistingFile(ExtForCore.id(modelPath));
            ModelFile tapedModel = prov.models().getExistingFile(ExtForCore.id(modelPath + "_taped"));
    ...
    // spotless:off
    public static final ResourceLocation ROTOR_HOLDER_BLOCK = ExtForCore.id("block/machine/template/rotor_holder/block");
    public static final ResourceLocation ROTOR_HOLDER_OVERLAY = ExtForCore.id("block/machine/template/rotor_holder/overlay");
    public static final ResourceLocation ROTOR_HOLDER_ROTOR_IDLE = ExtForCore.id("block/machine/template/rotor_holder/rotor_idle");
    public static final ResourceLocation ROTOR_HOLDER_ROTOR_SPINNING = ExtForCore.id("block/machine/template/rotor_holder/rotor_spinning");
    // spotless:on
    ...
    public static final ImmutableMap<Material, ResourceLocation> MATERIALS_TO_CASING_TEXTURES = Util.make(() -> {
        ...
        builder.put(GTMaterials.Bronze, ExtForCore.id("block/casings/solid/machine_casing_bronze_plated_bricks"));
        builder.put(GTMaterials.Invar, ExtForCore.id("block/casings/solid/machine_casing_heatproof"));
        builder.put(GTMaterials.Aluminium, ExtForCore.id("block/casings/solid/machine_casing_frost_proof"));
        builder.put(GTMaterials.Steel, ExtForCore.id("block/casings/solid/machine_casing_solid_steel"));
        builder.put(GTMaterials.StainlessSteel, ExtForCore.id("block/casings/solid/machine_casing_clean_stainless_steel"));
        builder.put(GTMaterials.Titanium, ExtForCore.id("block/casings/solid/machine_casing_stable_titanium"));
        builder.put(GTMaterials.TungstenSteel, ExtForCore.id("block/casings/solid/machine_casing_robust_tungstensteel"));
        builder.put(GTMaterials.Polytetrafluoroethylene, ExtForCore.id("block/casings/solid/machine_casing_inert_ptfe"));
        builder.put(GTMaterials.HSSE, ExtForCore.id("block/casings/solid/machine_casing_sturdy_hsse"));
    ...
    public static final ResourceLocation MAINTENANCE_TAPED_OVERLAY = ExtForCore.id("block/overlay/machine/overlay_maintenance_taped");
    // spotless:on
    ...
    // spotless:off
    public static final ResourceLocation HPCA_PART_MODEL = ExtForCore.id("block/machine/template/part/hpca_part_machine");
    public static final ResourceLocation COMPUTER_CASING_TEXTURE = ExtForCore.id("block/casings/hpca/computer_casing/");
    public static final ResourceLocation ADVANCED_COMPUTER_CASING_TEXTURE = ExtForCore.id("block/casings/hpca/advanced_computer_casing/");
    // spotless:on
    ...
    public static final ResourceLocation OVERLAY_SCREEN_TEXTURE = ExtForCore.id("block/overlay/machine/overlay_screen");
    public static final ResourceLocation OVERLAY_QTANK_EMISSIVE_TEXTURE = ExtForCore
            .id("block/overlay/machine/overlay_qtank_emissive");

    public static MachineBuilder.ModelInitializer createFisherModel() {
        return (ctx, prov, builder) -> {
            BlockModelBuilder model = prov.models().nested()
                    .parent(prov.models().getExistingFile(ExtForCore.id("block/overlay/2_layer/top_emissive")))
    ...
    public static ResourceLocation getTieredHullTexture(int tier) {
        return ExtForCore.id("block/casings/voltage/%s/".formatted(EFValues.VN[tier].toLowerCase(Locale.ROOT)));
    }
    ...
    public static ResourceLocation getSteamCasingTexture(boolean steel) {
        return ExtForCore.id("block/casings/steam/%s/".formatted(steel ? "steel" : "bronze"));
    }
