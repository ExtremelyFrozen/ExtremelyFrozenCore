...
import com.extfro.extfrocore.data.recipe.MaterialInfoLoader;
import com.extfro.extfrocore.data.recipe.configurable.RecipeAddition;
import com.extfro.extfrocore.data.recipe.configurable.RecipeRemoval;
import com.extfro.extfrocore.data.recipe.generated.*;
import com.extfro.extfrocore.data.recipe.misc.*;
import com.extfro.extfrocore.data.recipe.serialized.chemistry.ChemistryRecipes;
...
public class GTRecipes {
    ...
    public static void recipeAddition(RecipeOutput originalConsumer) {
        ...
        // com.extfro.extfrocore.data.recipe.generated.*
        ...
        if (!(ExtForCore.Mods.isKubeJSLoaded() && KJSCallWrapper.recipeEventHasListeners())) {
