...
import com.extfro.extfrocore.common.data.machines.*;
import com.extfro.extfrocore.common.data.models.GTModels;
import com.extfro.extfrocore.common.machine.electric.*;
import com.extfro.extfrocore.common.machine.multiblock.part.*;
import com.extfro.extfrocore.common.machine.multiblock.part.monitor.AdvancedMonitorPartMachine;
import com.extfro.extfrocore.common.machine.multiblock.part.monitor.MonitorPartMachine;
import com.extfro.extfrocore.common.machine.steam.SteamLiquidBoilerMachine;
import com.extfro.extfrocore.common.machine.steam.SteamMinerMachine;
import com.extfro.extfrocore.common.machine.steam.SteamSolarBoiler;
import com.extfro.extfrocore.common.machine.steam.SteamSolidBoilerMachine;
import com.extfro.extfrocore.common.machine.storage.*;
import com.extfro.extfrocore.common.pipelike.fluidpipe.longdistance.LDFluidEndpointMachine;
import com.extfro.extfrocore.common.pipelike.item.longdistance.LDItemEndpointMachine;
...
import static com.extfro.extfrocore.api.capability.recipe.IO.*;
import static com.extfro.extfrocore.api.machine.property.GTMachineModelProperties.*;
import static com.extfro.extfrocore.common.data.GTCreativeModeTabs.MACHINE;
import static com.extfro.extfrocore.common.data.GTRecipeTypes.DUMMY_RECIPES;
import static com.extfro.extfrocore.common.data.GTRecipeTypes.STEAM_BOILER_RECIPES;
import static com.extfro.extfrocore.common.data.machines.GTMachineUtils.*;
import static com.extfro.extfrocore.common.data.machines.GTMachineUtils.ALL_TIERS;
...
public class GTMachines {
    ...
    public static final Pair<MachineDefinition, MachineDefinition> STEAM_SOLID_BOILER = registerSteamMachines(
            ...
            (pressure, builder) -> builder.rotationState(RotationState.ALL)
                    ...
                    .workableSteamHullModel(pressure, ExtForCore.id("block/generators/boiler/coal"))
    ...
    public static final Pair<MachineDefinition, MachineDefinition> STEAM_LIQUID_BOILER = registerSteamMachines(
            ...
            (pressure, builder) -> builder.rotationState(RotationState.ALL)
                    .recipeType(STEAM_BOILER_RECIPES)
                    .recipeModifier(SteamBoilerMachine::recipeModifier)
                    .workableSteamHullModel(pressure, ExtForCore.id("block/generators/boiler/lava"))
                    .tooltips(Component.translatable("gtceu.universal.tooltip.produces_fluid",
    ...
    public static final Pair<MachineDefinition, MachineDefinition> STEAM_SOLAR_BOILER = registerSteamMachines(
            ...
            (pressure, builder) -> builder.rotationState(RotationState.NON_Y_AXIS)
                    .recipeType(STEAM_BOILER_RECIPES)
                    .recipeModifier(SteamBoilerMachine::recipeModifier)
                    .workableSteamHullModel(pressure, ExtForCore.id("block/generators/boiler/solar"))
                    .tooltips(Component.translatable("gtceu.universal.tooltip.produces_fluid",
    ...
    public static final Pair<MachineDefinition, MachineDefinition> STEAM_MACERATOR = registerSteamMachines(
            "steam_macerator", SimpleSteamMachine::new, (pressure, builder) -> builder
                    ...
                    .workableSteamHullModel(pressure, ExtForCore.id("block/machines/macerator"))
                    .register());
    ...
    public static final Pair<MachineDefinition, MachineDefinition> STEAM_MINER = registerSteamMachines(
            ...
            (isHP, builder) -> builder
                    ...
                    .workableSteamHullModel(isHP, isHP ?
                            ExtForCore.id("block/machines/high_pressure_steam_miner") :
                            ExtForCore.id("block/machines/steam_miner"))
                    .register());
    ...
    public static final MachineDefinition[] MACERATOR = registerTieredMachines("macerator",
            (holder, tier) -> new SimpleTieredMachine(holder, tier, defaultTankSizeFunction), (tier, builder) -> builder
                    ...
                    .workableTieredHullModel(ExtForCore.id("block/machines/macerator"))
                    .tooltips(workableTiered(tier, EFValues.V[tier], EFValues.V[tier] * 64,
    ...
    public static final MachineDefinition[] ROCK_CRUSHER = registerTieredMachines("rock_crusher",
            RockCrusherMachine::new, (tier, builder) -> builder
                    ...
                    .recipeModifier(GTRecipeModifiers.OC_NON_PERFECT)
                    .workableTieredHullModel(ExtForCore.id("block/machines/rock_crusher"))
                    .tooltips(workableTiered(tier, EFValues.V[tier], EFValues.V[tier] * 64,
    ...
    public static final MachineDefinition[] AIR_SCRUBBER = registerTieredMachines("air_scrubber",
            AirScrubberMachine::new, (tier, builder) -> builder
                    ...
                    .recipeModifier(GTRecipeModifiers.OC_NON_PERFECT)
                    .workableTieredHullModel(ExtForCore.id("block/machines/air_scrubber"))
                    .tooltips(workableTiered(tier, EFValues.V[tier], EFValues.V[tier] * 64,
    ...
    public static final MachineDefinition[] COMBUSTION = registerSimpleGenerator("combustion",
            GTRecipeTypes.COMBUSTION_GENERATOR_FUELS, genericGeneratorTankSizeFunction, 0.1f, EFValues.LV, EFValues.MV,
            EFValues.HV);
    public static final MachineDefinition[] STEAM_TURBINE = registerSimpleGenerator("steam_turbine",
            GTRecipeTypes.STEAM_TURBINE_FUELS, steamGeneratorTankSizeFunction, 0.0f, EFValues.LV, EFValues.MV,
            EFValues.HV);
    public static final MachineDefinition[] GAS_TURBINE = registerSimpleGenerator("gas_turbine",
            GTRecipeTypes.GAS_TURBINE_FUELS, genericGeneratorTankSizeFunction, 0.1f, EFValues.LV, EFValues.MV,
            EFValues.HV);
    ...
    public static final MachineDefinition[] PUMP = registerTieredMachines("pump", PumpMachine::new,
            (tier, builder) -> builder
                    .rotationState(RotationState.ALL)
                    .tieredHullModel(ExtForCore.id("block/machine/template/pump_machine"))
                    .langValue("%s Pump %s".formatted(VLVH[tier], VLVT[tier]))
                    .tooltips(Component.translatable("gtceu.machine.pump.tooltip"),
                            Component.translatable("gtceu.universal.tooltip.voltage_in",
                                    FormattingUtil.formatNumbers(EFValues.V[tier]),
                                    EFValues.VNF[tier]),
                            Component.translatable("gtceu.universal.tooltip.energy_storage_capacity",
                                    FormattingUtil.formatNumbers(EFValues.V[tier] * 64)),
    ...
    public static final MachineDefinition[] MINER = registerTieredMachines("miner",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltipBuilder((stack, tooltip) -> {
                        ...
                        long energyPerTick = EFValues.V[tier - 1];
                        ...
                        tooltip.add(Component.translatable("gtceu.universal.tooltip.energy_storage_capacity",
                                FormattingUtil.formatNumbers(EFValues.V[tier] * 64L)));
    ...
    public static final MachineDefinition[] WORLD_ACCELERATOR = registerTieredMachines("world_accelerator",
            ...
            (tier, builder) -> builder
                    ...
                    .model(createWorldAcceleratorModel(ExtForCore.id("block/machines/world_accelerator_te"),
                            ExtForCore.id("block/machines/world_accelerator")))
                    .tooltipBuilder((stack, tooltip) -> {
    ...
    public static final MachineDefinition[] BUFFER = registerTieredMachines("buffer",
            ...
            (tier, builder) -> builder
                    ...
                    .rotationState(RotationState.NONE)
                    .model(createSingleOverlayTieredHullMachineModel(ExtForCore.id("block/overlay/machine/overlay_buffer"),
                            ExtForCore.id("block/overlay/machine/overlay_buffer_emissive")))
                    .tooltips(
    ...
    public static final MachineDefinition CREATIVE_ENERGY = REGISTRATE
            ...
            .model(createSingleOverlayTieredHullMachineModel(GTModels.BLANK_TEXTURE,
                    ExtForCore.id("block/overlay/machine/overlay_energy_emitter")))
    ...
    public static final MachineDefinition CREATIVE_COMPUTATION_PROVIDER = REGISTRATE
            ...
            .model(createSingleOverlayTieredHullMachineModel(
                    ExtForCore.id("block/overlay/machine/overlay_data_hatch_optical"),
                    ExtForCore.id("block/overlay/machine/overlay_data_hatch_optical_emissive")))
            .tooltipBuilder(CREATIVE_TOOLTIPS)
            .tier(MAX)
            .register();
    ...
    public static final MachineDefinition CREATIVE_FLUID = REGISTRATE
            ...
            .model(createBasicMachineModel(ExtForCore.id("block/machine/template/quantum/creative_container"))
    ...
    public static final MachineDefinition[] ENERGY_INPUT_HATCH_4A = registerTieredMachines("energy_input_hatch_4a",
            ...
            (tier, builder) -> builder
                    ...
                    .register(),
            EFValues.tiersBetween(EV, EFAPI.isHighTier() ? MAX : UHV));
    ...
    public static final MachineDefinition COKE_OVEN_HATCH = REGISTRATE.machine("coke_oven_hatch", CokeOvenHatch::new)
            ...
            .simpleModel(ExtForCore.id("block/machine/part/coke_oven_hatch"))
            .register();
    ...
    public static final MachineDefinition PUMP_HATCH = REGISTRATE.machine("pump_hatch", PumpHatchPartMachine::new)
            ...
            .modelProperty(IS_FORMED, false)
            .model(createBasicReplaceableTextureMachineModel(ExtForCore.id("block/machine/part/pump_hatch")))
            .register();
    ...
    public static final MachineDefinition MAINTENANCE_HATCH = REGISTRATE
            ...
            .model(createMaintenanceModel(ExtForCore.id("block/machine/part/maintenance_hatch")))
            .tier(LV)
            .register();
    ...
    public static final MachineDefinition CONFIGURABLE_MAINTENANCE_HATCH = REGISTRATE
            ...
            .modelProperty(IS_FORMED, false)
            .modelProperty(GTMachineModelProperties.IS_TAPED, false)
            .model(createMaintenanceModel(ExtForCore.id("block/machine/part/configurable_maintenance_hatch")))
            .tier(HV)
            .register();
    ...
    public static final MachineDefinition CLEANING_MAINTENANCE_HATCH = REGISTRATE
            ...
            .overlayTieredHullModel(ExtForCore.id("block/machine/part/cleaning_maintenance_hatch"))
            .tier(HV)
            .register();
    ...
    public static final MachineDefinition AUTO_MAINTENANCE_HATCH = REGISTRATE
            ...
            .modelProperty(IS_FORMED, false)
            .tooltips(Component.translatable("gtceu.part_sharing.disabled"))
            .overlayTieredHullModel(ExtForCore.id("block/machine/part/auto_maintenance_hatch"))
            .tier(HV)
            .register();
    ...
    public static final MachineDefinition[] ROTOR_HOLDER = registerTieredMachines("rotor_holder",
            ...
            (tier, builder) -> builder
                    ...
                    .tooltips(Component.translatable("gtceu.part_sharing.disabled"))
                    .register(),
            EFValues.tiersBetween(HV, EFAPI.isHighTier() ? OpV : UV));
    ...
    public static final MachineDefinition MONITOR = REGISTRATE.machine("monitor", MonitorPartMachine::new)
            .rotationState(RotationState.ALL)
            .model(createOverlayCasingMachineModel(ExtForCore.id("block/casings/solid/machine_casing_frost_proof"),
                    ExtForCore.id("block/machine/part/computer_monitor")))
            .tier(MV)
            .register();
    public static final MachineDefinition ADVANCED_MONITOR = REGISTRATE
            .machine("advanced_monitor", AdvancedMonitorPartMachine::new)
            .rotationState(RotationState.ALL)
            .model(createOverlayCasingMachineModel(ExtForCore.id("block/casings/solid/machine_casing_clean_stainless_steel"),
                    ExtForCore.id("block/machine/part/computer_monitor")))
            .tier(HV)
            .allowExtendedFacing(true)
            .register();
    ...
    public static MachineDefinition get(String name) {
        return GTRegistries.MACHINES.get(ExtForCore.id(name));
    }
}
