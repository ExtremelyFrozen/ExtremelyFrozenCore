...
public class BatteryBlock extends Block {
    ...
    public enum BatteryPartType implements StringRepresentable, IBatteryData {
        ...
        EMPTY_TIER_I,
        EV_LAPOTRONIC(EFValues.EV, 25_000_000L * 6),      // Lapotron Crystal * 6
        IV_LAPOTRONIC(EFValues.IV, 250_000_000L * 6),     // Lapotronic Orb * 6

        EMPTY_TIER_II,
        LuV_LAPOTRONIC(EFValues.LuV, 1_000_000_000L * 6), // Lapotronic Orb Cluster * 6
        ZPM_LAPOTRONIC(EFValues.ZPM, 4_000_000_000L * 6), // Energy Orb * 6

        EMPTY_TIER_III,
        UV_LAPOTRONIC(EFValues.UV, 16_000_000_000L * 6),  // Energy Cluster * 6
        UHV_ULTIMATE(EFValues.UHV, Long.MAX_VALUE),       // Ultimate Battery
        ;
