package com.extfro.extfrocore.common.cosmetics;
...
public class GTCapes {
    ...
    public static final ResourceLocation GREGTECH_CAPE = ExtForCore.id("gregtech");
    public static final ResourceLocation GREEN_CAPE = ExtForCore.id("green");
    public static final ResourceLocation YELLOW_CAPE = ExtForCore.id("yellow");
    public static final ResourceLocation RED_CAPE = ExtForCore.id("red");
    public static final ResourceLocation DEBUG_CAPE = ExtForCore.id("debug");

    public static final ResourceLocation RAINBOW_CAPE = ExtForCore.id("rainbow");
    public static final ResourceLocation ACE_CAPE = ExtForCore.id("ace");
    public static final ResourceLocation AGENDER_CAPE = ExtForCore.id("agender");
    public static final ResourceLocation AROMANTIC_CAPE = ExtForCore.id("aromantic");
    public static final ResourceLocation BI_CAPE = ExtForCore.id("bi");
    public static final ResourceLocation GENDERFLUID_CAPE = ExtForCore.id("genderfluid");
    public static final ResourceLocation GENDERQUEER_CAPE = ExtForCore.id("genderqueer");
    public static final ResourceLocation INTERSEX_CAPE = ExtForCore.id("intersex");
    public static final ResourceLocation LESBIAN_CAPE = ExtForCore.id("lesbian");
    public static final ResourceLocation NONBINARY_CAPE = ExtForCore.id("nonbinary");
    public static final ResourceLocation PAN_CAPE = ExtForCore.id("pan");
    public static final ResourceLocation TRANS_CAPE = ExtForCore.id("trans");
    ...
    public static void registerGTCapes(RegisterGTCapesEvent event) {
        ...
        event.registerCape(GREGTECH_CAPE, ExtForCore.id("textures/capes/gregtech_cape.png"));
        event.registerCape(GREEN_CAPE, ExtForCore.id("textures/capes/green_cape.png"));
        event.registerCape(YELLOW_CAPE, ExtForCore.id("textures/capes/yellow_cape.png"));
        event.registerCape(RED_CAPE, ExtForCore.id("textures/capes/red_cape.png"));
        // don't link this to anything (except easter egg? april fools? TBD)
        event.registerCape(DEBUG_CAPE, ExtForCore.id("textures/capes/debug_cape.png"));

        event.registerFreeCape(RAINBOW_CAPE, ExtForCore.id("textures/capes/rainbow_cape.png"));
        event.registerFreeCape(ACE_CAPE, ExtForCore.id("textures/capes/ace_cape.png"));
        event.registerFreeCape(AGENDER_CAPE, ExtForCore.id("textures/capes/agender_cape.png"));
        event.registerFreeCape(AROMANTIC_CAPE, ExtForCore.id("textures/capes/aromantic_cape.png"));
        event.registerFreeCape(BI_CAPE, ExtForCore.id("textures/capes/bi_cape.png"));
        event.registerFreeCape(GENDERFLUID_CAPE, ExtForCore.id("textures/capes/genderfluid_cape.png"));
        event.registerFreeCape(GENDERQUEER_CAPE, ExtForCore.id("textures/capes/genderqueer_cape.png"));
        event.registerFreeCape(INTERSEX_CAPE, ExtForCore.id("textures/capes/intersex_cape.png"));
        event.registerFreeCape(LESBIAN_CAPE, ExtForCore.id("textures/capes/lesbian_cape.png"));
        event.registerFreeCape(NONBINARY_CAPE, ExtForCore.id("textures/capes/nonbinary_cape.png"));
        event.registerFreeCape(PAN_CAPE, ExtForCore.id("textures/capes/pan_cape.png"));
        event.registerFreeCape(TRANS_CAPE, ExtForCore.id("textures/capes/trans_cape.png"));
    }
