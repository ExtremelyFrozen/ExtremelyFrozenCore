...
public class SCPacketShareProspection implements CustomPacketPayload {
    ...
    public static final ResourceLocation ID = ExtForCore.id("share_prospection");
    ...
    public void execute(IPayloadContext context) {
        if (context.flow() == PacketFlow.CLIENTBOUND) {
            ...
            ServerPlayer receiverPlayer = ExtForCore.getMinecraftServer().getPlayerList().getPlayer(receiver);
