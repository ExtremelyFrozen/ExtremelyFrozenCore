package com.extfro.extfrocore.common.network.packets.hazard;

import com.extfro.extfrocore.ExtForCore;
import com.extfro.extfrocore.client.EnvironmentalHazardClientHandler;
...
public class SPacketSyncHazardZoneStrength implements CustomPacketPayload {
    ...
    public static final ResourceLocation ID = ExtForCore.id("sync_hazard_zone_strength");
