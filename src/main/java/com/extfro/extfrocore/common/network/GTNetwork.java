...
import com.extfro.extfrocore.common.network.packets.*;
import com.extfro.extfrocore.common.network.packets.hazard.*;
import com.extfro.extfrocore.common.network.packets.prospecting.SPacketProspectBedrockFluid;
import com.extfro.extfrocore.common.network.packets.prospecting.SPacketProspectBedrockOre;
import com.extfro.extfrocore.common.network.packets.prospecting.SPacketProspectOre;
...
public class GTNetwork {
    ...
    public static void registerPayloads(RegisterPayloadHandlersEvent event) {
        PayloadRegistrar registar = event.registrar(EFAPI.NETWORK_VERSION);
        // spotless:off
