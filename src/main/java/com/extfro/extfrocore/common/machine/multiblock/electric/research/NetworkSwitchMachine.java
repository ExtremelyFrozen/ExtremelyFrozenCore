...
import com.extfro.extfrocore.api.capability.IOpticalComputationHatch;
...
public class NetworkSwitchMachine extends DataBankMachine implements IOpticalComputationProvider {
    ...
    public static final int EUT_PER_HATCH = EFValues.VA[EFValues.IV];
    ...
    protected int calculateEnergyUsage() {
        ...
        return EFValues.VA[EFValues.IV] * (receivers + transmitters);
    }
