...
import com.extfro.extfrocore.api.machine.steam.SteamEnergyRecipeHandler;
...
public class SteamParallelMultiblockMachine extends WorkableMultiblockMachine implements IDisplayUIMachine {
    ...
    public static ModifierFunction recipeModifier(@NotNull MetaMachine machine, @NotNull GTRecipe recipe) {
        ...
        if (RecipeHelper.getRecipeEUtTier(recipe) > EFValues.LV) return ModifierFunction.NULL;
