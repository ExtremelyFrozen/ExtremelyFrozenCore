...
import com.extfro.extfrocore.api.block.IFusionCasingType;
...
import com.extfro.extfrocore.common.block.FusionCasingBlock;
...
import static com.extfro.extfrocore.api.recipe.OverclockingLogic.PERFECT_HALF_DURATION_FACTOR;
import static com.extfro.extfrocore.api.recipe.OverclockingLogic.PERFECT_HALF_VOLTAGE_FACTOR;
...
public class FusionReactorMachine extends WorkableElectricMultiblockMachine implements ITieredMachine {
    ...
    public static void addEUToStartLabel(GTRecipe recipe, UIElement group) {
        ...
        group.addChild(GTRecipeElement.label(-8, (int) group.getSizeHeight() - 10,
                Component.literal(LocalizationUtils.format("gtceu.recipe.eu_to_start",
