...
import com.extfro.extfrocore.api.sync_system.ClassSyncData;
import com.extfro.extfrocore.api.sync_system.annotations.SaveField;
import com.extfro.extfrocore.api.sync_system.data_transformers.ValueTransformer;
import com.extfro.extfrocore.integration.ae2.machine.trait.GridNodeHostTrait;
...
public class HullMachine extends TieredPartMachine implements IMonitorComponent {
    ...
    public void onLoad() {
        super.onLoad();
        if (ExtForCore.Mods.isAE2Loaded() && gridNodeHost instanceof GridNodeHostTrait connectedBlockEntity &&
