package com.extfro.extfrocore.common.machine.trait.miner;
...
import com.extfro.extfrocore.api.misc.IgnoreEnergyRecipeHandler;
import com.extfro.extfrocore.api.misc.ItemRecipeHandler;
import com.extfro.extfrocore.api.recipe.GTRecipe;
import com.extfro.extfrocore.api.recipe.RecipeHelper;
import com.extfro.extfrocore.api.sync_system.annotations.SaveField;
import com.extfro.extfrocore.api.transfer.item.NotifiableAccountedInvWrapper;
...
public class MinerLogic extends RecipeLogic implements IRecipeCapabilityHolder {
    ...
    private static BlockState findMiningReplacementBlock(Level level, BlockPos pos) {
        ...
        try {
            ...
            ExtForCore.LOGGER.error("failed to parse replaceMinedBlocksWith, invalid BlockState: {}",
